...
class CelticCrossService
{
     ...
     *
     * 🆕 (2026-05-16 v2) Sequence-aware short style — ปรับ threshold ตาม user spec:
     *   - Q1-Q3: full storytelling 9 sections — 800-1500 chars (ลูกค้าจ่าย 99฿ ต้องคุ้ม)
     *   - Q4+: short analytical + ฟันธง — 200-450 chars (เริ่มลึกแล้ว ตอบกระชับ)
     *   - Q5+ ที่นอกเรื่องเดิม: AI signal [OFF_TOPIC_REPICK] → ระบบชวนจับไพ่ใหม่
     *     + เหตุผล: "ไพ่ชุดเดิมอาจตอบเรื่องราวใหม่ๆ ได้ไม่ครบ"
     *
    ...
    protected function buildFollowupPrompt(
        ...
        // 🆕 (2026-05-16 v2) Q4+ — short analytical style แทน 9 sections
        //    user spec 2026-05-16: "ทำนายตามแบบเดิมก่อนในคำถาม 3 คำถามแรก
        //                           หลังจากนั้น ค่อยตอบแบบเชิงวิเคราะห์สั้นๆ แทน"
        //    Q1-Q3 = full storytelling (เดิม), Q4+ = short analytical
        if ($sequence >= 4) {
    ...
    /**
     * 🆕 (2026-05-16 v2) Short followup prompt สำหรับ Q4+
     *
     * user spec 2026-05-16: "ทำนายตามแบบเดิมก่อนในคำถาม 3 คำถามแรก
     *                       หลังจากนั้น ค่อยตอบแบบเชิงวิเคราะห์สั้นๆ แทน
     *                       ไม่ต้องมีการสวัสดีระหว่างทำนายเด็ดขาด"
     *
     * + Q5+ + คำถามนอกเรื่องเดิม → AI signal [OFF_TOPIC_REPICK]
    ...
    protected function buildShortFollowupPrompt(
        ...
        // สั่ง AI ตรวจ off-topic เมื่อถามถึง Q5
        //   user spec 2026-05-16: "พอเข้าคำถามที่ 5 เดิมเราตั้งค่าให้ชวนเปิดไพ่ใหม่ ก็ทำเหมือนเดิม
        //                          แต่ต้องให้เหตุผลว่า ไพ่ชุดเดิม อาจตอบเรื่องราวใหม่ๆ ได้ไม่ครบ"
        $offTopicGuard = '';
        if ($sequence >= 5) {
            $offTopicGuard = "\n\n━━━━━━━━━━━━━━━━━\n"
                ...
                ."   ระบบจะชวนเจ้าชะตาจับไพ่ใหม่เอง พร้อมเหตุผลว่า ไพ่ชุดเดิมอาจตอบเรื่องราวใหม่ๆ ได้ไม่ครบ\n"
        ...
        return $personaPrefix
            ...
            ."━━━━━━━━━━━━━━━━━\n"
            ."🎯 หลักการตอบ (Q{$sequence} — short style หลัง Q3)\n"
            ."━━━━━━━━━━━━━━━━━\n"
