    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
        ...
        <div class="flex gap-2">
            <a href="{{ route('admin.mlm.members.genealogy', $member) }}"
               class="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 dark:from-purple-500 dark:to-pink-500 dark:hover:from-purple-600 dark:hover:to-pink-600 text-white px-6 py-3 rounded-xl flex items-center gap-2 shadow-lg hover:shadow-xl transition-all duration-200">
                <i class="fas fa-sitemap"></i>
                ดูผังสายงาน
            </a>
            <a href="{{ route('admin.mlm.members.index') }}"
               class="bg-gray-600 hover:bg-gray-700 dark:bg-gray-500 dark:hover:bg-gray-600 text-white px-6 py-3 rounded-xl flex items-center gap-2 shadow-lg hover:shadow-xl transition-all duration-200">
        ...
        <div class="flex flex-col md:flex-row items-start md:justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 dark:text-gray-400 flex items-center gap-2">
            ...
            <div class="text-left md:text-right">
                <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Member Code</p>
                <p class="text-2xl font-bold text-purple-600 dark:text-purple-400">{{ $member->member_code }}</p>
                <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 mt-1 flex items-center gap-1 md:justify-end">
            ...
            <div class="space-y-3">
                @if($member->unilevelSponsor)
                    <div class="flex items-center justify-between p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-800">
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">ผู้สนับสนุน</p>
                            <p class="font-semibold text-gray-900 dark:text-white">{{ $member->unilevelSponsor->user->name }}</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400">{{ $member->unilevelSponsor->member_code }}</p>
                        </div>
                ...
                @else
                    <div class="p-4 bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-700 dark:border-gray-600">
                        <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 italic flex items-center gap-2">
                ...
                <div class="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border border-blue-100 dark:border-blue-800">
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">ระดับ Unilevel</p>
                ...
                <div class="p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl border border-purple-100 dark:border-purple-800">
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">ลูกทีมโดยตรง</p>
            ...
            <div class="space-y-3">
                @if($member->binaryParent)
                    <div class="flex items-center justify-between p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl border border-purple-100 dark:border-purple-800">
                        <div>
                            <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Parent</p>
                            <p class="font-semibold text-gray-900 dark:text-white">{{ $member->binaryParent->user->name }}</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400">{{ $member->binaryParent->member_code }}</p>
                        </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-800">
                        <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1 flex items-center gap-1">
                            <i class="fas fa-arrow-left"></i>
                            Left Leg PV
                        </p>
                        <p class="text-xl font-bold text-blue-600 dark:text-blue-400">{{ number_format($member->left_leg_pv, 2) }}</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 mt-1">{{ $member->left_leg_members }} สมาชิก</p>
                    </div>
                    <div class="p-4 bg-pink-50 dark:bg-pink-900/20 rounded-xl border border-pink-100 dark:border-pink-800">
                        <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1 flex items-center gap-1">
                            <i class="fas fa-arrow-right"></i>
                            Right Leg PV
                        </p>
                        <p class="text-xl font-bold text-pink-600 dark:text-pink-400">{{ number_format($member->right_leg_pv, 2) }}</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 mt-1">{{ $member->right_leg_members }} สมาชิก</p>
                    </div>
                </div>
                ...
                @if($member->carry_forward_left > 0 || $member->carry_forward_right > 0)
                    <div class="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl border border-yellow-200 dark:border-yellow-700">
                        <p class="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2 flex items-center gap-2">
                            <i class="fas fa-forward text-yellow-600 dark:text-yellow-400"></i>
                            Carry Forward PV
                        </p>
                        <div class="flex justify-between text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">
