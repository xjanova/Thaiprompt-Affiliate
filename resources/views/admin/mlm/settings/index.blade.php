...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <!-- Settings Group -->
        <div class="glass-fusion dark:bg-gray-800 rounded-2xl shadow-xl mb-6 overflow-hidden border border-gray-100 dark:border-gray-700 transform transition-all duration-300 hover:shadow-2xl">
            <div class="bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-4">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 glass-fusion rounded-xl flex items-center justify-center backdrop-blur-sm">
            ...
            <div class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <div class="p-6 hover:bg-gray-100/50 dark:bg-gray-800/50 dark:bg-gray-700 transition-colors">
                        ...
                        <div class="w-full">
                            @if(!$setting->is_editable)
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="flex-1 px-4 py-3 bg-gray-100/50 dark:bg-gray-800/50 dark:bg-gray-700 text-gray-600 dark:text-gray-400 rounded-xl border-2 border-gray-200 dark:border-gray-700">
                            ...
                            @else
                                ...
                                @elseif(($setting->input_type ?? 'text') === 'select')
                                    ...
                                    <div class="relative">
                                        <select name="settings[{{ $setting->key }}]"
                                                class="w-full px-4 py-3 pr-10 glass-fusion dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:ring-4 focus:ring-purple-200 focus:border-purple-500 appearance-none cursor-pointer text-base font-medium text-gray-700 dark:text-gray-300 hover:border-purple-300 transition-all duration-200"
                                ...
                                @elseif(($setting->input_type ?? 'text') === 'number')
                                    ...
                                    <div class="relative">
                                        <input type="number"
                                               ...
                                               class="w-full px-4 py-3 {{ $setting->unit ? 'pr-20' : '' }} glass-fusion dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:ring-4 focus:ring-purple-200 focus:border-purple-500 text-base font-semibold text-gray-700 dark:text-gray-300 placeholder-gray-400 hover:border-purple-300 transition-all duration-200">
                                        @if($setting->unit)
                                ...
                                @elseif($setting->type === 'json' || $setting->type === 'array')
                                    ...
                                    <textarea name="settings[{{ $setting->key }}]"
                                              ...
                                              class="w-full px-4 py-3 glass-fusion dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:ring-4 focus:ring-purple-200 focus:border-purple-500 font-mono text-sm text-gray-700 dark:text-gray-300 placeholder-gray-400 hover:border-purple-300 transition-all duration-200">{{ $setting->value }}</textarea>
                                ...
                                @else
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ $setting->value }}"
                                           placeholder="{{ $setting->placeholder ?? '' }}"
                                           class="w-full px-4 py-3 glass-fusion dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:ring-4 focus:ring-purple-200 focus:border-purple-500 text-base font-medium text-gray-700 dark:text-gray-300 placeholder-gray-400 hover:border-purple-300 transition-all duration-200">
                                @endif
                            @endif
                        </div>
                    </div>
        ...
        <div class="xl:col-span-1">
            <div class="sticky top-4 space-y-6">
                ...
                <div class="glass-fusion dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100" hover:scale-105 transition-transform >
    ...
    <div class="mt-8 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 rounded-3xl shadow-2xl p-8 text-white">
        <div class="flex items-center gap-3 mb-6">
            <div class="w-12 h-12 glass-fusion rounded-2xl flex items-center justify-center backdrop-blur-sm"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="glass-fusion backdrop-blur-lg rounded-2xl p-5 hover:glass-fusion transition-all duration-200 cursor-pointer border border-white/20 dark:border-white/10"
                 onclick="showPlacementDemo('manual')">
                <div class="flex items-center gap-3 mb-3">
                    <div class="w-10 h-10 glass-fusion rounded-xl flex items-center justify-center"
...
<div id="visualModal" class="modal-overlay" onclick="closeModal(event)">
    <div class="modal-content" onclick="event.stopPropagation()">
        <div class="sticky top-0 glass-fusion dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-8 py-6 rounded-t-3xl z-10"
...
function updateDashboard(total, unilevel, binary) {
    ...
    if (breakdownDiv) {
        ...
        breakdownDiv.innerHTML = `
            ...
            <div class="flex justify-between items-center p-3 bg-gray-100/50 dark:bg-gray-800/50 dark:bg-gray-700 rounded-xl border-t-2 border-gray-300 dark:border-gray-600">
    ...
    modalBody.innerHTML = `
        <div class="space-y-6">
            ...
            <div class="bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-300 rounded-xl p-5">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between glass-fusion dark:bg-gray-800 rounded-xl p-3 shadow-sm"
