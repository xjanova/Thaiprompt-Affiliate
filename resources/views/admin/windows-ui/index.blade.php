...
<div class="container-fluid px-4 py-6">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-slate-800 dark:to-slate-700 border border-blue-200 dark:border-cyan-700 rounded-xl p-6 mb-8">
        <div class="flex items-start gap-4">
            <div class="flex-shrink-0">
                <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white text-2xl">
                    ℹ️
                </div>
            </div>
            <div>
                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">📝 Hard-Coded Menu System</h3>
                <p class="text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">
    ...
    <div x-data="unifiedSettingsManager()">
        <form method="POST" action="{{ route('admin.windows-ui.update') }}" id="main-settings-form" enctype="multipart/form-data">
            ...
            <!-- Tab Navigation -->
            <div class="glass-fusion dark:bg-slate-800 rounded-2xl shadow-lg border border-gray-100 dark:border-slate-700 overflow-hidden mb-6" border border-white/20 dark:border-white/10>
                <div class="border-b border-gray-200 dark:border-gray-700 dark:border-slate-700">
                    <div class="flex flex-wrap p-2 gap-2 bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:bg-slate-900">
                        <button type="button" @click="activeTab = 'taskbar'" :class="activeTab === 'taskbar' ? 'active' : ''" class="settings-tab flex-1 min-w-[180px] px-6 py-3 rounded-xl text-sm font-semibold glass-fusion dark:bg-slate-800 text-gray-700 dark:text-gray-300 dark:text-gray-300 hover:bg-gray-100/50 dark:bg-gray-800/50 dark:hover:bg-slate-700 transition-all">
                            <i class="fas fa-desktop mr-2"></i>Taskbar & Interface
                        </button>
                        <button type="button" @click="activeTab = 'menu'" :class="activeTab === 'menu' ? 'active' : ''" class="settings-tab flex-1 min-w-[180px] px-6 py-3 rounded-xl text-sm font-semibold glass-fusion dark:bg-slate-800 text-gray-700 dark:text-gray-300 dark:text-gray-300 hover:bg-gray-100/50 dark:bg-gray-800/50 dark:hover:bg-slate-700 transition-all">
                            <i class="fas fa-align-justify mr-2"></i>Start Menu
                        </button>
                        <button type="button" @click="activeTab = 'startbutton'" :class="activeTab === 'startbutton' ? 'active' : ''" class="settings-tab flex-1 min-w-[180px] px-6 py-3 rounded-xl text-sm font-semibold glass-fusion dark:bg-slate-800 text-gray-700 dark:text-gray-300 dark:text-gray-300 hover:bg-gray-100/50 dark:bg-gray-800/50 dark:hover:bg-slate-700 transition-all">
                            <i class="fas fa-window-maximize mr-2"></i>Start Button
                        </button>
                        <button type="button" @click="activeTab = 'menurgb'" :class="activeTab === 'menurgb' ? 'active' : ''" class="settings-tab flex-1 min-w-[180px] px-6 py-3 rounded-xl text-sm font-semibold glass-fusion dark:bg-slate-800 text-gray-700 dark:text-gray-300 dark:text-gray-300 hover:bg-gray-100/50 dark:bg-gray-800/50 dark:hover:bg-slate-700 transition-all">
            ...
            <div class="glass-fusion dark:bg-slate-800 rounded-2xl shadow-lg border border-gray-100 dark:border-slate-700 overflow-hidden mb-20" border border-white/20 dark:border-white/10>
                <div class="p-6">
                ...
                <div class="relative">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3 pb-2 border-b-2 border-gray-200 dark:border-gray-700 dark:border-slate-700">
                        <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white text-xl">
                            🖥️
                        </div>
                ...
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                    <button type="button" @click="openSections.includes('taskbar') ? openSections = openSections.filter(s => s !== 'taskbar') : openSections.push('taskbar')" class="w-full flex items-center justify-between mb-4">
                        ...
                        <svg class="w-6 h-6 text-gray-500 dark:text-gray-400 transition-transform" :class="openSections.includes('taskbar') ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    </button>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-4" x-show="openSections.includes('taskbar')">ปรับแต่งลักษณะและพฤติกรรมของ Taskbar หลัก</p>
                    <div x-show="openSections.includes('taskbar')" x-collapse>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ตำแหน่ง Taskbar</label>
                            <select name="windows_taskbar_position" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                        ...
                        <div x-data="{ height: {{ $settings['windows_taskbar_height'] ?? 56 }} }">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ความสูง (px)</label>
                            <div class="flex items-center gap-4">
                                <input type="range" name="windows_taskbar_height" x-model="height" min="32" max="80" step="2" class="flex-1 h-2 bg-gray-200 dark:bg-gray-700 rounded-xl appearance-none cursor-pointer dark:bg-gray-700 accent-indigo-600">
                                <span class="text-2xl font-bold text-indigo-600 dark:text-indigo-400 min-w-[4rem] text-center" x-text="height + 'px'"></span>
                            </div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">แนะนำ: 48-64px สำหรับหน้าจอทั่วไป</p>
                        </div>
                        <div x-data="{ transparency: {{ $settings['windows_taskbar_transparency'] ?? 95 }} }">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">โปร่งแสง (%)</label>
                            <div class="flex items-center gap-4">
                                <input type="range" name="windows_taskbar_transparency" x-model="transparency" min="0" max="100" class="flex-1 h-2 bg-gray-200 dark:bg-gray-700 rounded-xl appearance-none cursor-pointer dark:bg-gray-700 accent-indigo-600">
                                <span class="text-2xl font-bold text-indigo-600 dark:text-indigo-400 min-w-[4rem] text-center" x-text="transparency + '%'"></span>
                            </div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">0 = โปร่งใสสุด, 100 = ทึบสุด</p>
                        </div>
                        <div class="flex items-center">
                            <label class="flex items-center cursor-pointer">
                                ...
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">เปิดใช้ Blur Effect</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="mt-8 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border-2 border-blue-200 dark:border-blue-700">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-6">ปรับแต่งสีของ Taskbar ให้ตรงกับธีมของคุณ</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    <input type="color"
                                           ...
                                           class="w-16 h-10 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 cursor-pointer">
                                    <input type="text"
                                           value="{{ $settings['windows_taskbar_bg_color'] ?? '#1e293b' }}"
                                           class="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl text-sm font-mono"
                                           readonly>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                <label class="flex items-center cursor-pointer">
                                    ...
                                    <span class="ml-2 text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">ใช้ Gradient</span>
                                </label>
                            </div>
                        </div>

                        <!-- Gradient Settings -->
                        <div class="mt-6 p-4 glass-fusion dark:bg-slate-800/50 rounded-xl border border-blue-200 dark:border-blue-700" border border-white/20 dark:border-white/10>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                <button type="button"
                                        class="px-4 py-2 bg-gradient-to-r from-slate-700 to-slate-900 text-white rounded-xl text-xs hover:shadow-lg transition-all"
                                        onclick="applyColorPreset('#1e293b', '#ffffff', '#334155', '#475569', '#475569', false)">
                                    Dark Slate
                                </button>
                                <button type="button"
                                        class="px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-xl text-xs hover:shadow-lg transition-all"
                                        onclick="applyColorPreset('#ec4899', '#ffffff', '#f472b6', '#be185d', '#be185d', true, '#ec4899', '#8b5cf6')">
                                    Purple Dream
                                </button>
                                <button type="button"
                                        class="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl text-xs hover:shadow-lg transition-all"
                                        onclick="applyColorPreset('#0891b2', '#ffffff', '#06b6d4', '#0e7490', '#0e7490', true, '#0891b2', '#0e7490')">
                                    Ocean Blue
                                </button>
                                <button type="button"
                                        class="px-4 py-2 bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-xl text-xs hover:shadow-lg transition-all"
                        ...
                        <!-- Info -->
                        <div class="mt-4 p-3 bg-blue-100 dark:bg-blue-900/30 rounded-xl border border-blue-300 dark:border-blue-700">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                    <button type="button" @click="openSections.includes('backButton') ? openSections = openSections.filter(s => s !== 'backButton') : openSections.push('backButton')" class="w-full flex items-center justify-between mb-4">
                        ...
                        <svg class="w-6 h-6 text-gray-500 dark:text-gray-400 transition-transform" :class="openSections.includes('backButton') ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                        </svg>
                    </button>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-4" x-show="openSections.includes('backButton')">ปรับแต่งปุ่มย้อนกลับใน Taskbar</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="flex items-center">
                            <label class="flex items-center cursor-pointer">
                                ...
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">แสดงปุ่มกลับ</span>
                            </label>
                        </div>
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ข้อความปุ่มกลับ</label>
                            <input type="text" name="millennium_back_button_text" value="{{ $settings['millennium_back_button_text'] ?? 'กลับ' }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-4">ข้อความที่แสดงในส่วนกลางของ Taskbar</p>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="flex items-center">
                            <label class="flex items-center cursor-pointer">
                                ...
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">แสดงส่วนกลาง</span>
                            </label>
                        </div>
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ข้อความส่วนกลาง (เว้นว่างเพื่อใช้ค่าเริ่มต้น)</label>
                            <input type="text" name="millennium_center_section_text" value="{{ $settings['millennium_center_section_text'] ?? '' }}" placeholder="เช่น: Admin Dashboard" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="relative mt-12">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-3 pb-2 border-b-2 border-gray-200 dark:border-gray-700 dark:border-slate-700">
                        <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white text-xl">
                            ✨
                        </div>
                ...
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">โหมดธีม</label>
                            <select name="windows_theme_mode" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">สี Accent</label>
                            <input type="color" name="windows_accent_color" value="{{ $settings['windows_accent_color'] ?? '#0078D4' }}" class="w-full h-10 px-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 rounded-xl">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="flex items-center">
                            <label class="flex items-center cursor-pointer">
                                ...
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">เปิดใช้ธีมยานอวกาศ</span>
                            </label>
                        </div>
                        <div class="flex items-center">
                            <label class="flex items-center cursor-pointer">
                                ...
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">แสดงดาวพื้นหลัง</span>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">โหมดความกว้าง</label>
                            <select name="content_width_mode" id="content_width_mode" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                        ...
                        <div id="custom_width_wrapper" style="display: {{ ($settings['content_width_mode'] ?? 'container') === 'custom' ? 'block' : 'none' }};">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ความกว้างแบบกำหนดเอง (px)</label>
                            <input type="number" name="content_width_custom" min="800" max="3000" step="10" value="{{ $settings['content_width_custom'] ?? 1400 }}" placeholder="1400" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                ...
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">รูปแบบนาฬิกา</label>
                            <select name="millennium_clock_style" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">รูปแบบเวลา</label>
                            <select name="millennium_clock_format" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                        ...
                        <div class="flex items-center">
                            <label class="flex items-center cursor-pointer">
                                ...
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">แสดงวินาที</span>
                            </label>
                        </div>
                        <div class="flex items-center">
                            <label class="flex items-center cursor-pointer">
                                ...
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">แสดงวันที่</span>
                            </label>
                        </div>
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">รูปแบบวันที่</label>
                            <select name="millennium_clock_date_format" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="flex items-center">
                            <label class="flex items-center cursor-pointer">
                                ...
                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">เปิดใช้ปุ่ม Back to Top</span>
                            </label>
                        </div>
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ตำแหน่งปุ่ม</label>
                            <select name="millennium_back_to_top_position" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                        ...
                        <div x-data="{ threshold: {{ $settings['millennium_back_to_top_threshold'] ?? 20 }} }">
                            ...
                            <div class="flex items-center gap-4">
                                <input
                                    ...
                                    max="100"
                                    step="5"
                                    class="flex-1 h-2 bg-gray-200 dark:bg-gray-700 rounded-xl appearance-none cursor-pointer dark:bg-gray-700 accent-indigo-600">
                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">อนิเมชั่น</label>
                            <select name="millennium_back_to_top_animation" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ข้อความไลเซ่น</label>
                            <input type="text" name="windows_license_text" value="{{ $settings['windows_license_text'] ?? 'Licensed' }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 dark:border-slate-600 transition-all duration-300 hover:shadow-md">
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ข้อความลิขสิทธิ์</label>
                            <input type="text" name="windows_copyright_text" value="{{ $settings['windows_copyright_text'] ?? '© 2025 TP-Affiliate' }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
                </div>
                        ...
                        <div class="space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <select name="millennium_menu_position" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all">
                                        ...
                                        <div>
                                            ...
                                            <div class="flex gap-2">
                                                <template x-if="widthUnit === 'px'">
                                                    <input type="number" x-model="widthValue" min="200" max="1200" class="flex-1 px-4 py-3 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all">
                                                </template>
                                                <template x-if="widthUnit === '%'">
                                                    <div class="flex-1 flex items-center gap-4">
                                                        <input type="range" x-model="widthValue" min="20" max="100" class="flex-1 h-3 bg-gradient-to-r from-indigo-200 to-purple-200 rounded-xl appearance-none cursor-pointer dark:from-indigo-800 dark:to-purple-800 accent-indigo-600">
                                                ...
                                                <select x-model="widthUnit" class="w-24 px-3 py-3 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-indigo-500">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">แนะนำ: 400-600px หรือ 30-50%</p>
                                        </div>
                                    </div>
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <div class="flex gap-2">
                                                <template x-if="heightUnit === 'px'">
                                                    <input type="number" x-model="heightValue" min="300" max="1200" class="flex-1 px-4 py-3 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all">
                                                </template>
                                                <template x-if="heightUnit === '%' || heightUnit === 'vh'">
                                                    <div class="flex-1 flex items-center gap-4">
                                                        <input type="range" x-model="heightValue" min="50" max="100" class="flex-1 h-3 bg-gradient-to-r from-indigo-200 to-purple-200 rounded-xl appearance-none cursor-pointer dark:from-indigo-800 dark:to-purple-800 accent-indigo-600">
                                                ...
                                                <select x-model="heightUnit" class="w-24 px-3 py-3 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-indigo-500">
                                                    <option value="px">px</option>
                                                    <option value="%">%</option>
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">แนะนำ: 600px หรือ 80vh</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 p-6 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl border-2 border-blue-200 dark:border-blue-700">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        <label class="flex items-center justify-between p-4 glass-fusion dark:bg-slate-800 rounded-xl cursor-pointer border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 hover:border-blue-400 dark:hover:border-blue-600 transition-all">
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">แสดงโลโก้ในเมนู Start</p>
                                            </div>
                                            <label class="toggle-switch">
                                        ...
                                        <label class="flex items-center justify-between p-4 glass-fusion dark:bg-slate-800 rounded-xl cursor-pointer border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 hover:border-blue-400 dark:hover:border-blue-600 transition-all">
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">แสดงชื่อแอปพลิเคชัน</p>
                                            </div>
                                            <label class="toggle-switch">
                                        ...
                                        <label class="flex items-center justify-between p-4 glass-fusion dark:bg-slate-800 rounded-xl cursor-pointer border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 hover:border-blue-400 dark:hover:border-blue-600 transition-all">
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">แสดงข้อความ subtitle</p>
                                            </div>
                                            <label class="toggle-switch">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="md:col-span-2">
                                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-3">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div class="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 p-4 rounded-xl border-2 border-blue-200 dark:border-blue-700">
                                                    <p class="text-xs font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">โลโก้ปัจจุบัน:</p>
                                                    <div class="flex items-center justify-center glass-fusion dark:bg-slate-800 p-4 rounded-xl mb-2" border border-white/20 dark:border-white/10>
                                                ...
                                                <div class="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-4 rounded-xl border-2 border-purple-200 dark:border-purple-700">
                                                    <p class="text-xs font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">อัพโหลดโลโก้ใหม่:</p>
                                                    <div id="menuLogoPreview" class="hidden mb-3">
                                                        <div class="flex items-center justify-center glass-fusion dark:bg-slate-800 p-4 rounded-xl" border border-white/20 dark:border-white/10>
                                                    ...
                                                    <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-purple-300 dark:border-purple-600 rounded-xl cursor-pointer hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-all">
                                                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                            <i class="fas fa-cloud-upload-alt text-3xl text-purple-500 dark:text-purple-400 mb-2"></i>
                                                            <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400"><span class="font-semibold">คลิกเพื่ออัพโหลด</span></p>
                                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400">PNG, JPG, GIF, SVG (สูงสุด 2MB)</p>
                                        ...
                                        <div x-data="{ logoSize: {{ \App\Models\WindowsUiSetting::get('millennium_menu_logo_size', 40) }} }">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <input type="range" x-model="logoSize" min="20" max="100" class="flex-1 h-3 bg-gradient-to-r from-blue-200 to-purple-200 rounded-xl appearance-none cursor-pointer dark:from-blue-800 dark:to-purple-800 accent-blue-600">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">ขนาดของโลโก้ในเมนู (แนะนำ: 30-60px)</p>
                                        </div>
                                        <!-- Custom App Name -->
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">
                                            ...
                                            <input type="text" name="millennium_menu_app_name" value="{{ \App\Models\WindowsUiSetting::get('millennium_menu_app_name') }}" maxlength="50" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all" placeholder="เว้นว่างเพื่อใช้ชื่อเริ่มต้น">
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">ชื่อแอปที่แสดงในเมนู (เว้นว่างใช้ชื่อระบบหลัก)</p>
                                        </div>
                                        <!-- Custom Subtitle -->
                                        <div>
                                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">
                                            ...
                                            <input type="text" name="millennium_menu_subtitle" value="{{ \App\Models\WindowsUiSetting::get('millennium_menu_subtitle') }}" maxlength="50" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all" placeholder="เว้นว่างเพื่อใช้ '{Role} Dashboard'">
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">ข้อความรองในเมนู (เว้นว่างใช้ค่าเริ่มต้น)</p>
                                        </div>
                                        <!-- Menu Item Spacing -->
                                        <div x-data="{ itemSpacing: {{ \App\Models\WindowsUiSetting::get('millennium_menu_item_spacing', 8) }} }">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <input type="range" x-model="itemSpacing" min="0" max="32" class="flex-1 h-3 bg-gradient-to-r from-blue-200 to-purple-200 rounded-xl appearance-none cursor-pointer dark:from-blue-800 dark:to-purple-800 accent-blue-600">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">ระยะห่างระหว่างรายการเมนู (แนะนำ: 4-12px)</p>
                                        </div>
                                        <!-- Menu Item Padding -->
                                        <div x-data="{ menuPadding: {{ \App\Models\WindowsUiSetting::get('millennium_menu_padding', 12) }} }">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <input type="range" x-model="menuPadding" min="4" max="32" class="flex-1 h-3 bg-gradient-to-r from-blue-200 to-purple-200 rounded-xl appearance-none cursor-pointer dark:from-blue-800 dark:to-purple-800 accent-blue-600">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">ขนาด padding ภายในแต่ละรายการ (แนะนำ: 8-16px)</p>
                                        </div>
                                        <!-- Visual Preview -->
                                        <div class="flex items-center justify-center p-4 glass-fusion dark:bg-slate-800 rounded-xl border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600" border border-white/20 dark:border-white/10>
                                            <div class="text-center">
                                                <div class="text-3xl mb-2">📐</div>
                                                <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400">ตัวอย่างจะแสดง<br>หลังบันทึก</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 p-6 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl border-2 border-purple-200 dark:border-purple-700">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div x-data="{ mainHeight: {{ \App\Models\WindowsUiSetting::get('millennium_menu_item_height', 50) }} }">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <input type="range" x-model="mainHeight" min="30" max="100" class="flex-1 h-3 bg-gradient-to-r from-purple-200 to-pink-200 rounded-xl appearance-none cursor-pointer dark:from-purple-800 dark:to-pink-800 accent-purple-600">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">กำหนดความสูงรายการเมนูหลัก (แนะนำ: 40-70px)</p>
                                        </div>
                                        <!-- Submenu Item Height -->
                                        <div x-data="{ subHeight: {{ \App\Models\WindowsUiSetting::get('millennium_menu_subitem_height', 35) }} }">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <input type="range" x-model="subHeight" min="20" max="80" class="flex-1 h-3 bg-gradient-to-r from-purple-200 to-pink-200 rounded-xl appearance-none cursor-pointer dark:from-purple-800 dark:to-pink-800 accent-purple-600">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">กำหนดความสูงรายการเมนูย่อย (แนะนำ: 25-50px)</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Menu Color Settings -->
                                <div class="mt-6 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border-2 border-blue-200 dark:border-blue-700">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-6">ปรับแต่งสีของเมนู Start ให้ตรงกับธีมของคุณ</p>
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <input type="text" name="millennium_start_button_text" value="{{ \App\Models\WindowsUiSetting::get('millennium_start_button_text', 'เริ่ม') }}" maxlength="20" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all" placeholder="เริ่ม">
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">ข้อความที่จะแสดงบนปุ่ม Start (สูงสุด 20 ตัวอักษร)</p>
                                        </div>
                                        <div class="space-y-3">
                                            <label class="flex items-center justify-between p-4 bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:bg-slate-700 rounded-xl cursor-pointer hover:bg-gray-100/50 dark:bg-gray-800/50 dark:hover:bg-slate-600 transition-all border-2 border-transparent hover:border-indigo-300 dark:hover:border-indigo-700">
                                                <div>
                                                    <span class="font-semibold text-gray-900 dark:text-white">🖼️ แสดงโลโก้</span>
                                                    <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">แสดงไอคอน/โลโก้ในปุ่ม Start</p>
                                                </div>
                                                <label class="toggle-switch">
                                            ...
                                            <label class="flex items-center justify-between p-4 bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:bg-slate-700 rounded-xl cursor-pointer hover:bg-gray-100/50 dark:bg-gray-800/50 dark:hover:bg-slate-600 transition-all border-2 border-transparent hover:border-indigo-300 dark:hover:border-indigo-700">
                                                <div>
                                                    ...
                                                    <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">แสดงข้อความ "เริ่ม" ในปุ่ม Start</p>
                                                </div>
                                                <label class="toggle-switch">
                                        ...
                                        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-4 border-2 border-blue-200 dark:border-blue-800">
                                            ...
                                            <div class="space-y-3">
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ประเภทไอคอน</label>
                                                    <select name="millennium_start_button_icon_type" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-blue-500">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="grid grid-cols-2 gap-3">
                                                        ...
                                                        <div class="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-xl border border-blue-200 dark:border-blue-700">
                                                            <p class="text-xs font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-1">ไอคอนปัจจุบัน:</p>
                                                            <div class="flex items-center justify-center glass-fusion dark:bg-slate-800 p-2 rounded mb-1" border border-white/20 dark:border-white/10>
                                                        ...
                                                        <!-- Upload New Icon -->
                                                        <div class="bg-purple-50 dark:bg-purple-900/20 p-3 rounded-xl border border-purple-200 dark:border-purple-700">
                                                            <p class="text-xs font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-1">อัพโหลดใหม่:</p>
                                                            <div id="startButtonIconPreview" class="hidden mb-2">
                                                                <div class="flex items-center justify-center glass-fusion dark:bg-slate-800 p-2 rounded" border border-white/20 dark:border-white/10>
                                                            ...
                                                            <label class="flex flex-col items-center justify-center h-20 border border-dashed border-purple-300 dark:border-purple-600 rounded cursor-pointer hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-all">
                                                                ...
                                                                <p class="text-xs text-gray-500 dark:text-gray-400">คลิกเพื่ออัพโหลด</p>
                                                    ...
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">PNG, JPG, SVG (สูงสุด 2MB)</p>
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Font Awesome Icon Class</label>
                                                    <input type="text" name="millennium_start_button_fontawesome_icon" value="{{ \App\Models\WindowsUiSetting::get('millennium_start_button_fontawesome_icon', 'fa-solid fa-rocket') }}" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-blue-500" placeholder="fa-solid fa-rocket">
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">ตัวอย่าง: fa-solid fa-rocket, fa-brands fa-windows</p>
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Emoji</label>
                                                    <input type="text" name="millennium_start_button_emoji" value="{{ \App\Models\WindowsUiSetting::get('millennium_start_button_emoji', '🚀') }}" maxlength="4" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-blue-500 text-2xl" placeholder="🚀">
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ตำแหน่งไอคอน</label>
                                                    <select name="millennium_start_button_icon_position" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-blue-500">
                                        ...
                                        <div class="bg-gradient-to-br from-pink-50 to-rose-50 dark:from-pink-900/20 dark:to-rose-900/20 rounded-xl p-4 border-2 border-pink-200 dark:border-pink-800">
                                            ...
                                            <div class="space-y-3">
                                                <div>
                                                    ...
                                                    <select name="windows_start_button_position" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-pink-500">
                                                    ...
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">เลือกตำแหน่งที่ต้องการให้ปุ่ม Start แสดงบน Taskbar</p>
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">สไตล์ปุ่ม</label>
                                                    <select name="millennium_start_button_style" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-pink-500">
                                                ...
                                                <div class="grid grid-cols-2 gap-3">
                                                    <div>
                                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">สีหลัก</label>
                                                        <input type="color" name="millennium_start_button_color_primary" value="{{ \App\Models\WindowsUiSetting::get('millennium_start_button_color_primary', '#ec4899') }}" class="w-full h-10 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 rounded-xl cursor-pointer">
                                                    </div>
                                                    <div>
                                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">สีรอง</label>
                                                        <input type="color" name="millennium_start_button_color_secondary" value="{{ \App\Models\WindowsUiSetting::get('millennium_start_button_color_secondary', '#3b82f6') }}" class="w-full h-10 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 rounded-xl cursor-pointer">
                                                    </div>
                                                </div>
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">สีข้อความ</label>
                                                    <input type="color" name="millennium_start_button_text_color" value="{{ \App\Models\WindowsUiSetting::get('millennium_start_button_text_color', '#ffffff') }}" class="w-full h-10 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 rounded-xl cursor-pointer">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="space-y-4">
                                        ...
                                        <div class="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-4 border-2 border-purple-200 dark:border-purple-800">
                                            ...
                                            <label class="flex items-center justify-between p-3 glass-fusion dark:bg-slate-800 rounded-xl cursor-pointer mb-3">
                                                <div>
                                                    <span class="font-medium text-gray-900 dark:text-white">เปิดใช้กล่องคำพูด</span>
                                                    <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">แสดงกล่องคำพูดเมื่อเข้ามาครั้งแรก</p>
                                                </div>
                                                <label class="toggle-switch">
                                            ...
                                            <div class="space-y-3">
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ข้อความในกล่องคำพูด</label>
                                                    <textarea name="millennium_start_button_tooltip_text" rows="2" maxlength="100" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-purple-500" placeholder="คลิกที่นี่เพื่อเริ่มต้น! 🚀">{{ \App\Models\WindowsUiSetting::get('millennium_start_button_tooltip_text', 'คลิกที่นี่เพื่อเริ่มต้น! 🚀') }}</textarea>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">ข้อความที่จะแสดงในกล่องคำพูด (สูงสุด 100 ตัวอักษร)</p>
                                                </div>
                                                <div class="grid grid-cols-2 gap-3">
                                                    <div>
                                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ระยะเวลาแสดง (วินาที)</label>
                                                        <input type="number" name="millennium_start_button_tooltip_duration" min="3" max="30" value="{{ \App\Models\WindowsUiSetting::get('millennium_start_button_tooltip_duration', 8) }}" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-purple-500">
                                                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">3-30 วินาที</p>
                                                    </div>
                                                    <div>
                                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ตำแหน่ง</label>
                                                        <select name="millennium_start_button_tooltip_position" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-purple-500">
                                                ...
                                                <div>
                                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">แอนิเมชั่น</label>
                                                    <select name="millennium_start_button_tooltip_animation" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-purple-500">
                                        ...
                                        <div class="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl p-4 border-2 border-indigo-200 dark:border-indigo-800">
                                            ...
                                            <label class="flex items-center justify-between p-3 glass-fusion dark:bg-slate-800 rounded-xl cursor-pointer mb-3">
                                                <div>
                                                    ...
                                                    <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">รวมไอคอนเป็นปุ่มเมื่อหน้าจอเล็ก</p>
                                                </div>
                                                <label class="toggle-switch">
                                            ...
                                            <div class="mb-3">
                                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Breakpoint (px)</label>
                                                <input type="number" name="millennium_taskbar_collapse_breakpoint" min="320" max="1920" value="{{ \App\Models\WindowsUiSetting::get('millennium_taskbar_collapse_breakpoint', 768) }}" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-indigo-500">
                                                <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">หน้าจอที่แคบกว่านี้จะแสดงโหมด Responsive</p>
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">รูปแบบเมนู</label>
                                                <select name="millennium_taskbar_collapse_style" class="w-full px-4 py-2 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-indigo-500">
                                                ...
                                                <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">เลือกรูปแบบการแสดงเมนูบนมือถือ</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div x-show="activeTab === 'menurgb'" x-transition>
                        <div class="space-y-6">
                                ...
                                <div class="bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/30 dark:to-pink-900/30 rounded-xl p-4 mb-6 border-2 border-purple-300 dark:border-purple-700">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-2">
                                ...
                                <div class="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl p-6 border-2 border-blue-200 dark:border-blue-700">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-4">แถบสีสันที่วิ่งตามขอบ Taskbar</p>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <label class="flex items-center justify-between p-4 glass-fusion dark:bg-slate-800 rounded-xl cursor-pointer border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 hover:border-blue-400 dark:hover:border-blue-600 transition-all">
                                            <div>
                                                <span class="font-semibold text-gray-900 dark:text-white">เปิดใช้ RGB Border</span>
                                                <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">แสดงเส้นขอบสีสันรอบ Taskbar</p>
                                            </div>
                                            <label class="toggle-switch">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="millennium_rgb_speed" min="1" max="10" value="{{ $settings['millennium_rgb_speed'] ?? 5 }}" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-blue-500">
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">ความเร็วในการเปลี่ยนสี (แนะนำ: 3-7)</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-xl p-6 border-2 border-indigo-200 dark:border-indigo-700">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-4">เอฟเฟกต์แสงสีที่เปลี่ยนสีตลอดเวลาทั่วทั้งระบบ</p>
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <label class="flex items-center justify-between p-4 glass-fusion dark:bg-slate-800 rounded-xl cursor-pointer border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 hover:border-indigo-400 dark:hover:border-indigo-600 transition-all">
                                            <div>
                                                <span class="font-semibold text-gray-900 dark:text-white">เปิดใช้ RGB</span>
                                                <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">แสดงเอฟเฟกต์ RGB</p>
                                            </div>
                                            <label class="toggle-switch">
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="windows_rgb_speed" min="1" max="10" value="{{ $settings['windows_rgb_speed'] ?? 3 }}" class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:border-indigo-500">
                                        </div>
                                        <label class="flex items-center justify-between p-4 glass-fusion dark:bg-slate-800 rounded-xl cursor-pointer border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 hover:border-indigo-400 dark:hover:border-indigo-600 transition-all">
                                            <div>
                                                <span class="font-semibold text-gray-900 dark:text-white">Glow Effect</span>
                                                <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">แสงเรืองรอบ RGB</p>
                                            </div>
                                            <label class="toggle-switch">
                                ...
                                <div class="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6 border-2 border-purple-200 dark:border-purple-700">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-4">เอฟเฟกต์ RGB สำหรับ Start Menu และรายการเมนู</p>
                                    ...
                                    <label class="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl cursor-pointer border-2 border-purple-200 dark:border-purple-800 hover:border-purple-400 dark:hover:border-purple-600 transition-all">
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">แสดงเอฟเฟค RGB วิ่งรอบเมนู Start</p>
                                        </div>
                                        <label class="toggle-switch">
                                    ...
                                    <label class="flex items-center justify-between p-4 bg-gradient-to-r from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 rounded-xl cursor-pointer border-2 border-cyan-200 dark:border-cyan-800 hover:border-cyan-400 dark:hover:border-cyan-600 transition-all">
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">แสดงเอฟเฟค RGB เมื่อเมาส์ชี้รายการเมนู</p>
                                        </div>
                                        <label class="toggle-switch">
                                ...
                                <!-- RGB Settings -->
                                <div class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:bg-slate-900/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700 dark:border-slate-700 mb-6">
                                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div x-data="{ rgbSpeed: {{ \App\Models\WindowsUiSetting::get('millennium_menu_rgb_speed', 5) }} }">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <input type="range" x-model="rgbSpeed" min="1" max="20" class="flex-1 h-3 bg-gradient-to-r from-purple-200 to-pink-200 rounded-xl appearance-none cursor-pointer dark:from-purple-800 dark:to-pink-800 accent-purple-600">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">ความเร็วในการเปลี่ยนสี (แนะนำ: 3-7)</p>
                                        </div>
                                        <div x-data="{ borderWidth: {{ \App\Models\WindowsUiSetting::get('millennium_menu_rgb_border_width', 2) }} }">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <input type="range" x-model="borderWidth" min="1" max="10" class="flex-1 h-3 bg-gradient-to-r from-purple-200 to-pink-200 rounded-xl appearance-none cursor-pointer dark:from-purple-800 dark:to-pink-800 accent-purple-600">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">ความหนาของเส้นขอบ RGB (แนะนำ: 2-4)</p>
                                        </div>
                                        <div x-data="{ glowSize: {{ \App\Models\WindowsUiSetting::get('millennium_menu_rgb_glow_size', 15) }} }">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <input type="range" x-model="glowSize" min="0" max="50" class="flex-1 h-3 bg-gradient-to-r from-purple-200 to-pink-200 rounded-xl appearance-none cursor-pointer dark:from-purple-800 dark:to-pink-800 accent-purple-600">
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">ขนาดของแสงเรืองรอบขอบ (แนะนำ: 10-20)</p>
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">ปรับแต่งสี RGB แบบละเอียด และตั้งค่าขั้นสูงเพิ่มเติม</p>
                                </div>
                        </div>
                    </div>
    ...
    <button type="button" onclick="document.getElementById('main-settings-form').submit()" 
        ...
        <!-- Helper text -->
        <div class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-2 text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
...
<script>
    ...
    function applyColorPreset(bgColor, textColor, hoverColor, activeColor, borderColor, useGradient, gradientFrom, gradientTo) {
        ...
        notification.className = 'fixed top-4 right-4 bg-green-500 text-white px-6 py-3 rounded-xl shadow-lg z-50 transition-all';
