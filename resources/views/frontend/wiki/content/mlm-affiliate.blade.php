<div class="wiki-content-section">
    ...
    <!-- Tab Navigation -->
    <div class="tab-navigation" id="mlm-tab-nav" style="display: flex; gap: 0.5rem; margin-bottom: 2rem; flex-wrap: wrap; border-bottom: 2px solid var(--wiki-border);">
        <button class="mlm-tab-btn active" onclick="switchMlmTab(this, 'binary')" style="padding: 0.75rem 1.5rem; background: linear-gradient(135deg, rgb(var(--primary-rgb)), rgb(var(--secondary-rgb))); color: white; border: none; border-radius: 8px 8px 0 0; font-weight: 600; cursor: pointer;">
            🌳 Binary System
        </button>
        <button class="mlm-tab-btn" onclick="switchMlmTab(this, 'unilevel')" style="padding: 0.75rem 1.5rem; background: var(--wiki-card-bg); color: var(--wiki-text-primary); border: 1px solid var(--wiki-border); border-bottom: none; border-radius: 8px 8px 0 0; font-weight: 600; cursor: pointer;">
            🎯 Unilevel System
        </button>
        <button class="mlm-tab-btn" onclick="switchMlmTab(this, 'commission')" style="padding: 0.75rem 1.5rem; background: var(--wiki-card-bg); color: var(--wiki-text-primary); border: 1px solid var(--wiki-border); border-bottom: none; border-radius: 8px 8px 0 0; font-weight: 600; cursor: pointer;">
            💰 Commission
        </button>
        <button class="mlm-tab-btn" onclick="switchMlmTab(this, 'rank')" style="padding: 0.75rem 1.5rem; background: var(--wiki-card-bg); color: var(--wiki-text-primary); border: 1px solid var(--wiki-border); border-bottom: none; border-radius: 8px 8px 0 0; font-weight: 600; cursor: pointer;">
            👑 Rank & Bonus
        </button>
        <button class="mlm-tab-btn" onclick="switchMlmTab(this, 'genealogy')" style="padding: 0.75rem 1.5rem; background: var(--wiki-card-bg); color: var(--wiki-text-primary); border: 1px solid var(--wiki-border); border-bottom: none; border-radius: 8px 8px 0 0; font-weight: 600; cursor: pointer;">
            📊 Genealogy
        </button>
    </div>
        ...
        <section class="wiki-section">
            ...
            <div class="info-box">
                ...
                <ul style="line-height: 2;">
                    ...
                    <li><strong>Matching Bonus:</strong> รางวัลจับคู่ที่ให้ผลตอบแทนสูง</li>
                </ul>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; margin: 2rem 0;">
                <div class="feature-card" style="border: 2px solid var(--wiki-border); transition: all 0.3s;"
                    ...
                    <ul style="font-size: 0.9rem; line-height: 1.8;">
                        ...
                        <li>✅ Weak Leg Priority (ขาอ่อนก่อน)</li>
                    </ul>
                </div>
                ...
                <div class="feature-card" style="border: 2px solid var(--wiki-border); transition: all 0.3s;"
                    ...
                    <ul style="font-size: 0.9rem; line-height: 1.8;">
                        ...
                        <li>✅ Balance Ratio (อัตราสมดุล)</li>
                    </ul>
                </div>
            </div>
            ...
            <table class="wiki-table" style="margin: 2rem 0;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>เปอร์เซ็นต์โบนัสจับคู่ (เช่น 10% ของขาที่น้อยกว่า)</td>
                    </tr>
                    <tr>
                        <td><strong>Maximum Payout</strong></td>
                        <td>จำนวนเงินสูงสุดต่อวัน/สัปดาห์ (ป้องกันจ่ายมากเกินไป)</td>
                    </tr>
                    <tr>
                        <td><strong>Flush Out</strong></td>
                        <td>ตัดยอดคงเหลือหรือยกยอดไปวันถัดไป</td>
                    </tr>
                    <tr>
                        <td><strong>Min. Active Requirement</strong></td>
                        <td>จำนวน Active Member ขั้นต่ำในแต่ละขา (เช่น ต้องมีอย่างน้อย 2:2)</td>
                    </tr>
                    <tr>
                        <td><strong>Capping</strong></td>
                        <td>จำกัดรายได้สูงสุดต่อวัน/สัปดาห์/เดือน</td>
                    </tr>
                </tbody>
            </table>
...
3. ยอดคงเหลือขาขวา = 150,000 - 100,000 = 50,000 PV (ยกไปรอบถัดไป)
        ...
        <section class="wiki-section">
            ...
            <div class="info-box success">
                ...
                <ul style="line-height: 2;">
                    ...
                    <li><strong>Level Commission:</strong> รับค่าคอมหลายระดับลึก</li>
                </ul>
            </div>
            ...
            <table class="wiki-table" style="margin: 2rem 0;">
                <thead>
                    <tr>
                        <th>Level</th>
                        <th>Commission %</th>
                        <th>ตัวอย่าง (ยอดขาย 1,000 บาท)</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td><strong>Level 1</strong> (Direct)</td>
                        <td>10%</td>
                        <td>100 บาท</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><strong>Level 8-10</strong></td>
                        <td>1%</td>
                        <td>10 บาท</td>
                    </tr>
                </tbody>
            ...
            <div class="info-box warning">
                ...
                <ul style="line-height: 2;">
                    ...
                    <li><strong>Breakaway:</strong> พิจารณาระบบ Breakaway เมื่อทีมโตเกินไป</li>
                </ul>
            </div>
        </section>
    </div>
    ...
    <div class="tab-content" data-tab-content="commission" style="display: none;">
        <section class="wiki-section">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; margin: 2rem 0;">
                ...
                <div style="background: var(--wiki-card-bg); border: 2px solid var(--wiki-border); border-radius: 12px; padding: 1.5rem; transition: all 0.3s;"
                    ...
                    <ul style="list-style: none; padding-left: 0; font-size: 0.9rem; line-height: 1.8;">
                        ...
                        <li>• Flush Out หรือ Carry Forward</li>
                    </ul>
                </div>
                ...
                <div style="background: var(--wiki-card-bg); border: 2px solid var(--wiki-border); border-radius: 12px; padding: 1.5rem; transition: all 0.3s;"
                    ...
                    <ul style="list-style: none; padding-left: 0; font-size: 0.9rem; line-height: 1.8;">
                        ...
                        <li>• Compression ยอด Inactive</li>
                    </ul>
                </div>
            ...
            <div class="info-box success">
                <h4>⚡ Real-time Commission Processing</h4>
        ...
        <section class="wiki-section">
            ...
            <div class="info-box success">
                ...
                <ul style="line-height: 2;">
                    ...
                    <li><strong>🚗 รถยนต์:</strong> Diamond ขึ้นไป (ค่าผ่อนรถยนต์ฟรี)</li>
                    <li><strong>🏠 บ้าน:</strong> Crown Diamond (บ้านหลังแรกฟรี!)</li>
                </ul>
            </div>
        ...
        <section class="wiki-section">
            ...
            <div class="info-box">
                ...
                <ul style="line-height: 2;">
                    ...
                    <li><strong>ติดตามผลงาน:</strong> ดูยอดขายและผลงานของแต่ละคน</li>
                </ul>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; margin: 2rem 0;">
                <div class="feature-card">
                    ...
                    <ul style="font-size: 0.9rem; line-height: 1.8;">
                        ...
                        <li>✅ Search Member (ค้นหาสมาชิก)</li>
                    </ul>
                </div>
            ...
            <div class="info-box tip">
                ...
                <ul style="line-height: 2;">
                    ...
                    <li><strong>Celebrate Success:</strong> แสดงความยินดีเมื่อมีคนในทีมขึ้นยศ</li>
                </ul>
            </div>
        </section>
    </div>
...
<script>
function switchMlmTab(clickedButton, targetTab) {
    ...
    console.log('MLM Tab clicked:', targetTab);

    // Get all buttons and contents within this specific tab navigation
    const tabNav = document.getElementById('mlm-tab-nav');
    const allButtons = tabNav.querySelectorAll('.mlm-tab-btn');
    ...
    if (targetContent) {
        ...
        console.log('MLM Tab content shown:', targetTab);
    } else {
        console.error('MLM Tab content not found:', targetTab);
    }
}
</script>
