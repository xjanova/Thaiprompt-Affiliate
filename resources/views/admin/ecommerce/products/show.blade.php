        ...
        <div class="relative flex flex-col md:flex-row md:justify-between md:items-center gap-4">
            <div class="flex items-center gap-4">
                ...
                <div class="text-white">
                    <h1 class="text-3xl md:text-4xl font-bold mb-1">รายละเอียดสินค้า</h1>
                    <p class="text-white/90 text-sm md:text-base">ข้อมูลสินค้าและสถิติการขาย</p>
                </div>
            </div>
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('admin.ecommerce.products.edit', $product) }}" class="group relative bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 px-6 py-3 rounded-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex items-center gap-2 font-semibold">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.ecommerce.products.index') }}" class="bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white px-6 py-3 rounded-xl transition-all duration-200 flex items-center gap-2 font-semibold">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-slate-700 dark:to-slate-800 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">ข้อมูลสินค้า</h3>
                    </div>
                </div>
                        ...
                        <div class="flex-1 space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div class="flex items-start gap-3 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-0.5">หมวดหมู่</p>
                                ...
                                <div class="flex items-start gap-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-0.5">ราคาขาย</p>
                                        <div class="flex items-baseline gap-2">
                                            <p class="text-2xl font-bold text-gray-900 dark:text-white">฿{{ number_format($product->price, 2) }}</p>
                                            @if($product->compare_at_price && $product->compare_at_price > $product->price)
                                                <span class="text-sm text-gray-500 dark:text-gray-400 line-through">฿{{ number_format($product->compare_at_price, 2) }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-3 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-0.5">สต็อก</p>
                                ...
                                <div class="flex items-start gap-3 p-3 bg-pink-50 dark:bg-pink-900/20 rounded-lg">
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-0.5">คอมมิชชั่น</p>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="group bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 rounded-xl shadow-lg p-5 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                    ...
                    <p class="text-white/80 text-sm mb-1">ยอดขาย</p>
                    <p class="text-3xl font-bold text-white">{{ number_format($stats['total_sales'] ?? 0) }}</p>
                    <p class="text-white/70 text-xs mt-1">ชิ้น</p>
                </div>
                ...
                <div class="group bg-gradient-to-br from-green-500 to-green-600 dark:from-green-600 dark:to-green-700 rounded-xl shadow-lg p-5 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                    ...
                    <p class="text-white/80 text-sm mb-1">รายได้</p>
                    <p class="text-3xl font-bold text-white">฿{{ number_format($stats['total_revenue'] ?? 0) }}</p>
                    <p class="text-white/70 text-xs mt-1">บาท</p>
                </div>
                ...
                <div class="group bg-gradient-to-br from-yellow-500 to-orange-600 dark:from-yellow-600 dark:to-orange-700 rounded-xl shadow-lg p-5 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                    ...
                    <p class="text-white/80 text-sm mb-1">รีวิว</p>
                    <p class="text-3xl font-bold text-white">{{ number_format($stats['total_reviews'] ?? 0) }}</p>
                    <p class="text-white/70 text-xs mt-1">รายการ</p>
                </div>
                ...
                <div class="group bg-gradient-to-br from-purple-500 to-pink-600 dark:from-purple-600 dark:to-pink-700 rounded-xl shadow-lg p-5 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                    ...
                    <p class="text-white/80 text-sm mb-1">คะแนน</p>
                    <p class="text-3xl font-bold text-white">{{ number_format($stats['average_rating'] ?? 0, 1) }}</p>
                    <p class="text-white/70 text-xs mt-1">⭐ ดาว</p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-slate-700 dark:to-slate-800 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">การกระทำ</h3>
                    </div>
                </div>

                <div class="p-6 space-y-3">
                    <a href="{{ route('admin.ecommerce.products.edit', $product) }}" class="flex items-center gap-3 w-full px-4 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                        </svg>
                        แก้ไขสินค้า
                    ...
                    <a href="{{ route('admin.ecommerce.products.index') }}" class="flex items-center gap-3 w-full px-4 py-3 bg-gray-600 hover:bg-gray-700 text-white rounded-lg font-medium transition-all duration-300">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
                        </svg>
                        กลับรายการสินค้า
                    ...
                    <form action="{{ route('admin.ecommerce.products.delete', $product) }}" method="POST" onsubmit="return confirm('⚠️ คุณแน่ใจหรือไม่ที่จะลบสินค้า &quot;{{ $product->name }}&quot;?')">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="flex items-center gap-3 w-full px-4 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg font-medium transition-all duration-300">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-slate-700 dark:to-slate-800 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">ข้อมูลเพิ่มเติม</h3>
                    </div>
                </div>
                ...
                <div class="p-6 space-y-4">
                    <div class="flex items-start gap-3 p-3 bg-gray-50 dark:bg-slate-700/50 rounded-lg">
                        ...
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mb-0.5">สร้างเมื่อ</p>
                            <p class="text-sm font-semibold text-gray-900 dark:text-white">{{ $product->created_at->format('d/m/Y H:i น.') }}</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{{ $product->created_at->diffForHumans() }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-3 p-3 bg-gray-50 dark:bg-slate-700/50 rounded-lg">
                        ...
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mb-0.5">แก้ไขล่าสุด</p>
                            <p class="text-sm font-semibold text-gray-900 dark:text-white">{{ $product->updated_at->format('d/m/Y H:i น.') }}</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{{ $product->updated_at->diffForHumans() }}</p>
                        </div>
                    </div>

                    @if($product->is_featured)
                        <div class="flex items-center gap-3 p-3 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                            <svg class="w-5 h-5 text-yellow-500 dark:text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                            </svg>
                            <span class="text-sm font-semibold text-yellow-800 dark:text-yellow-200">⭐ สินค้าแนะนำ</span>
                        </div>
                    @endif

                    @if($product->track_inventory)
                        <div class="flex items-center gap-3 p-3 bg-gradient-to-r from-green-50 to-teal-50 dark:from-green-900/20 dark:to-teal-900/20 rounded-lg border border-green-200 dark:border-green-800">
                            ...
                            <span class="text-sm font-semibold text-green-800 dark:text-green-200">📊 ติดตามสต็อก</span>
                        </div>
                    @endif
                </div>
            </div>
