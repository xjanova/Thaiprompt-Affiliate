 ...
 *   คู่ตำแหน่ง: 1↔2 (ครอส) · 5↔6 (อดีต→อนาคต) · 4↔3 (ใต้-บน) ·
...
return [
    ...
    // [a, b, ชื่อคู่]
    'celtic_pairs' => [
        // ⚠️ (2026-06-18) ต.3=จิตสำนึก/เป้าหมาย, ต.5=อดีต (ตาม CELTIC_POSITIONS) — เดิม 3/5 สลับ = label ผิด
        [1, 2, '🎯 ปัจจุบัน × ขัดขวาง'],
        [5, 6, '⏰ อดีต → อนาคต (ทิศทางเวลา)'],
        [4, 3, '🧠 จิตใต้สำนึก × จิตสำนึก (ใต้-บน)'],
