...
trait FreeCardConversationTrait
{
    ...
    protected function matchesFreeCardKeyword(string $text): bool
    {
        ...
        //
        // 🎁 (2026-08-21) ผ่อนให้รับคำว่า "ดวง" เดี่ยว ๆ ด้วย
        //   เดิมบังคับต้องมี "ทำนาย" หรือ "ดูดวง" ⇒ "ดวงฟรี" / "มีดวงฟรีไหม" ตกทุกด่าน
        //   แล้วตกไปถึง AI chat ซึ่งเคยตอบมั่วว่า "ปิดบริการไปแล้ว" ใส่คนที่มาขอของฟรี
        //   ⚠️ ห้ามใส่คำที่มีรอบเวลา (รายวัน/ประจำวัน/วันนี้) ที่นี่ —
        //      พวกนั้นเป็นของดวงรายวัน ซึ่ง looksLikeDailyIntent() รับไปก่อนแล้ว
        if (mb_strpos($clean, 'ฟรี') !== false &&
            preg_match('/(ทำนาย|ดูดวง|ดวง|ดูให้|เปิดไพ่)/u', $clean)) {
        ...
        try {
            ...
            return [
                ...
                'message' => FortuneLocaleService::lo(
                    "🙏 ขออภัยค่ะ ตอนนี้แม่หมอขอสับไพ่ใหม่อีกครั้งนะคะ\nลองทักมาใหม่ในอีกครู่ได้นะคะ ✨",
