...
/**
 * @title TPIX DEX Router 02
 * @notice Router contract for swapping and managing liquidity
 * @dev Stateless contract that routes swaps and liquidity operations
 */
contract TPIXDEXRouter02 {
    ...
    function removeLiquidity(
        ...
        address pair = TPIXDEXLibrary.pairFor(factory, tokenA, tokenB);
        ITPIXDEXPair(pair).transferFrom(msg.sender, pair, liquidity); // send liquidity to pair
