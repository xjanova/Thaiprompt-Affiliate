...
class LineFortuneWebhookController extends Controller
{
    ...
    {
        // 🔁 (2026-09-13) ย้ายไป ChatSpamGuard (ใช้ร่วมกับ Telegram) — key/พฤติกรรมเดิมเป๊ะ
        return app(\App\Services\Fortune\ChatSpamGuard::class)->isSpamming('line', $userId, $text, $messageType);
    }
