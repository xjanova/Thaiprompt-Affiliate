...
- ไพ่ยิปซีต้อง **เสริม** คำทำนายหลัก ไม่ใช่มุมขัด — ถ้าไพ่หงายแต่ดวงร้าย ให้อธิบายว่า "ไพ่แสดงโอกาสที่มี แต่ดวงชี้ว่าต้องแก้ X ก่อน"';
    ...
    public const NO_HEDGE_DIRECTIVE =
        ...
        ."- ❌ ห้ามตอบลอยๆ ว่า \"ขึ้นกับตัวเอง / แล้วแต่เจ้าชะตา / ต้องดูกันต่อ / ไปถามใหม่\" — เจ้าชะตามาหาแม่หมอเพื่อให้ตัดสินใจให้\n"
...
- ✅ **ต้องบอกตรงๆ ทันที** ว่าจ่ายด้วย **บัตรเครดิต/เดบิต** ได้เลย ระบบส่งลิงก์ให้ ไม่ต้องโอนเข้าบัญชีไทย
  * ตัวอย่าง: "เจ้าชะตาอยู่ต่างประเทศ โอนเข้าพร้อมเพย์ไทยไม่ได้นะคะ — ใช้บัตรเครดิตหรือเดบิตได้เลย
...
- ถ้ามีบิลค้างอยู่ ระบบจะยื่นปุ่มยืนยันสลับไปเลนบัตรให้เอง — หน้าที่ของเธอคือ *อธิบายให้เขาเข้าใจ* ว่าทำไมต้องใช้บัตร
        ...
        try {
            ...
            if ($chart !== '' && ! str_starts_with($chart, '(วันเกิด:')) {
                return "=== 🪐 ดวงพื้นของเจ้าชะตา (คำนวณจริงจากวันเกิด) ===\n"
                    ...
                    .'⭐ ตัวเลข/องศาเป็นข้อมูลเบื้องหลัง — ❌ ห้ามบรรยายให้ลูกค้าฟัง ให้สรุปเป็นผลที่เจ้าชะตาควรรู้เลย';
            }
        } catch (\Throwable $e) {
