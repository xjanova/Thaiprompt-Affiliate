...
<div class="min-h-screen bg-gray-50 dark:bg-slate-900 py-6 px-4 sm:px-6 lg:px-8" x-data="{
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-4">
            ...
            @else
                <div class="px-4 py-2 bg-gray-200 dark:bg-slate-700 text-gray-600 dark:text-gray-400 rounded-xl font-bold flex items-center gap-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <textarea name="system_prompt" rows="8"
                                  ...
                                  class="w-full px-4 py-3 border-2 border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white rounded-xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-300 font-mono text-sm">{{ old('system_prompt', $aiSetting->system_prompt) }}</textarea>
                    ...
                    <div class="p-6">
                        ...
                        <div x-show="enableFallback">
                            ...
                            <textarea name="fallback_message" rows="4"
                                      ...
                                      class="w-full px-4 py-3 border-2 border-gray-200 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white rounded-xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-300">{{ old('fallback_message', $aiSetting->fallback_message) }}</textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-2xl border-2 border-indigo-200 dark:border-indigo-800 p-6">
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex items-center justify-between p-3 bg-white dark:bg-slate-800 rounded-xl">
