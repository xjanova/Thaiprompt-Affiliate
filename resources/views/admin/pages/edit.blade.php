...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">อัปเดตเนื้อหาหน้าเพจ</p>
        </div>
    </div>

    <!-- Form -->
    <form action="{{ route('admin.pages.update', $page) }}" method="POST" class="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="content" rows="15" required
                          class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500 font-mono text-sm @error('content') border-red-500 @enderror">{{ old('content', $page->content) }}</textarea>
