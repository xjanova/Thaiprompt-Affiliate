...
<div class="space-y-6">
    ...
    <form action="{{ route('admin.tpix.update-settings') }}" method="POST">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input
                            ...
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                            required
                        >
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">ราคา 1 TPIX เป็นเงินบาท</p>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">เปอร์เซ็นต์ค่าธรรมเนียมการแลกเปลี่ยน</p>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        >
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                            <span class="text-gray-500 dark:text-gray-400">TPIX</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center pt-8">
                    <label class="flex items-center cursor-pointer">
                        <input
                            ...
                            class="w-5 h-5 text-blue-600 bg-gray-100 dark:bg-slate-700 border-gray-300 dark:border-slate-600 rounded focus:ring-blue-500 dark:focus:ring-blue-600 focus:ring-2"
                        >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                    >
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">จำนวนยืนยันก่อนถือว่าธุรกรรมสำเร็จ</p>
                </div>
        ...
        <div class="flex items-center gap-4">
            <button
                type="submit"
                class="px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-300"
            >
            ...
            <a
                ...
                class="px-6 py-4 bg-gray-200 dark:bg-slate-700 hover:bg-gray-300 dark:hover:bg-slate-600 text-gray-700 dark:text-gray-300 font-semibold rounded-lg transition"
            >
                ยกเลิก
            </a>
        </div>
