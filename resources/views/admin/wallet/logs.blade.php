...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">ประวัติความปลอดภัย</h2>
                <p class="text-gray-600 mt-1">บันทึกกิจกรรมและการแจ้งเตือนด้านความปลอดภัย</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">การกระทำ</label>
            ...
            <div>
                ...
                <select name="severity" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
                    <option value="">ทั้งหมด</option>
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('admin.wallet.logs') }}" class="px-6 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition">
                    ล้างตัวกรอง
                </a>
            </div>
        </form>
    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        <div class="space-y-4">
            @forelse($logs as $log)
            <div class="flex items-start p-4 rounded-lg hover:bg-gray-50 transition border-l-4 border-{{ $log->severity_color }}-500">
                ...
                <div class="ml-4 flex-1">
                    ...
                    <details class="mt-2">
                        ...
                        <pre class="text-xs bg-gray-100 p-2 rounded mt-2 overflow-auto">{{ json_encode($log->metadata, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) }}</pre>
                    </details>
                    @endif
                </div>
            </div>
