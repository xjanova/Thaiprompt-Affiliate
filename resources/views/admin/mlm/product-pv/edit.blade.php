        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <span class="inline-flex items-center px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-lg font-medium">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="pv_value" id="pvValue" step="0.01" min="0"
                                       ...
                                       class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl pl-12 pr-4 py-3 text-lg font-bold focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400"
                            ...
                            <div class="mt-4 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl border border-purple-200 dark:border-purple-800">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-medium text-gray-700 dark:text-gray-300">PV เป็นเปอร์เซ็นต์ของราคา</p>
                                        <p class="text-2xl font-bold text-purple-600 dark:text-purple-400" id="pvPercentage">0%</p>
                                    </div>
                                    <button type="button" onclick="setPvFromPrice()" class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-sm font-medium transition-colors">
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                            <label class="flex items-center gap-3 cursor-pointer group">
                                <input type="checkbox" name="use_global_rate" id="useGlobalRate"
                                       ...
                                       class="w-6 h-6 rounded-lg border-gray-300 dark:border-gray-600 text-green-600 focus:ring-green-500 dark:focus:ring-green-400"
                        ...
                        <div id="customRateSection" class="{{ old('use_global_rate', $productPv->use_global_rate) ? 'hidden' : '' }}">
                            ...
                            <div class="relative">
                                <input type="number" name="custom_commission_per_pv" id="customCommissionPv" step="0.01" min="0"
                                       ...
                                       class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl pl-12 pr-4 py-3 text-lg font-bold focus:ring-2 focus:ring-green-500 dark:focus:ring-green-400"
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                            <input type="checkbox" name="show_pv_on_product_page" id="showPv"
                                   ...
                                   class="mt-1 w-5 h-5 rounded border-gray-300 dark:border-gray-600 text-blue-600 focus:ring-blue-500 dark:focus:ring-blue-400">
                            <div class="flex-1">
                        ...
                        <div class="flex items-start gap-3 p-4 bg-green-50 dark:bg-green-900/20 rounded-xl border border-green-200 dark:border-green-800">
                            <input type="checkbox" name="show_commission_preview" id="showCommission"
                                   ...
                                   class="mt-1 w-5 h-5 rounded border-gray-300 dark:border-gray-600 text-green-600 focus:ring-green-500 dark:focus:ring-green-400">
                            <div class="flex-1">
                ...
                <div class="flex gap-4">
                    <a href="{{ route('admin.mlm.product-pv.index') }}"
                       class="flex-1 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-900 dark:text-white px-6 py-3 rounded-xl font-semibold text-center transition-colors">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gradient-to-br from-yellow-400 to-orange-500 dark:from-yellow-600 dark:to-orange-700 rounded-2xl shadow-2xl p-6 text-white sticky top-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Total Commission -->
                        <div class="bg-white/30 backdrop-blur-sm rounded-xl p-4 border-2 border-white/50">
                        ...
                        <!-- Note -->
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-3 text-xs opacity-75">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center pb-3 border-b border-gray-200 dark:border-gray-700">
                            <span class="text-sm text-gray-600 dark:text-gray-400">ราคาสินค้า</span>
                            <span class="font-bold text-gray-900 dark:text-white">฿{{ number_format($productPv->product->price, 2) }}</span>
                        </div>
                        <div class="flex justify-between items-center pb-3 border-b border-gray-200 dark:border-gray-700">
                            <span class="text-sm text-gray-600 dark:text-gray-400">PV ปัจจุบัน</span>
                            <span class="font-bold text-purple-600 dark:text-purple-400">{{ number_format($productPv->pv_value, 2) }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-sm text-gray-600 dark:text-gray-400">Global Rate</span>
