...
<div class="space-y-6">
        ...
        <div class="relative flex items-center justify-between">
            <div>
                <div class="flex items-center space-x-4 mb-4">
                    <div class="w-20 h-20 glass-fusion backdrop-blur-sm rounded-2xl flex items-center justify-center" border border-white/20 dark:border-white/10>
        ...
        <form method="GET" class="flex items-center space-x-4">
            <div class="flex-1">
                <div class="relative">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="ค้นหา Master Wallet, ผู้ใช้, อีเมล..." class="w-full pl-12 pr-4 py-3 border border-gray-300 dark:border-gray-600 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-transparent">
                </div>
            </div>
            ...
            @if(request('search'))
            <a href="{{ route('admin.crypto.master-wallets.index') }}" class="px-8 py-3 bg-gray-100/50 dark:bg-gray-800/50 hover:bg-gray-200 dark:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 dark:text-gray-300 font-bold rounded-xl transition-all">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all transform hover:scale-[1.02]" border border-white/20 dark:border-white/10>
            <!-- Header with Gradient -->
            <div class="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 p-6 relative overflow-hidden">
                <div class="absolute top-0 right-0 w-32 h-32 glass-fusion opacity-10 rounded-full -mr-16 -mt-16" border border-white/20 dark:border-white/10></div>
                <div class="relative flex items-center justify-between">
                    <div>
                        <div class="flex items-center space-x-2 mb-2">
                            <i class="fas fa-crown text-2xl text-white"></i>
                            <span class="px-3 py-1 glass-fusion backdrop-blur-sm text-white text-xs font-bold rounded-full">MASTER</span>
                        </div>
            ...
            <div class="p-6">
                <!-- Owner Info -->
                <div class="flex items-center space-x-3 mb-6 pb-6 border-b border-gray-200 dark:border-gray-700 dark:border-gray-700">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400">{{ $wallet->user->email }}</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-4 mb-6">
                    ...
                    <div class="text-center p-4 bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 rounded-xl border border-emerald-200 dark:border-emerald-800">
                        ...
                        <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400">Index</p>
                    </div>
            ...
            <!-- Footer -->
            <div class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:bg-gray-900 px-6 py-3 flex items-center justify-between border-t border-gray-200 dark:border-gray-700 dark:border-gray-700">
                ...
                <div class="flex items-center space-x-2">
                    @if($wallet->status === 'active')
                        <button onclick="lockWallet({{ $wallet->id }})" class="p-2 bg-yellow-100 hover:bg-yellow-200 dark:bg-yellow-900 dark:hover:bg-yellow-800 text-yellow-600 dark:text-yellow-300 rounded-xl transition-colors" title="ล็อก">
        ...
        @empty
        <div class="col-span-2 glass-fusion dark:bg-gray-800 rounded-2xl shadow-xl p-16 text-center" border border-white/20 dark:border-white/10>
            ...
            <p class="text-gray-600 dark:text-gray-400 dark:text-gray-400">ยังไม่มี Master Wallet ในระบบ</p>
        </div>
        @endforelse
    </div>
