...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <!-- Form -->
    <form action="{{ route('admin.email.templates.store') }}" method="POST" class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                @enderror
                <p class="mt-1 text-xs text-gray-500">ใช้ snake_case เช่น welcome_email, password_reset</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <select name="language" class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white" required>
        ...
        <div>
            ...
            @error('body_html')
                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
            @enderror
            <p class="mt-1 text-xs text-gray-500">สามารถใช้ HTML Tags และ Variables ได้</p>
        </div>
        ...
        <div>
            ...
            <p class="mt-1 text-xs text-gray-500">Optional - สำหรับ email client ที่ไม่รองรับ HTML</p>
        </div>
        ...
        <div>
            ...
            <p class="mt-1 text-xs text-gray-500">ตัวแปรที่ใช้ใน Template เช่น user_name, app_name</p>
        </div>
