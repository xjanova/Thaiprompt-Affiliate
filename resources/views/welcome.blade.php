...
<body class="bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 min-h-screen">
    ...
    <section id="systems" class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            ...
            <!-- E-Commerce -->
            <a href="{{ route('storefront.index') }}" class="group p-6 bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-500 transition-all hover:shadow-xl">
                <div class="flex items-center justify-between mb-4">
            ...
            <!-- AI Bots Marketplace -->
            <a href="{{ route('marketplace.index') }}" class="group p-6 bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-200 dark:border-gray-700 hover:border-orange-500 dark:hover:border-orange-500 transition-all hover:shadow-xl">
                <div class="flex items-center justify-between mb-4">
