...
class SendBillReminderJob implements ShouldQueue
{
    ...
    private function buildSystemMessage(string $personaContext, bool $isAwaitingMethod = false): string
    {
        ...
        $missionLine = $isAwaitingMethod
            ? 'ภารกิจ: ลูกค้าเห็นปุ่มเลือกวิธีชำระเงิน (QR ไทย / บัตรเครดิต) แต่ยังลังเล ไม่ได้กดเลือก ผ่านมาแค่ 1 นาทีเอง — ทักไปกระตุ้นเบา ๆ + เปิดทางขอช่วยถ้าติดขัด'
            : 'ภารกิจ: ลูกค้าสร้างบิลดูดวงไว้แต่ยังไม่ได้โอนเงิน (ผ่านมา 1+ นาที) — ทักไปด้วยความห่วงใย + เล่า benefit (สิ่งที่จะได้รับหลังโอน) ไม่ใช่ทวงแบบเจ้าหนี้';
        ...
        $bulletGoals = $isAwaitingMethod
            ...
            : "1. ทักไปทันใจ — \"แม่หมอเห็นว่าเจ้าชะตายังไม่ได้โอนนะคะ\"\n"
                ."2. เล่า benefit สิ่งที่จะได้รับหลังโอน — ตัวอย่าง: \"เมื่อโอนแล้วแม่หมอจะเปิดไพ่ 10 ใบทำนายให้เลยนะคะ\" หรือ \"พอโอนเสร็จ ดาวเจ้าชนะกับไพ่ที่จิตเลือกจะเรียงให้ทันที\"\n"
                .'3. เปิดทางเลือก — "ติดขัดตรงไหนบอกแม่หมอได้นะคะ / ถ้าไม่สะดวก พิมพ์ \'ยกเลิก\' ได้"';

        // 🌙 (2026-05-24) ตัวอย่าง tone ที่ user ระบุ — ให้ AI เลียนแบบสไตล์
        $toneExamples = $isAwaitingMethod
            ? "ตัวอย่าง tone ที่ดี (เลียน \"จังหวะ\" — ไม่ copy):\n"
                ."- \"🌙 ยังลังเลอยู่ใช่ไหมคะ? ถ้าใช้พร้อมเพย์ในไทย กดปุ่ม QR ได้เลย ส่วนบัตรเครดิตใช้ได้ทุกประเทศ ติดตรงไหนทักบอกแม่หมอนะคะ ✨\"\n"
                ."- \"แม่หมอรอเปิดไพ่ให้อยู่นะคะ เลือกวิธีไหนสะดวกแล้วบอกได้เลย หรือไม่สะดวกตอนนี้ทักมาคุยก่อนได้ค่ะ 🙏\"\n"
            : "ตัวอย่าง tone ที่ดี (เลียน \"จังหวะ\" — ไม่ copy):\n"
                ."- \"🌙 เมื่อโอนแล้วแม่หมอจะเปิดไพ่ 10 ใบเพื่อทำนายให้นะคะ ดาวเจ้าชนะกำลังเรียงอยู่ค่ะ ✨\"\n"
                ."- \"พอโอนเสร็จ ระบบจะรู้อัตโนมัติแล้วแม่หมอจะเปิดไพ่ให้ทันที ไม่ต้องส่งสลิปนะคะ 🪷\"\n"
                ."- \"ถ้าติดขัดตรงไหน ทักบอกแม่หมอได้เลยค่ะ ถ้าจะยกเลิก พิมพ์ 'ยกเลิก' ได้นะคะ 🙏\"\n";
...
- ✅ ความยาว 2-4 ประโยค กระชับ ใจเย็น (1 นาทีเร็ว — สั้นกว่าเดิม)
