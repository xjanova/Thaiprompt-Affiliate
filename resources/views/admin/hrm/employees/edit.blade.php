...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-cyan-600 rounded-xl shadow-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold mb-1">➕ แก้ไขข้อมูลพนักงาน</h1>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.hrm.employees.update', $employee) }}" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="id_card_number" value="{{ old('id_card_number', $employee->id_card_number) }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="basic_salary" value="{{ old('basic_salary', $employee->basic_salary) }}" required step="0.01"
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="email" name="work_email" value="{{ old('work_email', $employee->work_email) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="mobile_phone" value="{{ old('mobile_phone', $employee->mobile_phone) }}" required
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="current_address" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('current_address', $employee->current_address) }}</textarea>
                </div>
            </div>
        </div>
