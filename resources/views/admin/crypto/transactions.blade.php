...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 rounded-2xl shadow-2xl p-8 text-white relative overflow-hidden">
        ...
        <div class="relative z-10 flex items-center justify-between">
            ...
            <a href="{{ route('admin.crypto.dashboard') }}" class="glass-fusion bg-opacity-20 hover:bg-opacity-30 px-6 py-3 rounded-xl transition font-semibold">
                ← กลับ Dashboard
            </a>
        </div>
    </div>
    ...
    <div class="glass-fusion dark:bg-slate-800 rounded-2xl shadow-xl p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
                ...
                <select name="type" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-cyan-500">
            ...
            <div>
                ...
                <select name="status" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-cyan-500">
                    <option value="">ทั้งหมด</option>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">สกุลเงิน</label>
                <select name="currency" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-cyan-500">
                    <option value="">ทั้งหมด</option>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">TX Hash</label>
                <input type="text" name="tx_hash" value="{{ request('tx_hash') }}"
                    placeholder="ค้นหา TX Hash"
                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-cyan-500">
            </div>

            <div class="md:col-span-4 flex gap-2">
                <button type="submit" class="px-6 py-2 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white rounded-xl transition font-semibold shadow-lg">
                    🔍 ค้นหา
                </button>
                <a href="{{ route('admin.crypto.transactions') }}" class="px-6 py-2 bg-gray-100/50 dark:bg-gray-800/50 dark:bg-slate-700 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-slate-600 text-gray-700 dark:text-gray-300 dark:text-gray-300 rounded-xl transition font-semibold">
                    ล้างตัวกรอง
                </a>
            </div>
        </form>
    ...
    <div class="glass-fusion dark:bg-slate-800 rounded-2xl shadow-xl overflow-hidden" border border-white/20 dark:border-white/10>
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 dark:border-slate-700">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                <thead class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:bg-slate-900">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase tracking-wider">ผู้ใช้</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase tracking-wider">ประเภท</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase tracking-wider">จำนวน</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase tracking-wider">มูลค่า (THB)</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase tracking-wider">TX Hash</th>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase tracking-wider">วันที่</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase tracking-wider">การกระทำ</th>
                    </tr>
                </thead>
                <tbody class="glass-fusion dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700">
                    ...
                    <tr class="hover:bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:hover:bg-slate-700 transition">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-xs font-mono text-gray-500 dark:text-gray-400 dark:text-gray-400 max-w-xs truncate">
        ...
        <div class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:bg-slate-900 px-6 py-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="style="background: var(--arrow-x-success-gradient)" rounded-2xl shadow-xl p-6 text-white">
        ...
        <div class="style="background: var(--arrow-x-warning-gradient)" rounded-2xl shadow-xl p-6 text-white">
            <div class="text-3xl mb-2">📤</div>
