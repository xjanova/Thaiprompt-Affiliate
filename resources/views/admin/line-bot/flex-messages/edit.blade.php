...
<div class="container-fluid px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-2">
            <a href="{{ route('admin.line-bot.flex.index') }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name', $template->name ?? '') }}" required
                                class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-pink-500">
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Category</label>
                            <select name="category" class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-pink-500">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3" class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-pink-500">{{ old('description', $template->description ?? '') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass-fusion rounded-2xl shadow-lg border border-gray-100 p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                    ...
                    <textarea name="flex_content" id="flex-json" rows="20"
                        class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-pink-500 font-mono text-sm"
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="glass-fusion rounded-2xl shadow-lg border border-gray-100 p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">Check out our pre-made templates for inspiration</p>
        ...
        <div class="mt-8">
            <div class="glass-fusion rounded-2xl shadow-lg border border-gray-100 p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                <div class="flex items-center justify-between">
                    <a href="{{ route('admin.line-bot.flex.index') }}" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 text-sm">
