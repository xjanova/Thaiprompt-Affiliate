...
<div class="space-y-6">
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-purple-100">ภาพรวมระบบ TPIX Blockchain และ Smart Contracts</p>
                </div>
                <div class="text-right">
                    <div class="text-sm text-purple-200 mb-1">Current Block</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        {{-- Total Supply --}}
        <div class="relative overflow-hidden bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-5 text-white">
            <div class="absolute top-0 right-0 -mt-2 -mr-2 w-20 h-20 bg-white opacity-10 rounded-full"></div>
            <div class="relative z-10">
                <div class="text-3xl mb-2">💎</div>
                <p class="text-xs text-blue-100 mb-1">Total Supply</p>
                <p class="text-2xl font-bold">{{ number_format($stats['total_supply']) }}</p>
                <p class="text-xs text-blue-200 mt-1">TPIX</p>
            </div>
        </div>

        {{-- Circulating Supply --}}
        <div class="relative overflow-hidden bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-lg p-5 text-white">
            <div class="absolute top-0 right-0 -mt-2 -mr-2 w-20 h-20 bg-white opacity-10 rounded-full"></div>
            <div class="relative z-10">
                <div class="text-3xl mb-2">🔄</div>
        ...
        {{-- 24h Transactions --}}
        <div class="relative overflow-hidden bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl shadow-lg p-5 text-white">
            <div class="absolute top-0 right-0 -mt-2 -mr-2 w-20 h-20 bg-white opacity-10 rounded-full"></div>
            <div class="relative z-10">
                <div class="text-3xl mb-2">📊</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a href="{{ route('admin.tpix.transactions', ['type' => 'deposit', 'status' => 'pending']) }}" class="relative overflow-hidden bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition duration-300 block cursor-pointer">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="px-2 py-1 bg-white bg-opacity-20 rounded-lg text-xs font-semibold animate-pulse">
                        รอดำเนินการ
                    </span>
                    @endif
                </div>
        ...
        {{-- Pending Withdrawals --}}
        <a href="{{ route('admin.tpix.transactions', ['type' => 'withdrawal', 'status' => 'pending']) }}" class="relative overflow-hidden bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition duration-300 block cursor-pointer">
            <div class="absolute top-0 right-0 -mt-4 -mr-4">
                <div class="w-24 h-24 bg-white opacity-10 rounded-full"></div>
            </div>
            <div class="relative z-10">
        ...
        <a href="{{ route('admin.tpix.network-status') }}" class="relative overflow-hidden bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl shadow-xl p-6 text-white transform hover:scale-105 transition duration-300 block cursor-pointer">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-4">
                    <div class="text-5xl">🌐</div>
                    <span class="px-2 py-1 bg-green-500 bg-opacity-80 rounded-lg text-xs font-semibold">
                        ● Online
                    </span>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-slate-700 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-600 transition">
