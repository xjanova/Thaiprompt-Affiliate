  ...
  const element = (
    <>
      <ConsentSheet
        ...
        reasons={[
          { icon: 'moped', text: 'ใช้ตำแหน่งเฉพาะตอนคุณออนไลน์รับงานหรือกำลังส่งงาน' },
          { icon: 'map-trifold', text: 'ใช้จัดลำดับงานที่ใกล้ที่สุดและคำนวณระยะทาง' },
          { icon: 'power', text: 'กดหยุดรับงานเมื่อไหร่ แอปก็หยุดใช้ตำแหน่งทันที' },
        ]}
      ...
      <ConsentSheet
        ...
        reasons={[
          { icon: 'package', text: 'เก็บตำแหน่งเฉพาะช่วงที่คุณมีงานส่งอยู่เท่านั้น' },
          { icon: 'bell-ringing', text: 'จะมีแจ้งเตือนค้างบนเครื่องตลอดเวลาที่กำลังติดตาม' },
          { icon: 'power', text: 'หยุดทันทีเมื่อส่งสำเร็จ ส่งไม่สำเร็จ คืนงาน หรืองานถูกยกเลิก' },
          { icon: 'thumbs-up', text: 'ถ้าไม่อนุญาต ยังรับงานได้ แต่ตำแหน่งจะอัปเดตเฉพาะตอนเปิดแอปไว้' },
        ]}
      ...
      <ConsentSheet
        ...
        reasons={[
          { icon: 'eye', text: 'ลูกค้าเห็นตำแหน่งคุณเฉพาะออเดอร์ที่คุณกำลังส่งเท่านั้น' },
          { icon: 'navigation-arrow', text: 'เริ่มแชร์เมื่อรับงาน และหยุดเองเมื่อส่งเสร็จหรือยกเลิกงาน' },
          { icon: 'lock', text: 'ไม่แชร์ตอนออฟไลน์หรือตอนที่ไม่มีงาน' },
          { icon: 'check-circle', text: 'ยอมรับครั้งเดียว ใช้ได้ทุกงาน' },
        ]}
        acceptLabel="ยอมรับ"
