        ...
        <div class="relative flex items-center justify-between">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    <div class="w-14 h-14 rounded-xl glass-fusion backdrop-blur-sm flex items-center justify-center" border border-white/20 dark:border-white/10 border border-white/20 dark:border-white/10>
    ...
    <form method="POST" action="{{ route('admin.line-oa.update') }}">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <!-- System Status Card -->
                <div class="glass-fusion rounded-2xl shadow-lg border border-gray-100 overflow-hidden" border border-white/20 dark:border-white/10 border border-white/20 dark:border-white/10>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Activate LINE Official Account integration</p>
                            </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="login_channel_id" value="{{ old('login_channel_id', $settings->login_channel_id) }}"
                                class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                                placeholder="1234567890">
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">From LINE Developers Console → LINE Login Channel → Basic Settings</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">
                                <strong>Suggested:</strong> <code class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 px-2 py-0.5 rounded text-xs">{{ route('line.callback') }}</code>
                            </p>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">From LINE Developers Console → LINE Login Channel → LIFF tab</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="messaging_channel_id" value="{{ old('messaging_channel_id', $settings->messaging_channel_id) }}"
                                class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all"
                                placeholder="1234567890">
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">From LINE Developers Console → Messaging API Channel → Basic Settings (for reference only)</p>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="channel_access_token" rows="3"
                                class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all font-mono text-sm"
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">From LINE Developers Console → Messaging API Channel → Messaging API tab</p>
                        </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Force users to login with LINE before registration (KYC Level 1)</p>
                            </div>
                            <label class="relative inline-flex items-center cursor-pointer">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Allow sending messages through LINE Messaging API</p>
                            </div>
                            <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <div>
                            ...
                            <textarea name="welcome_message" rows="3"
                                class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all"
                                placeholder="ยินดีต้อนรับสู่ระบบ Affiliate! 🎉">{{ old('welcome_message', $settings->welcome_message) }}</textarea>
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">Sent when user adds your LINE OA as friend</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">
                                Available variables: <code class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 px-2 py-1 rounded text-orange-600">{name}</code>, <code class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 px-2 py-1 rounded text-orange-600">{email}</code>, <code class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 px-2 py-1 rounded text-orange-600">{referral_code}</code>
                            </p>
                        </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-gradient-to-br from-green-600 to-emerald-700 rounded-2xl shadow-2xl p-6 text-white sticky top-6">
                    <div class="flex items-center gap-3 mb-6">
                        <div class="w-12 h-12 rounded-xl glass-fusion backdrop-blur-sm flex items-center justify-center" border border-white/20 dark:border-white/10 border border-white/20 dark:border-white/10>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-3 glass-fusion backdrop-blur-sm rounded-xl" border border-white/20 dark:border-white/10 border border-white/20 dark:border-white/10>
                ...
                <!-- Setup Guide -->
                <div class="glass-fusion rounded-2xl shadow-lg border border-gray-100 p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10 hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                    ...
                    <ol class="space-y-3">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">Create LINE Provider</span>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">Create LINE Login Channel</span>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">Copy Channel ID & Secret</span>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">Set Callback URL</span>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">Enable Messaging API</span>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">Configure Webhook</span>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300 font-semibold">Test & Activate</span>
                        </li>
                    </ol>
                </div>
                    ...
                    <div class="space-y-2">
                        <a href="{{ route('admin.line-oa.logs') }}"
                           class="flex items-center gap-2 p-3 glass-fusion rounded-xl hover:shadow-md transition-all group">
                            ...
                            <span class="text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 group-hover:text-blue-600">Usage Logs</span>
                        </a>

                        <a href="https://developers.line.biz/console/" target="_blank"
                           class="flex items-center gap-2 p-3 glass-fusion rounded-xl hover:shadow-md transition-all group">
                            <i class="fas fa-external-link-alt text-blue-500"></i>
                            <span class="text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 group-hover:text-blue-600">LINE Console</span>
                        </a>

                        <a href="https://developers.line.biz/en/docs/line-login/" target="_blank"
                           class="flex items-center gap-2 p-3 glass-fusion rounded-xl hover:shadow-md transition-all group">
                            <i class="fas fa-book-open text-blue-500"></i>
                            <span class="text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 group-hover:text-blue-600">Documentation</span>
                        </a>
                    </div>
                </div>
...
<div id="connectionTestModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden items-center justify-center p-4">
    <div class="glass-fusion rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden transform transition-all" border border-white/20 dark:border-white/10 border border-white/20 dark:border-white/10>
        <div class="bg-gradient-to-r from-blue-500 to-cyan-600 px-6 py-4">
            <div class="flex items-center justify-between">
        ...
        <div class="p-6">
            <div id="connectionTestLoading" class="text-center py-8">
                ...
                <p class="text-gray-600 dark:text-gray-400 dark:text-gray-400 font-semibold">Testing connection...</p>
            </div>
        ...
        <div class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 px-6 py-4 flex justify-end">
            <button onclick="closeConnectionTestModal()"
                    class="px-6 py-2 bg-gray-200 dark:bg-gray-700 dark:bg-gray-700 text-gray-700 dark:text-gray-300 dark:text-gray-300 rounded-xl hover:bg-gray-300 transition font-semibold">
                Close
            </button>
        </div>
    </div>
...
<div id="testModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden items-center justify-center p-4" x-data="{ tab: 'select' }">
    <div class="glass-fusion rounded-2xl shadow-2xl max-w-3xl w-full overflow-hidden transform transition-all max-h-[90vh] flex flex-col" border border-white/20 dark:border-white/10 border border-white/20 dark:border-white/10>
        <div class="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-4">
            <div class="flex items-center justify-between">
                <h3 class="text-xl font-bold text-white flex items-center">
        ...
        <!-- Tabs -->
        <div class="flex border-b border-gray-200 dark:border-gray-700 dark:border-gray-700 px-6">
            <button type="button" @click="tab = 'select'"
                    class="px-6 py-3 font-semibold transition-colors border-b-2"
                    :class="tab === 'select' ? 'border-green-500 text-green-600' : 'border-transparent text-gray-500 dark:text-gray-400 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 dark:text-gray-300'">
                <i class="fas fa-users mr-2"></i>Select User
            </button>
            <button type="button" @click="tab = 'manual'"
                    class="px-6 py-3 font-semibold transition-colors border-b-2"
                    :class="tab === 'manual' ? 'border-green-500 text-green-600' : 'border-transparent text-gray-500 dark:text-gray-400 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 dark:text-gray-300'">
        ...
        <div class="flex-1 overflow-y-auto">
            ...
            <div x-show="tab === 'select'" class="p-6 space-y-4">
                ...
                <!-- Users Table -->
                <div class="border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl overflow-hidden">
                    <div id="usersTableLoading" class="p-8 text-center">
                        <i class="fas fa-spinner fa-spin text-2xl text-green-500 mb-2"></i>
                        <p class="text-gray-600 dark:text-gray-400 dark:text-gray-400">Loading users...</p>
                    </div>

                    <div id="usersTableContent" class="hidden">
                        <div class="max-h-96 overflow-y-auto">
                            <table class="w-full">
                                <thead class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 sticky top-0">
                                    <tr>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 dark:text-gray-400 uppercase">User</th>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 dark:text-gray-400 uppercase">LINE Display</th>
                                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-gray-400 dark:text-gray-400 uppercase">Status</th>
                                        <th class="px-4 py-3 text-center text-xs font-semibold text-gray-600 dark:text-gray-400 dark:text-gray-400 uppercase">Action</th>
                                    </tr>
                                </thead>
                    ...
                    <div id="usersTableEmpty" class="hidden p-8 text-center">
                        ...
                        <p class="text-gray-600 dark:text-gray-400 dark:text-gray-400">No users with LINE account found</p>
                    </div>
                </div>
            </div>
            ...
            <div x-show="tab === 'manual'" class="p-6 space-y-4">
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2">The LINE User ID of the recipient</p>
                </div>
            </div>
        </div>

        <!-- Message Form (Common) -->
        <form method="POST" action="{{ route('admin.line-oa.test-message') }}" class="p-6 border-t border-gray-200 dark:border-gray-700 dark:border-gray-700 space-y-4">
            @csrf
            ...
            <div class="flex gap-3">
                <button type="button" onclick="closeTestModal()"
                        class="flex-1 px-4 py-3 bg-gray-200 dark:bg-gray-700 dark:bg-gray-700 text-gray-700 dark:text-gray-300 dark:text-gray-300 rounded-xl hover:bg-gray-300 transition font-semibold">
                    Cancel
                </button>
                <button type="submit"
...
function renderUsersTable(users) {
    ...
    users.forEach(user => {
        ...
        tr.className = 'hover:bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50';
        tr.innerHTML = `
            <td class="px-4 py-3">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400">${user.email}</p>
                    </div>
                </div>
            </td>
            <td class="px-4 py-3">
            ...
            <td class="px-4 py-3">
                ${user.line_verified ?
                    ...
                    '<span class="inline-flex items-center px-2 py-1 bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 text-gray-600 dark:text-gray-400 dark:text-gray-400 text-xs font-semibold rounded">Unverified</span>'
                }
            </td>
