...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-white">รายงาน & สถิติ MLM</h1>
            <p class="text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">ภาพรวมและวิเคราะห์ข้อมูล MLM แบบละเอียด</p>
        </div>
        <div class="flex gap-2">
            <form method="GET" class="inline-flex items-center gap-2">
                <select name="plan_id" onchange="this.form.submit()" class="border-gray-300 dark:border-gray-600 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl text-sm">
            ...
            <a href="{{ route('admin.mlm.reports.export-members', ['plan_id' => request('plan_id')]) }}"
               class="bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white px-4 py-2 rounded-xl text-sm flex items-center gap-2">
                <i class="fas fa-download"></i>
                Export สมาชิก
            </a>
            <a href="{{ route('admin.mlm.reports.export-commissions', ['plan_id' => request('plan_id')]) }}"
               class="bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white px-4 py-2 rounded-xl text-sm flex items-center gap-2">
                <i class="fas fa-download"></i>
                Export คอมมิชชั่น
            </a>
            <a href="{{ route('admin.mlm.settings.index') }}"
               class="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-4 py-2 rounded-xl text-sm flex items-center gap-2">
    ...
    <div class="mb-6">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-white mb-3">สถิติสมาชิก</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="style="background: var(--arrow-x-primary-gradient)" dark:from-blue-600 dark:to-blue-700 rounded-xl shadow-lg p-6 text-white">
            ...
            <div class="style="background: var(--arrow-x-accent-gradient)" dark:from-purple-600 dark:to-purple-700 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
    ...
    <div class="mb-6">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-white mb-3">สถิติคอมมิชชั่น</h2>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-yellow-500" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">รออนุมัติ</p>
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-white mt-2">{{ number_format($commissionStats['pending_count']) }}</h3>
            ...
            <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-green-500" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">อนุมัติแล้ว</p>
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-white mt-2">{{ number_format($commissionStats['approved_count']) }}</h3>
            ...
            <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-blue-500" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">จ่ายแล้ว (ทั้งหมด)</p>
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-white mt-2">{{ number_format($commissionStats['paid_count']) }}</h3>
            ...
            <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-purple-500" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">จ่ายเดือนนี้</p>
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-white mt-2">-</h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-white">สมาชิกใหม่วันนี้</h3>
            ...
            <div class="flex items-center">
                <div class="w-full bg-gray-200 dark:bg-gray-700 dark:bg-gray-700 rounded-full h-3">
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-white">อัตราสมาชิก Active</h3>
    ...
    <div class="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl shadow-lg p-6">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-white mb-4">การดำเนินการด่วน</h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <a href="{{ route('admin.mlm.commissions.index', ['status' => 'pending']) }}"
               class="glass-fusion dark:bg-gray-800 hover:shadow-xl transition-shadow rounded-xl p-4 flex items-center gap-4 group">
                ...
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">คอมมิชชั่นรออนุมัติ</p>
                    <p class="text-xl font-bold text-gray-900 dark:text-white dark:text-white">{{ number_format($commissionStats['pending_count']) }}</p>
                </div>
            </a>
            ...
            <a href="{{ route('admin.mlm.members.index', ['status' => 'active']) }}"
               class="glass-fusion dark:bg-gray-800 hover:shadow-xl transition-shadow rounded-xl p-4 flex items-center gap-4 group">
                ...
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">สมาชิก Active</p>
                    <p class="text-xl font-bold text-gray-900 dark:text-white dark:text-white">{{ number_format($stats['active_members']) }}</p>
                </div>
            </a>
            ...
            <a href="{{ route('admin.mlm.plans.index') }}"
               class="glass-fusion dark:bg-gray-800 hover:shadow-xl transition-shadow rounded-xl p-4 flex items-center gap-4 group">
                ...
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white dark:text-white">{{ number_format($plans->count()) }}</p>
                </div>
            </a>
        </div>
    </div>
    ...
    <!-- Additional Info -->
    <div class="mt-6 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
