...
class FortuneConversationService
{
    ...
    protected function handlePendingPayment(FortuneReading $reading, string $messageText): array
    {
        ...
        $message .= "💡 หากโอนแล้วระบบไม่แจ้งเตือน ให้พิมพ์ว่า 'โอนแล้ว' ระบบจะส่งคำทำนายให้ค่ะ\n\n";
...
".(! empty($tarotCard) ? "🃏 **วิเคราะห์ไพ่ยิปซี** (⚠️ ห้ามข้ามหัวข้อนี้! ต้องเขียนอย่างน้อย 80 คำ):
- เริ่มต้นด้วย: \"ไพ่{$tarotCard['card_name_th']}ที่{$genderPrefix}{$name}เปิดได้...\"
...
- ถ้าไพ่".($tarotCard['is_reversed'] ? 'กลับหัว: เน้นความท้าทาย อุปสรรค สิ่งที่ต้องระวัง และวิธีรับมือ' : 'หงาย: เน้นพลังงานเชิงบวก โอกาส จุดแข็งที่เสริมดวง')."
