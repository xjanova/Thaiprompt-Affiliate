...
<div class="container mx-auto px-4 py-6 max-w-5xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.mlm.plans.index') }}"
               class="px-6 py-3 bg-gray-600 hover:bg-gray-700 dark:bg-gray-500 dark:hover:bg-gray-600 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2">
    ...
    <form action="{{ route('admin.mlm.plans.store') }}" method="POST">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 space-y-8">
            <!-- Basic Information -->
            <div>
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2 pb-3 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    ...
                    <div>
                        ...
                        <input type="color" name="color" value="{{ old('color', '#8B5CF6') }}"
                               class="w-full h-12 px-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 bg-white dark:bg-gray-700">
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">สีที่ใช้แสดงในการ์ดแผน</p>
                        @error('color')
                        <p class="text-red-500 dark:text-red-400 text-xs mt-1 flex items-center gap-1">
                            <i class="fas fa-exclamation-circle"></i>{{ $message }}
                        </p>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                ...
                <div class="mb-4">
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="requires_joining_fee" id="requires-joining-fee"
                               ...
                               class="w-4 h-4 text-purple-600 border-gray-300 dark:border-gray-600 rounded focus:ring-purple-500 dark:focus:ring-purple-400">
                ...
                <div id="joining-fee-section" class="hidden">
                    ...
                    <input type="number" name="joining_fee" value="{{ old('joining_fee', 0) }}"
                           min="0" step="0.01"
                           class="w-full md:w-1/2 px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent transition">
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">ค่าสมัครที่สมาชิกต้องจ่ายเพื่อเข้าร่วมแผนนี้</p>
                    @error('joining_fee')
                    <p class="text-red-500 dark:text-red-400 text-xs mt-1 flex items-center gap-1">
                        <i class="fas fa-exclamation-circle"></i>{{ $message }}
                    </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            <span class="text-sm text-gray-600 dark:text-gray-400">1 THB =</span>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">อัตราการแปลงเงินเป็น PV (เช่น 1 THB = 1 PV)</p>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            <input type="number" name="global_commission_per_pv" value="{{ old('global_commission_per_pv', 1) }}"
                                   ...
                                   class="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent transition"
                                   required>
                            <span class="text-sm text-gray-600 dark:text-gray-400">THB/PV</span>
                        </div>
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">ค่าคอมมิชชั่นต่อ 1 PV (เช่น 1 PV = 1 THB)</p>
            ...
            <!-- Unilevel Settings -->
            <div id="unilevel-settings" class="border-t border-gray-200 dark:border-gray-700 pt-6 hidden">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2 pb-3 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="number" name="unilevel_max_depth" value="{{ old('unilevel_max_depth', 10) }}"
                               min="1" max="50"
                               class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent transition">
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">ระดับสูงสุดที่จะคำนวณค่าคอมมิชชั่น (1-50)</p>
                    ...
                    <div>
                        <label class="flex items-center h-full cursor-pointer">
                            <input type="checkbox" name="unilevel_compression" value="1"
                                   ...
                                   class="w-4 h-4 text-purple-600 border-gray-300 dark:border-gray-600 rounded focus:ring-purple-500 dark:focus:ring-purple-400">
                            <div class="ml-2">
                                <span class="text-sm text-gray-700 dark:text-gray-300 font-medium">เปิดใช้งาน Compression</span>
                                <p class="text-xs text-gray-500 dark:text-gray-400">ข้ามสมาชิกที่ไม่มีคุณสมบัติ</p>
                            </div>
                        </label>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div id="unilevel-levels-container" class="grid grid-cols-2 md:grid-cols-5 gap-3">
                        @for($i = 1; $i <= 10; $i++)
                        <div>
                            <label class="block text-xs text-gray-600 dark:text-gray-400 mb-1">ระดับ {{ $i }}</label>
                            <input type="number" name="unilevel_levels[{{ $i }}]"
                                   value="{{ old("unilevel_levels.{$i}", $i <= 5 ? 10 - ($i - 1) * 2 : 0) }}"
                                   min="0" max="100" step="0.01"
                                   class="w-full px-2 py-1 text-sm border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400">
                        </div>
                        @endfor
                    </div>
            ...
            <!-- Binary Settings -->
            <div id="binary-settings" class="border-t border-gray-200 dark:border-gray-700 pt-6 hidden">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2 pb-3 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="binary_pair_commission" value="{{ old('binary_pair_commission', 100) }}"
                               min="0" step="0.01"
                               class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent transition">
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">ค่าคอมมิชชั่นต่อ 1 คู่ที่จับคู่สำเร็จ</p>
                    ...
                    <div>
                        ...
                        <input type="number" name="binary_match_percentage" value="{{ old('binary_match_percentage', 50) }}"
                               min="0" max="100" step="0.01"
                               class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent transition">
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">เปอร์เซ็นต์การจับคู่ (50% = ต้องมีทั้ง 2 ฝั่งเท่ากัน)</p>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">อัตราส่วนการจับคู่</p>
                    ...
                    <div>
                        <label class="flex items-center h-full cursor-pointer">
                            <input type="checkbox" name="binary_spillover" value="1"
                                   ...
                                   class="w-4 h-4 text-purple-600 border-gray-300 dark:border-gray-600 rounded focus:ring-purple-500 dark:focus:ring-purple-400">
                            <div class="ml-2">
                                <span class="text-sm text-gray-700 dark:text-gray-300 font-medium">Spillover</span>
                                <p class="text-xs text-gray-500 dark:text-gray-400">อนุญาตให้สมาชิกล้นไปขาที่เต็ม</p>
                            </div>
                        </label>
                    </div>
                </div>
            ...
            <!-- Auto Placement -->
            <div id="auto-placement-section" class="border-t border-gray-200 dark:border-gray-700 pt-6 hidden">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2 pb-3 border-b border-gray-200 dark:border-gray-700">
                ...
                <div id="auto-placement-type-section" class="hidden">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">วิธีการจัดวางสมาชิกใหม่ในโครงสร้าง Binary</p>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                <div class="flex flex-col sm:flex-row items-center justify-end gap-3">
                    <a href="{{ route('admin.mlm.plans.index') }}"
                       class="w-full sm:w-auto px-6 py-3 bg-gray-600 hover:bg-gray-700 dark:bg-gray-500 dark:hover:bg-gray-600 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2">
                        <i class="fas fa-times"></i>
                        ยกเลิก
                    </a>
                    <button type="submit"
                            class="w-full sm:w-auto px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 dark:from-purple-500 dark:to-pink-500 dark:hover:from-purple-600 dark:hover:to-pink-600 text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2">
