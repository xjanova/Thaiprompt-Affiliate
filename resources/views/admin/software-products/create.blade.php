...
@section('title', 'เพิ่มผลิตภัณฑ์ซอฟต์แวร์')
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    <h1 class="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 dark:from-cyan-400 dark:via-blue-400 dark:to-indigo-400">
                        เพิ่มผลิตภัณฑ์ซอฟต์แวร์ใหม่
                    </h1>
                    <p class="text-gray-600 dark:text-gray-400 mt-1">กรอกข้อมูลผลิตภัณฑ์ของคุณ</p>
                </div>
            </div>
        </div>

        <form action="{{ route('admin.software-products.store') }}" method="POST" x-data="productForm()">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="short_description"
                                  rows="2"
                                  class="w-full px-4 py-3 border border-gray-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-cyan-500 dark:bg-slate-700 dark:text-white"
                                  placeholder="คำอธิบายสั้นๆ สำหรับแสดงในการ์ด"></textarea>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description"
                                  rows="6"
                                  class="w-full px-4 py-3 border border-gray-300 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-cyan-500 dark:bg-slate-700 dark:text-white"
                                  placeholder="คำอธิบายโดยละเอียด"></textarea>
                    </div>
                </div>
            </div>
            ...
            {{-- Features --}}
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 mb-6" x-data="{ features: [''] }">
                <div class="flex items-center gap-3 mb-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label class="flex items-center gap-3 p-4 bg-gray-50 dark:bg-slate-700 rounded-xl cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-600 transition-colors">
                        <input type="checkbox" name="is_active" value="1" checked class="w-5 h-5 text-cyan-600 rounded focus:ring-cyan-500">
                        <span class="text-gray-700 dark:text-gray-300 font-medium">เปิดใช้งาน</span>
                    </label>

                    <label class="flex items-center gap-3 p-4 bg-gray-50 dark:bg-slate-700 rounded-xl cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-600 transition-colors">
                        <input type="checkbox" name="is_featured" value="1" class="w-5 h-5 text-purple-600 rounded focus:ring-purple-500">
                        <span class="text-gray-700 dark:text-gray-300 font-medium">แนะนำ</span>
                    </label>

                    <label class="flex items-center gap-3 p-4 bg-gray-50 dark:bg-slate-700 rounded-xl cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-600 transition-colors">
                        <input type="checkbox" name="is_customizable" value="1" class="w-5 h-5 text-orange-600 rounded focus:ring-orange-500">
                        <span class="text-gray-700 dark:text-gray-300 font-medium">กำหนดเองได้</span>
                    </label>

                    <label class="flex items-center gap-3 p-4 bg-gray-50 dark:bg-slate-700 rounded-xl cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-600 transition-colors">
                        <input type="checkbox" name="requires_consultation" value="1" class="w-5 h-5 text-blue-600 rounded focus:ring-blue-500">
