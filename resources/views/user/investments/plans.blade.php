...
<div class="space-y-6 pb-20 lg:pb-6">
    {{-- Premium Hero Header (Indigo-Purple-Pink for Investment Plans) --}}
        ...
        <div class="relative z-10">
            <div class="flex items-center gap-4">
                <div class="glass-fusion p-4 rounded-2xl">
                    <i class="fas fa-briefcase text-4xl text-white drop-shadow-lg"></i>
                </div>
                <div>
                    <h1 class="text-3xl md:text-4xl font-bold text-white drop-shadow-lg">💎 แผนการลงทุน ROI</h1>
                    <p class="text-indigo-100 mt-1">เลือกแผนที่เหมาะกับคุณและรับผลตอบแทนที่คุ้มค่า</p>
                </div>
            </div>
        </div>
    </div>
