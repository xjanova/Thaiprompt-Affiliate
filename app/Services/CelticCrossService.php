...
class CelticCrossService
{
    ...
    protected function buildFollowupPrompt(
        ...
        return $personaPrefix
            ...
            ."     \"เจ้าชะตาคราวนี้อยากให้แม่หมอดูเรื่องอะไรเป็นพิเศษคะ?\n"
            ...
            ."     เช่น \"แม่หมอเข้าใจค่ะ ฟังแล้วแน่น ๆ ใช่ไหม\n"
            ."          มาเล่าให้แม่หมอฟังหน่อย เรื่องไหนที่ค้างคาใจที่สุด แม่หมอจะดูไพ่ให้ละเอียดเลย\"\n\n"
            ."• ถ้าเป็น *คำถามสั้นกำกวม* (น้อยกว่า 5 คำ + ความหมายไม่ชัด) → ถามคืนให้ชัดก่อน\n\n"
    ...
    protected function buildShortFollowupPrompt(
        ...
        return $personaPrefix
            ...
            ."   → ตัวอย่าง: \"แม่หมอเข้าใจค่ะ ฟังแล้วเหนื่อยจริง ๆ ลองเล่าเพิ่มได้ไหม\n"
            ...
            ."   → ตัวอย่าง: \"ยินดีค่ะ ถ้ามีอะไรค้างคาใจถามต่อได้นะ 🌙\"\n\n"
            ...
            ."   → ถ้าเล่าจบลงด้วยคำถาม → จัดเป็นแบบ [A] วิเคราะห์ด้วยไพ่\n\n"
