...
@section('title', 'แก้ไข Template - Video Automation')
...
<div class="container mx-auto px-4 py-8" x-data="templateForm()">
    ...
    {{-- Form --}}
    <form action="{{ route('admin.video-automation.templates.update', $template) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description"
                              rows="3"
                              class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition resize-none">{{ old('description', $template->description) }}</textarea>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select name="music_genre"
                        ...
                        @foreach(\App\Models\VideoAutoTemplate::GENRES as $genre => $label)
                            <option value="{{ $genre }}" {{ old('music_genre', $template->music_genre) == $genre ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="music_mood"
                        ...
                        @foreach(\App\Models\VideoAutoTemplate::MOODS as $mood => $label)
                            <option value="{{ $mood }}" {{ old('music_mood', $template->music_mood) == $mood ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           value="{{ old('music_settings.duration', $template->music_settings['duration'] ?? 120) }}"
                           min="30"
                           max="300"
                           class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition">
                </div>
                ...
                <div class="md:col-span-2 lg:col-span-3">
                    ...
                    <textarea name="music_prompt"
                              rows="3"
                              class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition resize-none">{{ old('music_prompt', $template->music_prompt) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           value="{{ old('music_settings.bpm_min', $template->music_settings['bpm_min'] ?? 80) }}"
                           min="40"
                           max="200"
                           class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition">
                </div>
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           value="{{ old('music_settings.bpm_max', $template->music_settings['bpm_max'] ?? 140) }}"
                           min="40"
                           max="200"
                           class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition">
                </div>
                ...
                <div class="flex items-center gap-3 self-end pb-3">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox"
                               ...
                               value="1"
                               {{ old('music_settings.instrumental', $template->music_settings['instrumental'] ?? false) ? 'checked' : '' }}
                               class="sr-only peer">
                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-purple-300 dark:peer-focus:ring-purple-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-purple-600"></div>
                    </label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select name="image_style"
                        ...
                        @foreach(\App\Models\VideoAutoTemplate::IMAGE_STYLES as $style => $label)
                            <option value="{{ $style }}" {{ old('image_style', $template->image_style) == $style ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           value="{{ old('image_settings.count', $template->image_settings['count'] ?? 10) }}"
                           min="5"
                           max="50"
                           class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition">
                </div>
                ...
                <div>
                    ...
                    <select name="image_settings[resolution]"
                            class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition">
                        <option value="1920x1080" {{ old('image_settings.resolution', $template->image_settings['resolution'] ?? '1920x1080') == '1920x1080' ? 'selected' : '' }}>1920x1080 (Full HD)</option>
                        <option value="1280x720" {{ old('image_settings.resolution', $template->image_settings['resolution'] ?? '') == '1280x720' ? 'selected' : '' }}>1280x720 (HD)</option>
                        <option value="3840x2160" {{ old('image_settings.resolution', $template->image_settings['resolution'] ?? '') == '3840x2160' ? 'selected' : '' }}>3840x2160 (4K)</option>
                    </select>
                </div>
                ...
                <div class="md:col-span-2 lg:col-span-3">
                    ...
                    <textarea name="image_prompt"
                              rows="3"
                              class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition resize-none">{{ old('image_prompt', $template->image_prompt) }}</textarea>
                </div>
                ...
                <div class="flex items-center gap-3">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox"
                               ...
                               value="1"
                               {{ old('image_settings.consistent_style', $template->image_settings['consistent_style'] ?? true) ? 'checked' : '' }}
                               class="sr-only peer">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select name="video_settings[resolution]"
                        ...
                        <option value="1080p" {{ old('video_settings.resolution', $template->video_settings['resolution'] ?? '1080p') == '1080p' ? 'selected' : '' }}>1080p (Full HD)</option>
                        <option value="720p" {{ old('video_settings.resolution', $template->video_settings['resolution'] ?? '') == '720p' ? 'selected' : '' }}>720p (HD)</option>
                        <option value="4k" {{ old('video_settings.resolution', $template->video_settings['resolution'] ?? '') == '4k' ? 'selected' : '' }}>4K (Ultra HD)</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="video_settings[fps]"
                            class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-green-500 focus:border-transparent transition">
                        <option value="30" {{ old('video_settings.fps', $template->video_settings['fps'] ?? '30') == '30' ? 'selected' : '' }}>30 FPS</option>
                        <option value="24" {{ old('video_settings.fps', $template->video_settings['fps'] ?? '') == '24' ? 'selected' : '' }}>24 FPS (Cinematic)</option>
                        <option value="60" {{ old('video_settings.fps', $template->video_settings['fps'] ?? '') == '60' ? 'selected' : '' }}>60 FPS (Smooth)</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="video_settings[transition]"
                        ...
                        @foreach(\App\Models\VideoAutoTemplate::TRANSITIONS as $transition => $label)
                            <option value="{{ $transition }}" {{ old('video_settings.transition', $template->video_settings['transition'] ?? 'crossfade') == $transition ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           value="{{ old('video_settings.transition_duration', $template->video_settings['transition_duration'] ?? 1) }}"
                           min="0.5"
                           max="5"
                           step="0.5"
                           class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-green-500 focus:border-transparent transition">
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           value="{{ old('video_settings.image_duration', $template->video_settings['image_duration'] ?? 5) }}"
                           min="2"
                           max="30"
                           class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-green-500 focus:border-transparent transition">
                </div>
                ...
                <div class="flex items-center gap-3 self-end pb-3">
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox"
                               ...
                               value="1"
                               {{ old('video_settings.ken_burns', $template->video_settings['ken_burns'] ?? true) ? 'checked' : '' }}
                               class="sr-only peer">
                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-300 dark:peer-focus:ring-green-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-green-600"></div>
                    </label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="publish_settings[youtube_category]"
                        ...
                        <option value="10" {{ old('publish_settings.youtube_category', $template->publish_settings['youtube_category'] ?? '10') == '10' ? 'selected' : '' }}>Music</option>
                        <option value="22" {{ old('publish_settings.youtube_category', $template->publish_settings['youtube_category'] ?? '') == '22' ? 'selected' : '' }}>People & Blogs</option>
                        <option value="24" {{ old('publish_settings.youtube_category', $template->publish_settings['youtube_category'] ?? '') == '24' ? 'selected' : '' }}>Entertainment</option>
                        <option value="1" {{ old('publish_settings.youtube_category', $template->publish_settings['youtube_category'] ?? '') == '1' ? 'selected' : '' }}>Film & Animation</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="publish_settings[privacy]"
                            class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition">
                        <option value="public" {{ old('publish_settings.privacy', $template->publish_settings['privacy'] ?? 'public') == 'public' ? 'selected' : '' }}>สาธารณะ (Public)</option>
                        <option value="unlisted" {{ old('publish_settings.privacy', $template->publish_settings['privacy'] ?? '') == 'unlisted' ? 'selected' : '' }}>ไม่แสดง (Unlisted)</option>
                        <option value="private" {{ old('publish_settings.privacy', $template->publish_settings['privacy'] ?? '') == 'private' ? 'selected' : '' }}>ส่วนตัว (Private)</option>
                    </select>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('publish_settings.title_template', $template->publish_settings['title_template'] ?? '{genre} Music - {date}') }}"
                           class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="publish_settings[description_template]"
                              rows="4"
                              class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition resize-none">{{ old('publish_settings.description_template', $template->publish_settings['description_template'] ?? '') }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('publish_settings.default_tags', $template->publish_settings['default_tags'] ?? 'AI Music, Suno AI, Music Video') }}"
                           class="input-modern w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition">
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-between">
            <form action="{{ route('admin.video-automation.templates.destroy', $template) }}"
                  method="POST"
                  onsubmit="return confirm('ต้องการลบ template นี้หรือไม่? การดำเนินการนี้ไม่สามารถย้อนกลับได้')">
                @csrf
                @method('DELETE')
                <button type="submit"
                        class="px-6 py-3 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded-xl hover:bg-red-200 dark:hover:bg-red-900/50 transition">
                    ลบ Template
                </button>
            </form>
