...
<div class="container-fluid px-4 py-6">
    <div class="mb-6">
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.line-bot.rich-menu.index') }}" class="text-gray-600 dark:text-gray-400 dark:text-gray-400 hover:text-gray-900">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Design interactive menu for LINE chat</p>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ isset($richMenu) ? route('admin.line-bot.rich-menu.update', $richMenu->id) : route('admin.line-bot.rich-menu.store') }}" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 space-y-6">
                <div class="glass-fusion rounded-2xl shadow-lg p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10 hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                    <h3 class="text-lg font-bold text-gray-900 mb-4">Menu Information</h3>

                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Menu Name *</label>
                            <input type="text" name="name" value="{{ old('name', $richMenu->name ?? '') }}" required
                                class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-purple-500">
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Chat Bar Text *</label>
                            <input type="text" name="chat_bar_text" value="{{ old('chat_bar_text', $richMenu->chat_bar_text ?? 'Menu') }}" required maxlength="14"
                                class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-purple-500">
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">Text shown on chat bar (max 14 characters)</p>
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Menu Size</label>
                            <select name="size" class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-purple-500">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Menu Image *</label>
                            <input type="file" name="menu_image" accept="image/*"
                                class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-purple-500"
                                {{ isset($richMenu) ? '' : 'required' }}>
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">Upload menu template image (2500x1686px or 2500x843px)</p>
                            @isset($richMenu)
                ...
                <div class="glass-fusion rounded-2xl shadow-lg p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10 hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                    ...
                    <textarea name="menu_data" rows="15"
                        class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-purple-500 font-mono text-sm"
            ...
            <div class="lg:col-span-1">
                <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-200 p-6 sticky top-6">
                    ...
                    <div class="space-y-3 text-sm text-purple-800">
                        <div class="p-3 glass-fusion rounded-xl" border border-white/20 dark:border-white/10 border border-white/20 dark:border-white/10>
        ...
        <div class="mt-8 glass-fusion rounded-2xl shadow-lg p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10 hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <a href="{{ route('admin.line-bot.rich-menu.index') }}" class="text-gray-600 dark:text-gray-400 dark:text-gray-400 hover:text-gray-900 text-sm">
