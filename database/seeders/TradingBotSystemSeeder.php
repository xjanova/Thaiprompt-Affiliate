    ...
    protected function seedExchanges(): void
    {
        $exchanges = [
            ...
            [
                ...
                'slug' => 'bitkub',
                'type' => 'crypto',
                'description' => 'แพลตฟอร์มเทรด Crypto ชั้นนำของไทย รองรับ THB',
                'logo' => 'exchanges/bitkub.png',
                'website_url' => 'https://www.bitkub.com',
                'api_base_url' => 'https://api.bitkub.com',
                'supported_markets' => ['spot'],
                'supported_pairs' => ['BTC/THB', 'ETH/THB', 'USDT/THB', 'ADA/THB', 'XRP/THB'],
                'requires_kyc' => true,
                'supports_websocket' => true,
                'supports_paper_trading' => true,
                'supports_margin' => false,
            ...
            [
                ...
                'slug' => 'kucoin',
                'type' => 'crypto',
                'description' => 'แพลตฟอร์มเทรด Crypto ระดับโลก รองรับ Altcoin มากมาย',
                'logo' => 'exchanges/kucoin.png',
                'website_url' => 'https://www.kucoin.com',
                'api_base_url' => 'https://api.kucoin.com',
                'supported_markets' => ['spot', 'futures', 'margin'],
                'supported_pairs' => ['BTC/USDT', 'ETH/USDT', 'KCS/USDT', 'DOT/USDT', 'MATIC/USDT'],
                'requires_kyc' => false,
                'supports_websocket' => true,
                'supports_paper_trading' => true,
                'supports_margin' => true,
