...
<div x-data="{ activeTab: 'basic' }" class="container-fluid px-4 py-6">
    ...
    <div class="relative mb-8 overflow-hidden rounded-2xl bg-gradient-to-br from-cyan-500 via-blue-600 to-indigo-600 dark:from-cyan-600 dark:via-blue-700 dark:to-indigo-700 p-8 shadow-2xl">
        ...
        <div class="relative flex items-center justify-between">
            ...
            <a href="{{ route('admin.component-settings.index') }}" class="px-6 py-3 bg-white/20 backdrop-blur-md hover:bg-white/30 text-white rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 font-bold border border-white/30">
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.component-settings.update', $componentSetting) }}" class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 overflow-hidden p-8">
        @method('PUT')
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div x-show="activeTab === 'basic'" x-transition>
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="component_id" required value="{{ old('component_id', $componentSetting->component_id) }}"
                               class="w-full px-4 py-3 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-cyan-500 @error('component_id') border-red-500 @enderror">
                ...
                <div class="mt-6">
                    ...
                    <textarea name="description" rows="3" class="w-full px-4 py-3 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-cyan-500">{{ old('description', $componentSetting->description) }}</textarea>
                </div>
            ...
            <div class="flex justify-end gap-3 pt-6 border-t border-gray-200 dark:border-slate-700">
                <a href="{{ route('admin.component-settings.index') }}" class="px-6 py-3 bg-gray-200 dark:bg-slate-700 hover:bg-gray-300 dark:hover:bg-slate-600 text-gray-800 dark:text-gray-200 rounded-xl transition-all duration-200 font-medium">
