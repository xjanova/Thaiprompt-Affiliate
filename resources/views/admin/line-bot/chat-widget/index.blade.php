        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">Show widget on your website</p>
                            </div>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Widget Title</label>
                            <input type="text" name="widget_title" value="{{ old('widget_title', $settings->widget_title ?? 'Chat with us') }}"
                                class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl">
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Welcome Message</label>
                            <textarea name="welcome_message" rows="3"
                                class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl">{{ old('welcome_message', $settings->welcome_message ?? 'Hello! How can we help?') }}</textarea>
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Position</label>
                            <select name="position" class="w-full px-4 py-3 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">Primary Color</label>
                            <input type="color" name="primary_color" value="{{ old('primary_color', $settings->primary_color ?? '#06B6D4') }}"
                                class="w-full h-12 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl border border-cyan-200 p-6 sticky top-6">
                    ...
                    <div class="glass-fusion rounded-xl p-4 shadow-lg" border border-white/20 dark:border-white/10 border border-white/20 dark:border-white/10>
                        <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 text-center">Widget preview will appear here</p>
                    </div>
                </div>
            </div>
        </div>
