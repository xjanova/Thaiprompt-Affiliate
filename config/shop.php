...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | หน้าแรกธีม "โนวา" (Nova)
    |--------------------------------------------------------------------------
    |
    | true  = หน้าแรก (ยังไม่ค้นหา/เลือกหมวด) ใช้ฮีโร่กลางคืน + การ์ดกริด 3D + มาสคอต
    | false = กลับไปหน้าแรกธีม V4 เดิม (แบนเนอร์หมุน) ทันที — แก้ .env แล้วต้อง config:cache
    |
    */
    'nova_home' => env('SHOP_NOVA_HOME', true),

    /*
    |--------------------------------------------------------------------------
    | ธีมโนวาบนหน้าสาธารณะอื่น
    |--------------------------------------------------------------------------
    |
    | หน้าที่ใช้แถบหัว/ท้าย V4 สาธารณะ (ร้านค้า สินค้า ตะกร้า ชำระเงิน ร้านทางการ ตลาดสด หน้าร้าน)
    | true  = แถบหัว/ท้ายเว็บเป็นโนวา + การ์ด/ปุ่ม/ช่องกรอก V4 ใช้สกินกรมท่า-ทอง (คลาส nv-body ที่ <body>)
    | false = กลับเป็น V4 เดิม — ไม่แตะส่วนผู้ใช้/ผู้ขาย/หลังบ้าน (คนละ layout) · แก้ .env แล้วต้อง config:cache
    |
    */
    'nova_public' => env('SHOP_NOVA_PUBLIC', true),
