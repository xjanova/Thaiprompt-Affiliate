...
<div class="container-fluid px-4 py-6" x-data="templateForm()">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400">
                สร้างเทมเพลตสำหรับหน้า Recruit ของแม่ทีม
            </p>
        </div>
    ...
    {{-- Form --}}
    <form action="{{ route('admin.recruit-templates.store') }}" method="POST">
        @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea name="welcome_message" id="welcome_message" rows="5" required
                                  class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">{{ old('welcome_message') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="pitch_message" id="pitch_message" rows="5"
                                  class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all">{{ old('pitch_message') }}</textarea>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="space-y-4">
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="require_line_friend" value="1" {{ old('require_line_friend', true) ? 'checked' : '' }}
                    ...
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="show_team_leader_info" value="1" {{ old('show_team_leader_info', true) ? 'checked' : '' }}
                               class="w-5 h-5 text-blue-600 bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500">
                        <span class="ml-3 text-sm font-medium text-gray-900 dark:text-white">
                            แสดงข้อมูลแม่ทีม
                        </span>
                    ...
                    <label class="flex items-center cursor-pointer">
                        <input type="checkbox" name="show_statistics" value="1" {{ old('show_statistics', true) ? 'checked' : '' }}
                               class="w-5 h-5 text-blue-600 bg-gray-100 dark:bg-gray-700 border-gray-300 dark:border-gray-600 rounded focus:ring-blue-500">
                        <span class="ml-3 text-sm font-medium text-gray-900 dark:text-white">
                            แสดงสถิติ
                        </span>
