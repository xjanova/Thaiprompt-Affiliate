...
<div class="space-y-6" x-data="{ language: 'th' }">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 w-full pt-12 sm:pt-0">
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-emerald-100 mt-2 text-lg" data-translate>กรอกข้อมูลผู้ติดต่อใหม่ (ลูกค้าหรือผู้ขาย)</p>
    ...
    <!-- Form -->
    <form action="{{ route('admin.accounting.contacts.store') }}" method="POST" class="max-w-5xl mx-auto">
        @csrf
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea name="address" rows="3"
                                  class="w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400 shadow-sm"
                                  placeholder="บ้านเลขที่, ถนน" data-translate-placeholder>{{ old('address') }}</textarea>
                        @error('address')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="border-t-2 border-gray-200 dark:border-gray-700 pt-8 space-y-6">
                <div>
                    ...
                    <textarea name="notes" rows="3"
                              class="w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400 shadow-sm"
                              placeholder="ข้อมูลเพิ่มเติม" data-translate-placeholder>{{ old('notes') }}</textarea>
                </div>
