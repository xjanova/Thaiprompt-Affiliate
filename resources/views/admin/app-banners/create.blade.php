...
@section('title', 'สร้าง Emergency Alert Banner')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">สร้าง Emergency Alert Banner</h1>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">สร้างการแจ้งเตือนฉุกเฉินใหม่</p>
        </div>
    ...
    <form action="{{ route('admin.app-management.banners.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <textarea name="description_en" rows="3"
                              class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500"
                              placeholder="Additional details...">{{ old('description_en') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <select name="display_type" required
                            class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500">
                        <option value="popup" {{ old('display_type') === 'popup' ? 'selected' : '' }}>Popup เท่านั้น</option>
                        <option value="banner" {{ old('display_type') === 'banner' ? 'selected' : '' }}>Banner เท่านั้น</option>
                        <option value="marquee" {{ old('display_type') === 'marquee' ? 'selected' : '' }}>Marquee (แถบวิ่ง) เท่านั้น</option>
                        <option value="popup_and_banner" {{ old('display_type') === 'popup_and_banner' ? 'selected' : '' }}>Popup + Banner</option>
                        <option value="popup_and_marquee" {{ old('display_type') === 'popup_and_marquee' ? 'selected' : '' }}>Popup + Marquee</option>
                        <option value="banner_and_marquee" {{ old('display_type') === 'banner_and_marquee' ? 'selected' : '' }}>Banner + Marquee</option>
                        <option value="all" {{ old('display_type') === 'all' ? 'selected' : '' }}>ทั้งหมด (Popup + Banner + Marquee)</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="display_position" required
                            class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500">
                        <option value="top" {{ old('display_position') === 'top' ? 'selected' : '' }}>บนสุด (Top)</option>
                        <option value="bottom" {{ old('display_position') === 'bottom' ? 'selected' : '' }}>ล่างสุด (Bottom)</option>
                        <option value="top-right" {{ old('display_position') === 'top-right' ? 'selected' : '' }}>บนขวา (Top Right)</option>
                        <option value="top-left" {{ old('display_position') === 'top-left' ? 'selected' : '' }}>บนซ้าย (Top Left)</option>
                        <option value="bottom-right" {{ old('display_position') === 'bottom-right' ? 'selected' : '' }}>ล่างขวา (Bottom Right)</option>
                        <option value="bottom-left" {{ old('display_position') === 'bottom-left' ? 'selected' : '' }}>ล่างซ้าย (Bottom Left)</option>
                        <option value="center" {{ old('display_position') === 'center' ? 'selected' : '' }}>กลางจอ (Center)</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="size" required
                            class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500">
                        <option value="small" {{ old('size') === 'small' ? 'selected' : '' }}>เล็ก (Small)</option>
                        <option value="medium" {{ old('size', 'medium') === 'medium' ? 'selected' : '' }}>กลาง (Medium)</option>
                        <option value="large" {{ old('size') === 'large' ? 'selected' : '' }}>ใหญ่ (Large)</option>
                        <option value="full" {{ old('size') === 'full' ? 'selected' : '' }}>เต็มจอ (Full Screen)</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="position" value="{{ old('position', 'global') }}" required
                           class="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-lg focus:ring-2 focus:ring-indigo-500"
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <!-- Is Dismissible -->
                <div class="flex items-center">
                    <input type="checkbox" name="is_dismissible" id="is_dismissible" value="1" {{ old('is_dismissible', true) ? 'checked' : '' }}
                           class="w-4 h-4 text-indigo-600 border-gray-300 rounded">
        ...
        <div class="flex items-center justify-end gap-3">
            ...
            <button type="submit"
                ...
                <i class="fas fa-save mr-2"></i> สร้าง Emergency Alert
            </button>
        </div>
    </form>
</div>
