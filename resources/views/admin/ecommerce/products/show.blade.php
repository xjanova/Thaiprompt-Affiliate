                        ...
                        <div class="flex-1 space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div class="flex items-start gap-3 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-0.5" data-translate>หมวดหมู่</p>
                                ...
                                <div class="flex items-start gap-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-0.5" data-translate>ราคาขาย</p>
                                ...
                                <div class="flex items-start gap-3 p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-0.5" data-translate>สต็อก</p>
                                ...
                                <div class="flex items-start gap-3 p-3 bg-pink-50 dark:bg-pink-900/20 rounded-lg">
                                    ...
                                    <div>
                                        <p class="text-xs text-gray-500 dark:text-gray-400 mb-0.5" data-translate>คอมมิชชั่น</p>
                            ...
                            @if($product->description)
                                <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                                    <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2" data-translate>📝 คำอธิบาย</h4>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    <div class="flex items-start gap-3 p-3 bg-gray-50 dark:bg-slate-700/50 rounded-lg">
                        ...
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mb-0.5" data-translate>สร้างเมื่อ</p>
                    ...
                    <div class="flex items-start gap-3 p-3 bg-gray-50 dark:bg-slate-700/50 rounded-lg">
                        ...
                        <div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mb-0.5" data-translate>แก้ไขล่าสุด</p>
