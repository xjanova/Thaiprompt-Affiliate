...
echo ""
echo -e "  ${CYAN}1.${NC} ${GREEN}${BOLD}รัน deploy.sh เพื่อ build assets และ optimize:${NC}"
echo -e "      ${YELLOW}./deploy.sh${NC}"
echo -e "      ${WHITE}(สำคัญ! ต้องรันเพื่อให้ระบบพร้อมใช้งาน)${NC}"
echo -e ""
echo -e "  ${CYAN}2.${NC} ตั้งค่า Web Server (Nginx/Apache):"
echo -e "      ${GREEN}→${NC} DocumentRoot: ${YELLOW}$(pwd)/public${NC}"
echo -e ""
echo -e "  ${CYAN}3.${NC} เข้าสู่ระบบ:"
...
echo ""
echo -e "  ${CYAN}4.${NC} ทดสอบด้วย PHP Built-in Server (สำหรับทดสอบ):"
echo -e "      ${YELLOW}php artisan serve${NC}"
echo -e "      แล้วเข้า: ${YELLOW}http://localhost:8000${NC}"
echo ""
echo -e "  ${CYAN}5.${NC} การตั้งค่าเพิ่มเติม (ถ้าต้องการ):"
