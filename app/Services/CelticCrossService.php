...
class CelticCrossService
{
    ...
    protected function buildShortFollowupPrompt(
        ...
        return $personaPrefix
            ...
            ."━━━━━━━━━━━━━━━━━\n"
            ."🎯 ใส่ 3 อย่างนี้ *ตามที่คำถามต้องการ* (judgment-based — ไม่ใช่ทุกข้อต้องครบ):\n"
            ."   • *ทำนายฟันธงจากไพ่* — แกนหลักเสมอ (เห็นภาพ + ระบุเวลา + เหตุผล)\n"
            ."   • *ทางออก/คำแนะนำที่ทำได้จริง* — ใส่เมื่อลูกค้าต้องการทางออก (ไม่ใช่แค่อยากรู้ผล)\n"
