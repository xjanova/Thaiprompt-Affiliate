...
class MarketplaceProduct extends Model
{
    ...
    /**
     * Scope เฉพาะของที่ผ่านการตรวจแล้ว — ใช้กับ **การขึ้นหน้าร้าน** เท่านั้น
     *
     * ⚠️ อย่าใช้กับการเสนอในแชท — ดู scopeOfferable()
     */
    ...
    /**
     * Scope ของที่ "เสนอในแชทได้" — ทุกอย่างที่นำเข้ามา ยกเว้นของที่ถูกตีกลับ
     *
     * 🚨 ต่างจาก scopeApproved() โดยตั้งใจ (owner สั่ง 2026-08-23):
     *    "ใช้สินค้าทุกอย่างที่นำเข้า แม้ยังไม่ได้อนุมัติเข้า thaiprompt"
     *
     *    ด่านอนุมัติมีไว้คุม **หน้าร้านของเรา** (ของมั่วขึ้นร้าน = เสียภาพลักษณ์ถาวร)
     *    ไม่ได้มีไว้คุม **ลิงก์ที่ส่งในแชท** (ลิงก์ไปหน้า Lazada ของผู้ขายเอง จบในตัว)
     *    ⇒ ถ้าใช้ approved() กับแชทด้วย ของที่นำเข้าใหม่ทุกชิ้นจะรอคิวคนอนุมัติก่อน
     *      = ท่อนำเข้าอัตโนมัติเดินเต็มที่แต่บอทยังไม่มีของเพิ่มสักชิ้น
     *
     *    `rejected` ยังต้องกันเด็ดขาด — สถานะนั้นใช้กับของที่ถูกถอดจากโปรแกรม affiliate
     *    (ลิงก์ตาย) และของที่คนตีกลับว่าไม่เหมาะ ส่งไปก็ไม่ได้เงินและเสียความน่าเชื่อถือ
     */
    public function scopeOfferable($query)
    {
