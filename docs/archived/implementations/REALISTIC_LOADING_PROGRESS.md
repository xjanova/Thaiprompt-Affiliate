...
ระบบรองรับ **2 โหมด** ที่สามารถเลือกใช้ได้ตามความต้องการ:

### 1. **Real Progress Mode** ✅
- ใช้ Performance API ติดตามการโหลดทรัพยากรจริง
- แสดงเปอร์เซ็นต์และสถานะแบบ realtime
- เหมาะสำหรับหน้าที่มีทรัพยากรเยอะ ต้องการให้ผู้ใช้รู้ความคืบหน้าจริง

### 2. **Fake Progress Mode (Animation Only)** 🎭
- แสดง Loader Animation เฉยๆ ไม่ติดตามการโหลด
- ไม่แสดงเปอร์เซ็นต์และสถานะ
- เบาและรวดเร็วกว่า Real Progress
- เหมาะสำหรับหน้าที่ต้องการ animation แต่ไม่ต้องการ progress tracking

**การตั้งค่า:** Admin Panel → Settings → อนิเมชั่นโหลดหน้า → เลือก "โหมดการแสดงความคืบหน้า"

## ✨ ฟีเจอร์หลัก (Real Progress Mode)
