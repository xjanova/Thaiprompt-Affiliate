        ...
        $platforms = [
            ...
            [
                ...
                'api_endpoints' => json_encode([
                    ...
                    'photo' => 'https://graph.facebook.com/v21.0/{page-id}/photos',
                    'video' => 'https://graph.facebook.com/v21.0/{page-id}/videos',
                    'analytics' => 'https://graph.facebook.com/v21.0/{post-id}/insights',
                ]),
                'is_active' => true,
            ...
            [
                ...
                'api_endpoints' => json_encode([
                    ...
                    'publish' => 'https://graph.facebook.com/v21.0/{ig-user-id}/media_publish',
                    'analytics' => 'https://graph.facebook.com/v21.0/{media-id}/insights',
                ]),
                'is_active' => true,
