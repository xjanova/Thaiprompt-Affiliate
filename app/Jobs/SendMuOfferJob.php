 ...
 *
 * 🎚️ (2026-08-27) ใช้ได้กับทุกจุดยิงแล้ว ไม่ใช่แค่ดวงฟรี — แอดมินตั้งนาทีรายจุดได้ที่
 *    หน้า "แม่หมอเสนอสินค้า" ⇒ อย่า dispatch ตัวนี้เอง ให้เรียก
 *    `FortuneMuOfferService::send()` ซึ่งอ่านค่าหน่วงแล้วตัดสินใจให้ว่าจะส่งทันทีหรือเข้าคิว
 *
