...
<div class="container-fluid py-4" x-data="aiBotsManager()">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white dark:text-gray-100">
                <i class="fas fa-robot mr-3"></i>AI Bots
            </h2>
            <p class="text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">จัดการ AI Bot ทั้งหมดของคุณ</p>
        </div>
    ...
    <div class="grid grid-cols-1 gap-6">
        @forelse($bots as $bot)
        <div class="bot-card {{ $bot->is_active ? 'active' : 'inactive' }} glass-fusion dark:bg-slate-800 rounded-xl shadow-md overflow-hidden border border-gray-100 dark:border-slate-700" border border-white/20 dark:border-white/10>
            <div class="p-6">
                <!-- Bot Header -->
                <div class="flex items-start justify-between">
                    <div class="flex items-start gap-4 flex-1">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-2">
                                <h3 class="text-2xl font-bold text-gray-900 dark:text-white dark:text-gray-100">{{ $bot->display_name }}</h3>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">
                                <span class="font-mono bg-gray-100/50 dark:bg-gray-800/50 dark:bg-slate-700 px-2 py-1 rounded">{{ $bot->name }}</span>
                            </p>
                            @if($bot->description)
                            <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-2">{{ $bot->description }}</p>
                            @endif
                    ...
                    <div class="flex items-center gap-2 ml-4">
                        ...
                        <button @click="toggleBot({{ $bot->id }})"
                                ...
                                :class="bots[{{ $bot->id }}]?.is_active ? 'bg-green-500 text-white hover:bg-green-600' : 'bg-gray-300 text-gray-700 dark:text-gray-300 hover:bg-gray-400'">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-xl p-4 border border-blue-200 dark:border-blue-700/50">
                    ...
                    <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 rounded-xl p-4 border border-green-200 dark:border-green-700/50">
                    ...
                    <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 rounded-xl p-4 border border-purple-200 dark:border-purple-700/50">
                    ...
                    <div class="bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-900/30 dark:to-pink-800/30 rounded-xl p-4 border border-pink-200 dark:border-pink-700/50">
        ...
        @empty
        <div class="glass-fusion dark:bg-slate-800 rounded-xl shadow-md p-12 text-center border border-gray-100 dark:border-slate-700" border border-white/20 dark:border-white/10>
            <i class="fas fa-robot text-6xl text-gray-300 dark:text-gray-600 dark:text-gray-400 mb-4"></i>
            <h3 class="text-xl font-semibold text-gray-600 dark:text-gray-400 dark:text-gray-300 mb-2">ยังไม่มี Bot</h3>
            <p class="text-gray-500 dark:text-gray-400 dark:text-gray-400 mb-4">เริ่มสร้าง AI Bot แรกของคุณ</p>
...
function aiBotsManager() {
    return {
        ...
        showToast(message, type = 'info') {
            ...
            toast.innerHTML = `
                <div class="rounded-xl shadow-xl p-4 flex items-center gap-3" style="background: ${color.bg}; color: white;">
