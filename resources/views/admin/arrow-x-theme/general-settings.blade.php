        ...
        <form action="{{ route('admin.arrow-x-theme.general-settings.update') }}" method="POST" class="space-y-6">
            ...
            <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ชื่อ Theme</label>
                        <input type="text" name="theme_name" value="{{ $themeSetting->theme_name }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded-xl dark:bg-gray-700 dark:text-white">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ชื่อแบรนด์</label>
                        <input type="text" name="brand_name" value="{{ $themeSetting->brand_name }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded-xl dark:bg-gray-700 dark:text-white">
                    </div>
                </div>
            </div>
