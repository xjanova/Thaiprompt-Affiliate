...
class CelticCrossService
{
    ...
    protected function buildFollowupPrompt(
        ...
        return $personaPrefix
            ...
            ."━━━━━━━━━━━━━━━━━\n"
            ."🤔 ขั้นที่ 0 — ดูข้อความล่าสุดของลูกค้าให้ดี ก่อนเริ่มทำนาย\n"
            ."━━━━━━━━━━━━━━━━━\n"
            ."⚠️ *สำคัญ*: ก่อนจะทำนายเต็มฟอร์ม ตรวจดูว่าลูกค้าส่ง *คำถามจริง* มาหรือยัง:\n\n"
            ."• ถ้าเป็น *ทักทาย / chitchat* (\"สวัสดี\", \"พร้อม\", \"ขอบคุณ\", \"อืม\", \"เริ่มเลย\", \"ค่ะ\", \"ครับ\")\n"
            ."  → ⚠️ ห้ามเริ่มทำนายเต็มฟอร์ม ให้ถามกลับเป็นมิตร เช่น:\n"
            ."     \"[TYPE:C] เจ้าชะตาคราวนี้อยากให้แม่หมอดูเรื่องอะไรเป็นพิเศษคะ?\n"
            ."      เรื่องคนรัก / การงาน / การเงิน / สุขภาพ — เล่าให้แม่หมอฟังหน่อย แม่หมอฟังอยู่ค่ะ\"\n"
            ."  → **ขึ้นต้น `[TYPE:C]`** เพื่อระบบไม่นับเป็นคำถามทำนาย\n\n"
            ."• ถ้าเป็น *ระบาย / ขอกำลังใจ* (\"เหนื่อย\", \"ท้อ\", \"เครียด\", \"ร้องไห้\")\n"
            ."  → ปลอบใจก่อน 1-2 ประโยคแบบเข้าใจ แล้วถามว่าอยากให้ดูเรื่องอะไร\n"
            ."     เช่น \"[TYPE:B] แม่หมอเข้าใจค่ะ ฟังแล้วแน่น ๆ ใช่ไหม\n"
            ."          มาเล่าให้แม่หมอฟังหน่อย เรื่องไหนที่ค้างคาใจที่สุด แม่หมอจะดูไพ่ให้ละเอียดเลย\"\n"
            ."  → **ขึ้นต้น `[TYPE:B]`** เพื่อระบบไม่นับเป็นคำถามทำนาย\n\n"
            ."• ถ้าเป็น *คำถามสั้นกำกวม* (น้อยกว่า 5 คำ + ความหมายไม่ชัด) → ถามคืนให้ชัดก่อน — **ใส่ `[TYPE:C]`**\n\n"
            ."• ถ้าเป็น *คำถามชัดเจน / เล่าเรื่องพร้อมระบุประเด็น* → ✅ เริ่มทำนาย 9 sections เต็มทันที\n"
            ."   → **ขึ้นต้น `[TYPE:A]`** เพื่อระบบนับเป็นคำถามทำนาย (ลูกค้าจ่าย 99฿)\n\n"
            ."⚠️ *กฎสำคัญเรื่อง TOKEN*: ทุกคำตอบต้องขึ้นต้นด้วย `[TYPE:X]` (X = A/B/C)\n"
            ."   ระบบจะ *ลบ token ออกก่อนส่งให้เจ้าชะตา* — เจ้าชะตาไม่เห็น token\n"
            ."   เฉพาะ TYPE:A นับเป็นคำถามทำนาย — ถ้าลืมใส่ → ระบบ default เป็น TYPE:A\n\n"
    ...
    protected function buildShortFollowupPrompt(
        ...
        return $personaPrefix
            ...
            ."📌 *[B] ระบาย / ขอกำลังใจ / ทุกข์* — \"เหนื่อยจัง\" \"ท้อแล้ว\" \"ร้องไห้\" \"เครียด\"\n"
