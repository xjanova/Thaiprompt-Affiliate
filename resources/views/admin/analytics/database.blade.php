...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-600 rounded-xl shadow-2xl p-6 text-white">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <select id="hoursFilter" class="px-4 py-2 bg-white text-indigo-600 rounded-lg font-semibold">
                    <option value="6">Last 6 Hours</option>
                    <option value="24" selected>Last 24 Hours</option>
                    <option value="168">Last 7 Days</option>
                </select>
                <a href="{{ route('admin.dashboard') }}" class="px-4 py-2 bg-white text-indigo-600 rounded-lg hover:bg-indigo-50 transition font-semibold">
                    Back
                </a>
            </div>
        </div>
    ...
    <div id="loadingState" class="bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        <p class="mt-4 text-gray-600">Loading database analytics...</p>
    </div>
    ...
    <div id="contentArea" class="hidden space-y-6">
        ...
        <div class="grid md:grid-cols-4 gap-4">
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-gray-600 text-sm">Total Queries</span>
                    <span class="text-blue-600 text-2xl">📊</span>
                </div>
                <div class="text-3xl font-bold text-gray-800" id="totalQueries">-</div>
                <div class="mt-2 text-xs text-gray-500" id="queryTrend">-</div>
            </div>

            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-gray-600 text-sm">Slow Queries</span>
                    <span class="text-red-600 text-2xl">🐌</span>
                </div>
                <div class="text-3xl font-bold text-gray-800" id="slowQueries">-</div>
                <div class="mt-2 text-xs text-gray-500">Over 1000ms</div>
            </div>

            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-gray-600 text-sm">Connections</span>
                    <span class="text-green-600 text-2xl">🔗</span>
                </div>
                <div class="text-3xl font-bold text-gray-800" id="connections">-</div>
                <div class="mt-2 text-xs text-gray-500">Active connections</div>
            </div>

            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex items-center justify-between mb-2">
                    <span class="text-gray-600 text-sm">Avg Query Time</span>
                    <span class="text-purple-600 text-2xl">⏱️</span>
                </div>
                <div class="text-3xl font-bold text-gray-800"><span id="avgQueryTime">-</span>ms</div>
                <div class="mt-2 text-xs text-gray-500">Average execution</div>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-6">
            <div class="bg-white rounded-lg shadow-lg p-6">
                <h3 class="text-lg font-bold text-gray-800 mb-4">Query Volume</h3>
                <canvas id="queryChart" height="250"></canvas>
            </div>

            <div class="bg-white rounded-lg shadow-lg p-6">
                <h3 class="text-lg font-bold text-gray-800 mb-4">Query Performance</h3>
        ...
        <div class="grid md:grid-cols-2 gap-6">
            <div class="bg-white rounded-lg shadow-lg p-6">
                <h3 class="text-lg font-bold text-gray-800 mb-4">Connection Pool Usage</h3>
                <canvas id="connectionChart" height="250"></canvas>
            </div>

            <div class="bg-white rounded-lg shadow-lg p-6">
                <h3 class="text-lg font-bold text-gray-800 mb-4">Query Types Distribution</h3>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-bold text-gray-800">Slow Queries (Top 10)</h3>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody id="slowQueriesTable" class="bg-white divide-y divide-gray-200">
                        <tr>
...
function updateSlowQueries(queries) {
    ...
    if (queries.length === 0) {
        tbody.innerHTML = '<tr><td colspan="3" class="px-6 py-4 text-center text-gray-500">No slow queries found</td></tr>';
        return;
    }
