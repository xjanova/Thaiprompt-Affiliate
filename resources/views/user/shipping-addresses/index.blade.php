    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="mb-8" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2 text-sm">
                ...
                <li class="text-gray-700 font-medium">ที่อยู่จัดส่ง</li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-3xl font-black text-gray-900 mb-2">📍 ที่อยู่จัดส่ง</h1>
                <p class="text-gray-600">จัดการที่อยู่จัดส่งของคุณ</p>
            </div>
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                        ...
                        <div class="flex-1 mb-4 lg:mb-0">
                            <div class="flex items-center gap-2 mb-3">
                                <h3 class="text-lg font-bold text-gray-900">{{ $address->recipient_name }}</h3>
                            ...
                            <div class="space-y-2 text-sm text-gray-700">
                                ...
                                @if($address->notes)
                                <p class="flex items-start gap-2 text-gray-600 italic">
                                    <svg class="w-4 h-4 text-gray-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        @else
            ...
            <div class="bg-white rounded-2xl shadow-lg p-12 text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">ยังไม่มีที่อยู่จัดส่ง</h3>
                <p class="text-gray-600 mb-6">เพิ่มที่อยู่จัดส่งเพื่อใช้ในการสั่งซื้อสินค้า</p>
                <a href="{{ route('shipping-addresses.create') }}"
                   class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
                    + เพิ่มที่อยู่จัดส่ง
                </a>
