...
@section('title', 'สร้างรีวิวประสิทธิภาพ')
...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 dark:from-indigo-900 dark:via-purple-900 dark:to-pink-950 rounded-2xl shadow-2xl p-8 text-white">
        <div class="flex items-center gap-4 mb-4">
            ...
            <div>
                <h2 class="text-3xl font-bold">สร้างรีวิวประสิทธิภาพใหม่</h2>
                <p class="text-purple-100 mt-1">ประเมินผลการปฏิบัติงานและพัฒนาการของพนักงาน</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
        <form action="{{ route('admin.hrm.performance.reviews.store') }}" method="POST" class="space-y-8 p-8">
            @csrf
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="review_period" id="review_period" value="{{ old('review_period') }}" required
                    ...
                    <div>
                        ...
                        <select name="review_type" id="review_type" required
                            ...
                            <option value="promotion" {{ old('review_type') == 'promotion' ? 'selected' : '' }}>การเลื่อนตำแหน่ง</option>
                        </select>
                        @error('review_type')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="date" name="review_date" id="review_date" value="{{ old('review_date', date('Y-m-d')) }}" required
                    ...
                    <div>
                        ...
                        <input type="date" name="period_start_date" id="period_start_date" value="{{ old('period_start_date') }}" required
                    ...
                    <div>
                        ...
                        <input type="date" name="period_end_date" id="period_end_date" value="{{ old('period_end_date') }}" required
                            ...
                            <div class="flex items-center gap-2">
                                @for($i = 1; $i <= 5; $i++)
                                    <label class="relative cursor-pointer">
                                        <input type="radio" name="{{ $field }}" value="{{ $i }}" {{ old($field) == $i ? 'checked' : '' }}
                                               class="sr-only peer"
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <textarea name="strengths" id="strengths" rows="4"
                                  ...
                                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white transition-all duration-200">{{ old('strengths') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="areas_for_improvement" id="areas_for_improvement" rows="4"
                                  ...
                                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white transition-all duration-200">{{ old('areas_for_improvement') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="achievements" id="achievements" rows="4"
                                  ...
                                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white transition-all duration-200">{{ old('achievements') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="goals_for_next_period" id="goals_for_next_period" rows="4"
                                  ...
                                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white transition-all duration-200">{{ old('goals_for_next_period') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="training_needs" id="training_needs" rows="3"
                                  ...
                                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white transition-all duration-200">{{ old('training_needs') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="reviewer_comments" id="reviewer_comments" rows="4"
                                  ...
                                  class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-700 dark:text-white transition-all duration-200">{{ old('reviewer_comments') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="flex items-center">
                        <input type="checkbox" name="recommend_promotion" id="recommend_promotion" value="1" {{ old('recommend_promotion') ? 'checked' : '' }}
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="recommend_salary_increase" id="recommend_salary_increase" value="1" {{ old('recommend_salary_increase') ? 'checked' : '' }}
                               class="w-5 h-5 text-purple-600 border-gray-300 dark:border-gray-600 rounded focus:ring-purple-500 dark:bg-gray-700"
                    ...
                    <div id="salary_increase_field" class="md:col-span-2" style="display: {{ old('recommend_salary_increase') ? 'block' : 'none' }}">
                        ...
                        <input type="number" name="recommended_increase_percentage" id="recommended_increase_percentage" value="{{ old('recommended_increase_percentage') }}"
