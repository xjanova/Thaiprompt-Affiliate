...
class ThemePreset extends Model
{
    ...
    public static function defaultPresets()
    {
        return [
            ...
            // Classic X (WordPress-Inspired Premium)
            [
                'name' => 'classic_x',
                'display_name' => 'Classic X',
                'description' => 'ธีมแบบ WordPress สไตล์คลาสสิก หรูหรา เหมาะกับระบบจัดการ',
                'category' => 'professional',
                'is_featured' => true,
                'config' => array_merge(Theme::defaultConfig(), [
                    'colors' => array_merge(Theme::defaultConfig()['colors'], [
                        'primary' => '#2271b1',
                        'primary-dark' => '#135e96',
                        'primary-light' => '#2c8dcc',
                        'secondary' => '#0073aa',
                        'secondary-dark' => '#005177',
                        'secondary-light' => '#2091c7',
                        'accent' => '#d63638',
                        'accent-dark' => '#b32d2e',
                        'accent-light' => '#f56e4a',
                        'gray-50' => '#f6f7f7',
                    ...
                    'dark_colors' => array_merge(Theme::defaultConfig()['dark_colors'], [
                        'primary' => '#2c8dcc',
                        'primary-dark' => '#2271b1',
                        'primary-light' => '#4ca2df',
                        'secondary' => '#2091c7',
                        'secondary-dark' => '#0073aa',
                        'secondary-light' => '#54aad2',
                        'accent' => '#f56e4a',
                        'accent-dark' => '#d63638',
                        'accent-light' => '#ff8860',
                        'gray-50' => '#1d2327',
                    ...
                    'typography' => array_merge(Theme::defaultConfig()['typography'], [
