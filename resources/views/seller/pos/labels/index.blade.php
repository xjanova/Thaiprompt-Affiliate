...
<div class="container-fluid px-4 py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <a href="{{ route('seller.pos.labels.print-product') }}"
        ...
        <a href="{{ route('seller.pos.labels.print-shipping') }}"
            ...
            <div class="p-6">
                ...
                @if($recentPrints->count() > 0)
                    <div class="mt-4 text-center">
                        <a href="{{ route('seller.pos.labels.history') }}" class="text-blue-600 dark:text-blue-400 hover:underline text-sm">
                            ดูทั้งหมด →
                        </a>
                    </div>
                @endif
