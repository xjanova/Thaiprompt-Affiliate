...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">ระบบควบคุมการส่งอีเมลแบบ Multi-Provider</p>
        </div>
        <button onclick="sendTestEmail()" class="px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors">
            ส่งอีเมลทดสอบ
        </button>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-md p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">ส่งทั้งหมด</p>
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-md p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">ส่งสำเร็จ</p>
                    ...
                    @endphp
                    <p class="text-xs text-gray-500 dark:text-gray-400">{{ number_format($successRate, 1) }}%</p>
                </div>
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-md p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">ล้มเหลว</p>
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-md p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">รอส่ง</p>
    ...
    <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-md p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
        ...
        <div class="space-y-4">
            @forelse($providers as $provider)
                <div class="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 dark:border-gray-700 rounded-xl">
                    ...
                    <div class="flex items-center space-x-4">
                        @if($provider->daily_limit)
                            <div class="text-right">
                                <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400">วันนี้</p>
            ...
            @empty
                <div class="text-center py-8">
                    <p class="text-gray-500 dark:text-gray-400 dark:text-gray-400">ยังไม่มี Email Provider</p>
                ...
                <tbody class="glass-fusion dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($recentLogs as $log)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400">{{ $log->provider }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400">{{ $log->created_at->diffForHumans() }}</td>
                        </tr>
                    @empty
                        <tr>
