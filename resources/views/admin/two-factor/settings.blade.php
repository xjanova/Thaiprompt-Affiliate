        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600">Activate 2FA security for your application</p>
                            </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        <p class="text-sm text-gray-600 mb-6">Choose which actions require two-factor authentication</p>
                            ...
                            <div class="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600">User login attempts</p>
                                    </div>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600">Money withdrawals</p>
                                    </div>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl border border-blue-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600">Money transfers</p>
                                    </div>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl border border-orange-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600">Edit profile info</p>
                                    </div>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl border border-red-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600">Change password</p>
                                    </div>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <div class="flex items-center justify-between p-4 bg-gradient-to-r from-violet-50 to-purple-50 rounded-xl border border-violet-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600">Update payment info</p>
                                    </div>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        <p class="text-sm text-gray-600 mb-6">Enable or disable verification channels</p>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <label class="relative cursor-pointer group">
                                ...
                                <div class="h-32 rounded-xl border-2 transition-all duration-300 flex flex-col items-center justify-center peer-checked:border-green-500 peer-checked:bg-green-50 peer-checked:shadow-lg peer-checked:scale-105 border-gray-200 bg-gray-50 group-hover:border-green-300">
                                    <div class="text-4xl mb-2">
                                        <i class="fas fa-sms" :class="'text-green-500'"></i>
                                    </div>
                                    <span class="font-bold text-gray-700">SMS</span>
                                    <span class="text-xs text-gray-500">Via phone</span>
                                </div>
                            </label>
                            ...
                            <label class="relative cursor-pointer group">
                                ...
                                <div class="h-32 rounded-xl border-2 transition-all duration-300 flex flex-col items-center justify-center peer-checked:border-green-500 peer-checked:bg-green-50 peer-checked:shadow-lg peer-checked:scale-105 border-gray-200 bg-gray-50 group-hover:border-green-300">
                                    ...
                                    <span class="font-bold text-gray-700">LINE OA</span>
                                    <span class="text-xs text-gray-500">Via LINE</span>
                                </div>
                            </label>
                            ...
                            <div class="relative opacity-50 cursor-not-allowed" title="Email verification coming soon">
                                ...
                                <div class="h-32 rounded-xl border-2 border-gray-200 bg-gray-100 flex flex-col items-center justify-center">
                                    <div class="text-4xl mb-2">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                <label class="relative cursor-pointer">
                                    ...
                                    <div class="p-4 rounded-lg border-2 transition-all peer-checked:border-pink-500 peer-checked:bg-pink-50 border-gray-200 bg-white text-center">
                                        <i class="fas fa-sms text-2xl mb-2" :class="defaultMethod === 'sms' ? 'text-pink-500' : 'text-gray-400'"></i>
                                        <p class="font-bold text-sm" :class="defaultMethod === 'sms' ? 'text-pink-700' : 'text-gray-600'">SMS</p>
                                    </div>
                                </label>
                                ...
                                <label class="relative cursor-pointer">
                                    ...
                                    <div class="p-4 rounded-lg border-2 transition-all peer-checked:border-pink-500 peer-checked:bg-pink-50 border-gray-200 bg-white text-center">
                                        ...
                                        <p class="font-bold text-sm" :class="defaultMethod === 'line' ? 'text-pink-700' : 'text-gray-600'">LINE</p>
                                    </div>
                                </label>

                                <div class="opacity-50 cursor-not-allowed">
                                    <div class="p-4 rounded-lg border-2 border-gray-200 bg-gray-100 text-center">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="grace_period_minutes" value="{{ old('grace_period_minutes', $settings->grace_period_minutes) }}"
                                        min="0" max="120"
                                        class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all">
                                    <span class="absolute right-4 top-1/2 -translate-y-1/2 text-sm text-gray-500">min</span>
                                </div>
                                <p class="text-xs text-gray-500 mt-1">Don't ask again for X minutes after verification</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-1">Trust devices for X days</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="withdrawal_threshold" value="{{ old('withdrawal_threshold', $settings->withdrawal_threshold) }}"
                                        ...
                                        class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all"
                                        placeholder="0.00">
                                    <span class="absolute right-4 top-1/2 -translate-y-1/2 text-sm text-gray-500">THB</span>
                                </div>
                                <p class="text-xs text-gray-500 mt-1">Require 2FA above this amount (0 = always)</p>
                            </div>
                            ...
                            <div class="col-span-2 flex items-center justify-between p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border border-amber-200">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Let users trust devices for faster login</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl shadow-2xl p-6 text-white sticky top-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 bg-white/10 backdrop-blur-sm rounded-lg">
                            ...
                            <span class="px-3 py-1 bg-white/20 rounded-full text-xs font-bold uppercase">{{ $settings->default_method }}</span>
                        </div>
                    ...
                    <div class="mt-6 p-4 bg-white/10 backdrop-blur-sm rounded-lg">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @if($settings->require_on_login)
                                <span class="px-2 py-1 bg-white/20 rounded text-xs">Login</span>
                            @endif
                            @if($settings->require_on_withdrawal)
                                <span class="px-2 py-1 bg-white/20 rounded text-xs">Withdrawal</span>
                            @endif
                            @if($settings->require_on_transfer)
                                <span class="px-2 py-1 bg-white/20 rounded text-xs">Transfer</span>
                            @endif
                            @if($settings->require_on_profile_change)
                                <span class="px-2 py-1 bg-white/20 rounded text-xs">Profile</span>
                            @endif
                            @if($settings->require_on_password_change)
                                <span class="px-2 py-1 bg-white/20 rounded text-xs">Password</span>
                            @endif
                            @if($settings->require_on_payment_method_change)
                                <span class="px-2 py-1 bg-white/20 rounded text-xs">Payment</span>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                    ...
                    <ol class="space-y-3">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700">Configure OTP providers in OTP Settings</span>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700">Enable verification methods</span>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700">Choose protected actions</span>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700">Set security preferences</span>
                        </li>
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-sm text-gray-700 font-semibold">Enable 2FA system</span>
                        </li>
                    </ol>
                </div>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-200 p-6">
                    ...
                    <div class="space-y-2">
                        <a href="{{ route('admin.otp.settings') }}" class="flex items-center gap-2 p-3 bg-white rounded-lg hover:bg-purple-100 transition text-sm text-purple-700 font-medium">
                            <i class="fas fa-cog"></i>
                            <span>OTP Settings</span>
                        </a>
                        <a href="{{ route('user.two-factor.setup') }}" class="flex items-center gap-2 p-3 bg-white rounded-lg hover:bg-purple-100 transition text-sm text-purple-700 font-medium">
