    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        ...
        <form method="GET" action="{{ route('admin.wallet.all') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
                ...
                <input type="text" name="search" value="{{ $filters['search'] ?? '' }}" placeholder="ชื่อ, อีเมล, Wallet Address" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
            </div>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">ยอดขั้นต่ำ</label>
                <input type="number" name="min_balance" value="{{ $filters['min_balance'] ?? '' }}" step="0.01" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">ยอดสูงสุด</label>
                <input type="number" name="max_balance" value="{{ $filters['max_balance'] ?? '' }}" step="0.01" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500">
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm font-mono text-gray-900 bg-gray-100 px-2 py-1 rounded">{{ $wallet->wallet_address }}</span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h4 class="text-lg font-bold text-gray-800">กระเป๋าใช้งานได้</h4>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h4 class="text-lg font-bold text-gray-800">กระเป๋าถูกล็อก</h4>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h4 class="text-lg font-bold text-gray-800">ยอดเฉลี่ย/กระเป๋า</h4>
