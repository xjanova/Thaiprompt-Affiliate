...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">{{ $member->user->name }} ({{ $member->member_code }})</p>
        </div>
        <div class="flex gap-2">
            <a href="{{ route('admin.mlm.members.show', $member) }}"
               class="bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2">
    ...
    <div class="bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-700 dark:to-pink-700 rounded-xl shadow-lg p-6 mb-6 text-white">
        <div class="flex flex-col md:flex-row items-start md:items-center md:justify-between gap-4">
            <div class="flex items-center gap-4">
                <div class="w-16 h-16 glass-fusion rounded-full flex items-center justify-center text-2xl font-bold shadow-lg" border border-white/20 dark:border-white/10>
    ...
    <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
        <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                <label class="text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 flex items-center gap-2">
                    <i class="fas fa-stream text-purple-600 dark:text-purple-400"></i>
                    ประเภทผัง:
                </label>
                <div class="flex bg-gray-100/50 dark:bg-gray-800/50 dark:bg-gray-700 rounded-xl p-1">
                    <a href="{{ route('admin.mlm.members.genealogy', ['member' => $member, 'type' => 'unilevel']) }}"
                       class="px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 flex items-center gap-1 {{ $treeType === 'unilevel' ? 'bg-blue-600 text-white shadow-lg' : 'text-gray-700 dark:text-gray-300 dark:text-gray-300 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600' }}">
                        <i class="fas fa-network-wired"></i>
                        Unilevel
                    </a>
                    <a href="{{ route('admin.mlm.members.genealogy', ['member' => $member, 'type' => 'binary']) }}"
                       class="px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 flex items-center gap-1 {{ $treeType === 'binary' ? 'bg-purple-600 text-white shadow-lg' : 'text-gray-700 dark:text-gray-300 dark:text-gray-300 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600' }}">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                ...
                <select id="depth-selector" class="px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-gray-600 glass-fusion dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent transition text-sm" onchange="updateDepth(this.value)">
            ...
            <div class="flex items-center gap-2">
                <button onclick="zoomIn()" class="p-2 bg-gray-100/50 dark:bg-gray-800/50 dark:bg-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 dark:text-gray-300 rounded-xl transition-all duration-200" title="ซูมเข้า">
                    <i class="fas fa-search-plus text-lg"></i>
                </button>
                <button onclick="resetZoom()" class="px-4 py-2 bg-gray-100/50 dark:bg-gray-800/50 dark:bg-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 transition-all duration-200 flex items-center gap-1">
                    <i class="fas fa-redo-alt"></i>
                    รีเซ็ต
                </button>
                <button onclick="zoomOut()" class="p-2 bg-gray-100/50 dark:bg-gray-800/50 dark:bg-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 dark:text-gray-300 rounded-xl transition-all duration-200" title="ซูมออก">
            ...
            <div class="flex flex-wrap items-center gap-4 text-xs">
                <div class="flex items-center gap-1.5">
                    ...
                    <span class="text-gray-600 dark:text-gray-400 dark:text-gray-400">Active</span>
                </div>
                <div class="flex items-center gap-1.5">
                    <i class="fas fa-circle text-gray-400"></i>
                    <span class="text-gray-600 dark:text-gray-400 dark:text-gray-400">Inactive</span>
                </div>
                <div class="flex items-center gap-1.5">
                    <i class="fas fa-circle text-red-500"></i>
                    <span class="text-gray-600 dark:text-gray-400 dark:text-gray-400">Suspended</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Tree Container -->
    <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 dark:border-gray-700" border border-white/20 dark:border-white/10 style="height: 800px;">
        <div id="genealogy-tree" class="w-full h-full relative bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
            <!-- Loading State -->
            <div id="tree-loading" class="absolute inset-0 flex items-center justify-center glass-fusion dark:bg-gray-900/50 backdrop-blur-sm" border border-white/20 dark:border-white/10>
                <div class="text-center">
                    ...
                    <p class="text-gray-700 dark:text-gray-300 dark:text-gray-300 font-medium flex items-center gap-2">
            ...
            <div class="absolute bottom-4 right-4 glass-fusion dark:bg-gray-800/95 backdrop-blur-sm rounded-xl p-4 text-xs text-gray-700 dark:text-gray-300 dark:text-gray-300 shadow-xl border border-gray-200 dark:border-gray-700 dark:border-gray-700" border border-white/20 dark:border-white/10>
    ...
    <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 dark:border-gray-700" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">จำนวนโหนดในผัง</p>
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 dark:border-gray-700" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">Left Leg</p>
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 dark:border-gray-700" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">Right Leg</p>
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 dark:border-gray-700" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">Balance</p>
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 dark:border-gray-700" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">ผู้แนะนำโดยตรง</p>
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 dark:border-gray-700" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">ระดับสูงสุด</p>
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 dark:border-gray-700" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">ทีมทั้งหมด</p>
