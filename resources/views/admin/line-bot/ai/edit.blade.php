                ...
                <div class="glass-fusion dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <textarea name="system_prompt" rows="8"
                                  ...
                                  class="w-full px-4 py-3 border-2 border-gray-200 dark:border-slate-600 glass-fusion dark:bg-slate-700 text-gray-900 dark:text-white rounded-xl focus:ring-4 focus:ring-purple-500/20 focus:border-purple-500 transition-all duration-300 font-mono text-sm">{{ old('system_prompt', $aiSetting->system_prompt) }}</textarea>
                    ...
                    <div class="p-6">
                        ...
                        <div x-show="enableFallback">
                            ...
                            <textarea name="fallback_message" rows="4"
                                      ...
                                      class="w-full px-4 py-3 border-2 border-gray-200 dark:border-slate-600 glass-fusion dark:bg-slate-700 text-gray-900 dark:text-white rounded-xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-300">{{ old('fallback_message', $aiSetting->fallback_message) }}</textarea>
                        </div>
                    </div>
                </div>
