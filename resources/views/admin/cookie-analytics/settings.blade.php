...
<div class="p-6">
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">จัดการการแสดงผลและข้อความของระบบคุกกี้ PDPA</p>
    </div>
    ...
    <form action="{{ route('admin.cookie-analytics.settings.update') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">แสดงป๊อปอัพขอความยินยอมคุกกี้</p>
                    </div>
                ...
                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">บล็อกการติดตามจนกว่าจะได้รับความยินยอม</p>
                    </div>
                    <label class="relative inline-flex items-center cursor-pointer">
                ...
                <div>
                    ...
                    <input type="number" name="cookie_expiry_days" value="{{ $settings['cookie_expiry_days'] }}" min="1" max="730" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white" required>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">ระยะเวลาที่คุกกี้จะถูกเก็บไว้ (1-730 วัน)</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="cookie_banner_title" value="{{ $settings['cookie_banner_title'] }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white" required>
                ...
                <div>
                    ...
                    <textarea name="cookie_banner_description" rows="4" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white" required>{{ $settings['cookie_banner_description'] }}</textarea>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">คำอธิบายที่แสดงในแบนเนอร์คุกกี้</p>
                ...
                <div>
                    ...
                    <input type="text" name="cookie_policy_url" value="{{ $settings['cookie_policy_url'] }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white" required>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">URL ของหน้านโยบายคุกกี้</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div class="p-6 bg-gray-100 dark:bg-gray-700 rounded-lg border-4 border-indigo-600">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-300" id="preview-description">
        ...
        <div class="flex gap-4">
            ...
            <a href="{{ route('admin.cookie-analytics.index') }}" class="px-6 py-3 bg-gray-300 dark:bg-gray-600 text-gray-900 dark:text-white rounded-lg hover:bg-gray-400 dark:hover:bg-gray-500 transition-colors">
                ยกเลิก
            </a>
        </div>
    </form>
