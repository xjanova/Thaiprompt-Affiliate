...
EOT;
    ...
    public function getCommentDmTemplate(?string $userId = null): string
    {
        ...
        // 🎁 (2026-05-04) Pay-Later teaser — โฆษณาสิทธิ์ครั้งแรกในทุก variant
        //   gate downstream: FortuneReading::shouldUseRequestBeforePay() เช็ค first-time/platform
        //   ลูกค้าที่ใช้สิทธิ์ไปแล้ว → flow จะ fallback เป็น pay-first อัตโนมัติ (ปลอดภัยที่จะโฆษณา)
...
2. DM_MESSAGE: ข้อความทักใน inbox (200-400 ตัวอักษร) ทักทาย อ้างอิงคอมเม้นต์ ชวนดูดวง บอกวิธีใช้: พิมพ์ "ดูดวง" ตามด้วยคำถาม หรือระบุวันเกิดจะแม่นขึ้น
   ⭐ บังคับ: ใน DM_MESSAGE ต้องระบุชัดเจนว่า "🎁 สิทธิ์ครั้งแรก: ดูคำทำนายก่อน — จ่ายทีหลังได้ ✨" (ครั้งแรกของลูกค้าใหม่ ระบบจะให้ดูคำทำนายก่อน แล้วค่อยโอนค่าครู 39 บาทภายใน 24 ชม.)
