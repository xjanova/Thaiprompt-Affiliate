...
class CelticCrossService
{
     ...
     * = ต่อยอดจาก 2026-06-19 (FTU-260619-C9002) ที่ย้าย ฤกษ์/สีมงคล จาก Q1 พื้นดวง → Grand Finale ย่อหน้า 13
     ...
     *   ❌ ไม่ inject ใน buildGrandFinalePrompt — ที่นั่นคือ "ที่รวม" (ย่อหน้า 13 เคล็ด/เลข/ฤกษ์ + ย่อหน้า 14 คำคมปิด)
     */
    ...
    protected function buildGrandFinalePrompt(
        ...
        $bmFinaleFraming = $bmForced
            ? "━━━━━━━━━━━━━━━━━\n"
                ...
                ."━━━━━━━━━━━━━━━━━\n"
                ."• ทุกย่อหน้า (รวมการไล่ไพ่ 10 ตำแหน่ง) อ่านผ่านเลนส์ \"ภัยจากของ/พลังลบ/เกราะคุ้มครอง\" — โยงไพ่แต่ละตำแหน่งเข้าเรื่องของ/คุณไสย์ ไม่ใช่ รัก/งาน/เงิน/สุขภาพทั่วไป\n"
                ."• ย่อหน้า 0 (พาดหัว) = ฟันธง \"โดน/ไม่โดนของ + ชนิด\" (ไม่ใช่พาดหัวเรื่องเด่นรัก/งาน/เงิน)\n"
                ."• ย่อหน้า 11 (ผลลัพธ์) = สรุปฟันธงสุดท้าย โดน/ไม่โดน + ความรุนแรง + แนวโน้มคลาย/ยังค้าง\n"
                ."• ย่อหน้า 12-13 = *วิธีแก้/ถอน/ป้องกัน + ทิศสะเดาะเคราะห์ทำเอง + เสริมเกราะ/บารมี* (เน้น \"การแก้ไข\" ที่เจ้าชะตาอยากรู้) — แทนคำแนะนำชีวิต/เลข-สีมงคล/ฤกษ์ทั่วไป\n"
        ...
        return $localeDirective
            ...
            .$this->buildSaiMuDirective($reading, $questions->pluck('question')->implode(' '))
            ...
            .($bmForced ? $this->buildBlackMagicDirective($reading, $questions->pluck('question')->implode(' '), $qaHistory) : '')
            ...
            ."ย่อหน้า 13 — *สิ่งที่ต้องระวัง + เคล็ด/ฤกษ์/เลข/ของมงคลเฉพาะตัว* (รวมของท้ายที่เลื่อนมาจากรอบถามตอบทั้งหมด) (60-90 คำ):\n"
            ."   ⚠️ สิ่งที่ต้องระวัง (จากดาวศัตรู + ไพ่เตือน) + ทางแก้/เสริมดวง/เคล็ดที่ทำเองได้ (❌ ไม่ขายความกลัว ไม่พิธีแพง)\n"
            ."   📅 วัน/ช่วงเวลามงคล (ดาวมิตร+ไพ่) + สีมงคล + เลขมงคล/เลขเสี่ยงโชค + ทิศ — สั้น กระชับ ตรงดวงคนนี้ (ไม่มั่วตัวเลขถ้าไพ่/ดาวไม่ได้ชี้)\n\n"
