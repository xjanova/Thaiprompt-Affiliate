    ...
    protected function presentTierChoice(FortuneReading $reading): array
    {
        ...
        if ($celticEnabled) {
            $celticBlock = \App\Services\FortuneLocaleService::lo(
                "━━━━━━━━━━━━━━━━━\n"
                    . "👑💎 *แพคเกจ{$celticNum} — VIP PREMIUM* 💎👑\n"
                    . "🔮 *ไพ่ยิปซีเต็มสำรับ {$celticPrice} บาท* ✨\n"
                    . "━━━━━━━━━━━━━━━━━\n"
                    ...
                    . "🌟 *บทสรุปสุดท้ายระดับปรมาจารย์*\n"
                    . "    เมื่อจบ — แม่หมอผูกทุกคำถาม + ไพ่ทั้ง 10 + ช่วงเวลา + ลักษณะบุคคล\n\n"
                    ...
                    . "👑 *VIP สิทธิพิเศษ:* คำคมจากลาส่วนตัว + ทำนายช่วงเวลาที่จะเกิดผล\n"
                    . "⏱️ *เวลา:* เปิดไพ่ + ทำนายเสร็จใน 5-10 นาที\n\n",
                "━━━━━━━━━━━━━━━━━\n"
                    . "👑💎 *ແພັກເກດ{$celticNum} — VIP PREMIUM* 💎👑\n"
                    . "🔮 *ໄພ່ຍິບຊີເຕັມສຳລັບ {$celticPrice} ບາດ* ✨\n"
                    . "━━━━━━━━━━━━━━━━━\n"
                    . "🃏 *ເປີດໄພ່ Celtic Cross 10 ໃບ — ເຕັມສຳລັບ*\n"
                    . "    ຕຳແໜ່ງຄົບ: ປັດຈຸບັນ • ອຸປະສັກ • ຄວາມຫວັງ • ອະນາຄົດ\n\n"
                    . "🌌 *ແມ່ໝໍໃຊ້ພະລັງຈັກກະວານ + ຈິດເຈົ້າຊາຕາ*\n"
                    . "    ບໍ່ຕ້ອງບອກວັນເກີດ — ແມ່ໝໍລ້ວງເລິກຜ່ານໄພ່ທີ່ເຈົ້າຊາຕາເລືອກເອງ\n\n"
                    . "💬 *ຖາມໄດ້ {$qLimitText}* (ພາຍໃນ {$qaWindow} ນາທີຫຼັງຄຳທຳນາຍທຳອິດ)\n"
                    . "    ຄຸຍກັບແມ່ໝໍຈົນພໍໃຈ — ແມ່ໝໍຈະຕັດສິນໃຈຈົບເອງເມື່ອຄົບຖ້ວນ\n\n"
                    . "🌟 *ບົດສະຫລຸບສຸດທ້າຍລະດັບປະລະມາຈານ*\n"
                    . "    ເມື່ອຈົບ — ແມ່ໝໍຜູກທຸກຄຳຖາມ + ໄພ່ທັງ 10 + ຊ່ວງເວລາ + ລັກສະນະບຸກຄົນ\n\n"
                    . "🖼️ *ໄດ້ພາບ Celtic Cross spread* ສວຍງາມ\n"
                    . "    ເກັບໄວ້ເປັນທີ່ລະນຶກ ແບ່ງປັນໃຫ້ໝູ່ໄດ້\n\n"
                    . "📜 *ຄຳທຳນາຍແມ່ນກວ່າ ເລິກກວ່າ ເຫັນພາບລວມ*\n"
                    . "    ໃຊ້ສາດໄພ່ຍິບຊີໂບຮານ + ຈິດຕະວິທະຍາສຸຂຸມ ເຫັນເໝືອນຕາເຫັນ\n\n"
                    . "👑 *VIP ສິດທິພິເສດ:* ຄຳຄົມຈາກລາສ່ວນຕົວ + ທຳນາຍຊ່ວງເວລາທີ່ຈະເກີດຜົນ\n"
                    . "⏱️ *ເວລາ:* ເປີດໄພ່ + ທຳນາຍແລ້ວໃນ 5-10 ນາທີ\n\n"
            );
            $message .= $celticBlock;
        }
