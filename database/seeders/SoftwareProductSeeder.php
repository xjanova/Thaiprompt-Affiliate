...
class SoftwareProductSeeder extends Seeder
{
    ...
    {
        // Create Categories
        $mlmCategory = SoftwareProductCategory::create([
        ...
        $ecommerceCategory = SoftwareProductCategory::create([
        ...
        $affiliateCategory = SoftwareProductCategory::create([
            'name' => 'ระบบแอฟฟิลิเอท',
        ...
        // ========================================
        $mlmProduct = SoftwareProduct::create([
        ...
        $mlmPlanOption = SoftwareProductOption::create([
        ...
        $memberLimitOption = SoftwareProductOption::create([
            'software_product_id' => $mlmProduct->id,
            'name' => 'member_limit',
        ...
        $additionalFeaturesOption = SoftwareProductOption::create([
            'software_product_id' => $mlmProduct->id,
        ...
        $installationOption = SoftwareProductOption::create([
            'software_product_id' => $mlmProduct->id,
        ...
        $maintenanceOption = SoftwareProductOption::create([
            'software_product_id' => $mlmProduct->id,
            'name' => 'maintenance',
        ...
        $hostingOption = SoftwareProductOption::create([
            'software_product_id' => $mlmProduct->id,
            'name' => 'hosting',
