...
class FortuneReading extends Model
{
     ...
     *
     * Header (ใหม่) — บอกชัดเจนว่าบิลถูกยกเลิกอัตโนมัติ + เลขบิล:
     *   - ลูกค้าจะได้ไม่งง / ไม่กังวลว่าระบบมีปัญหา
     *   - มีเลขบิลให้อ้างอิงถ้าจะติดต่อ admin
     *   - บอกเหตุผลชัด: "ไม่ได้รับชำระภายใน 30 นาที"
     *
     * 20 รูปแบบปรัชญา (เดิม) — หมุนตาม reading->id (stable per reading) — ใช้คำพูดของคนมีความรู้:
     *   - การลงทุนกับความรู้/อนาคต ราคาถูกกว่าหวย/กาแฟ
     *   - การไม่กล้าเริ่มแม้แต่สิ่งเล็ก = สัญญาณของชีวิตที่ไม่ก้าวหน้า
     *   - ของเราใช้หลักดาวเจ้าชนะ + ไพ่ที่จิตเลือก (ไม่ใช่ยกเมฆ)
     *
     * @return string ข้อความแจ้งยกเลิก + เตือนสติ + แนวทางเริ่มต้นใหม่
     */
    protected static function buildCancelWakeupMessage(self $reading): string
    {
        // 🚫 Header — แจ้งชัดเจนว่าบิลถูกยกเลิกอัตโนมัติ + เลขบิล + เหตุผล
