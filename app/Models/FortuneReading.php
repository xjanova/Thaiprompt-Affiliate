...
class FortuneReading extends Model
{
     ...
     *
     * 20 รูปแบบหมุนตาม reading->id (stable per reading) — ใช้คำพูดเชิงปรัชญา
     * ไม่ด่า ไม่บีบ แค่ชวนให้ตระหนักว่า:
     ...
     *
     * @return string ข้อความเตือนสติ + แนวทางเริ่มต้นใหม่
     */
