...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">แก้ไขเทมเพลตการแจ้งเตือน</p>
        </div>
    </div>
    ...
    <!-- Form -->
    <form action="{{ route('admin.notification-templates.update', $template->id) }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
        @csrf
        @method('PUT')
