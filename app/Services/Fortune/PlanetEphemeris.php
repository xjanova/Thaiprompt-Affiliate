...
class PlanetEphemeris
{
    ...
    /**
     * อายนางศ (ayanamsa) แบบ Lahiri **เฉลี่ย (mean)** ณ J2000.0 — องศา
     *
     * = 23°51'25.5" ค่าเดียวกับ Swiss Ephemeris และปฏิทินโหรลาหิรีของ myhora.com
     *
     * 🔧 (2026-09-13) เดิมใช้ 23.85292472 (23°51'10.5") = ค่า "จริง (true)" ที่รวม nutation ของ J2000 ไว้
     *    แต่ตำแหน่งดาวทั้งคลาสนี้อ้างวิษุวัตเฉลี่ยของวันนั้น (ไม่รวม nutation) ⇒ ต้องคู่กับอายนางศแบบเฉลี่ย
     *    ค่าเดิมต่ำไป ~15″ ⇒ ดาวทุกดวง + ลัคนา เร็วไป 15″ เทียบ myhora
     *    หลักฐาน: ราหู (Meeus สูตรเดียวกับ myhora) คลาดคงที่ +15–16″ ตลอด 100 ปี → หลังแก้เหลือ 0″
     *    GenLotto (โปรเจกต์พี่น้องที่พอร์ตคลาสนี้ไป) เทียบ myhora 335 วัน × 10 ดาว + 12 ผังลัคนา แล้วแก้ก่อน (2026-09-12)
     *    ผลต่อลูกค้า: 15″ ≈ เวลาเกิดคลาด 1 วินาที — ราศีลัคนาแทบไม่มีใครเปลี่ยน แก้เพื่อให้ตรงแหล่งอ้างอิง
     */
    private const AYANAMSA_J2000 = 23.857092;
    ...
    /**
     * จุดอ้างอิงเกตุไทย: ยกเข้าราศีมีน (ข้าม 0°) 5 ม.ค. 2569 เวลา 01:04 น. เวลาไทย (UTC+7)
     * = 2026-01-04 18:04 UT = JD 2461045.2527778
     *
     * 🔧 (2026-09-13) เดิมตั้งไว้ 00:46 น. — เร็วไป 18 นาที
     *    ปฏิทินสุริยยาตร์ของ myhora.com พิมพ์ **เวลาท้องถิ่นกรุงเทพฯ (UTC+06:42)** ตามที่หน้านั้นหมายเหตุไว้เอง
     *    เราอ่าน 00:46 เป็นเวลาไทย ⇒ ต้อง +18 นาที = 01:04 น.
     *    ยืนยันกับหน้ารายการดาวยกราศีแบบลาหิรีของ myhora (พิมพ์เวลาไทย) — เกตุยกราศีที่นาที :04 ทุกครั้ง
     *    ตรงทั้ง 19 ครั้ง ปี 2567–2569 (ดู PlanetEphemerisAccuracyTest::myhoraKetuIngresses)
     */
    public const KETU_TH_EPOCH_JD = 2461045.2527778;
     ...
     *
     * ใช้ค่าแบบ Lahiri เฉลี่ย: 23°51'25.5" ที่ J2000 แล้วเพิ่มตามอัตราพรีเซสชัน
     * ปี 2569 (2026) ได้ ~24.23° = 24°13.8' ตรงกับตารางอายนางศมาตรฐาน
     *
     ...
     * เช่น เข้าพิจิก 19 ส.ค. 2569 09:04 น. · เข้าตุลย์ 14 ต.ค. 2569 23:04 น. (เวลาไทย —
     * ปฏิทินพิมพ์ 08:46 / 22:46 เป็นเวลาท้องถิ่นกรุงเทพฯ UTC+06:42 ดู KETU_TH_EPOCH_JD)
     *
