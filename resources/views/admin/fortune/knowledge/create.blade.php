...
<div class="container mx-auto px-4 py-6 max-w-3xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">🧠 เพิ่มองค์ความรู้</h1>
    ...
    <form method="POST" action="{{ route('admin.fortune.knowledge.store') }}"
          class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 space-y-4">
        @csrf
        @include('admin.fortune.knowledge._form', ['item' => null])
        <div class="flex gap-3 pt-2">
            <button type="submit" class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition">💾 บันทึก</button>
