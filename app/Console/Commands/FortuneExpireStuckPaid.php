...
/**
 * 🚨 (2026-05-19) Expire stuck paid readings — Last-resort safety net
 *
...
class FortuneExpireStuckPaid extends Command
{
    ...
    public function handle(): int
    {
        ...
        $celticStuck = FortuneReading::query()
            ...
            ->limit($limit)
            ->get()
            // กรองเฉพาะ Celtic ที่ยังไม่ได้เปิดไพ่เลย (picked=0)
            ->filter(fn ($r) => method_exists($r, 'getCelticPickedCount')
