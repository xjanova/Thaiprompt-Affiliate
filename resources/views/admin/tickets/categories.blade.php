...
<div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                ...
                <button onclick="openCreateModal()"
                        class="inline-flex items-center px-6 py-3 bg-white text-orange-600 hover:bg-orange-50 rounded-xl font-semibold transition-all duration-200 hover:scale-105 shadow-lg">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-orange-500 hover:shadow-xl transition-all duration-200 hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 dark:text-gray-400 text-sm font-medium mb-1">Total Categories</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-green-500 hover:shadow-xl transition-all duration-200 hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 dark:text-gray-400 text-sm font-medium mb-1">Active Categories</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-purple-500 hover:shadow-xl transition-all duration-200 hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 dark:text-gray-400 text-sm font-medium mb-1">Most Used</p>
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-gray-400 dark:text-gray-500 text-sm mt-2">Create your first category to organize tickets</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-2xl w-full transform transition-all">
            <form id="categoryForm" method="POST">
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" required
                               class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">FontAwesome icon class</p>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="color" name="color" id="color"
                                   class="w-full h-12 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                                   value="#f59e0b">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order" min="0" value="0"
                               class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                               placeholder="0">
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Lower number appears first</p>
                    </div>

                    <!-- Active Status -->
                    <div class="flex items-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
                ...
                <div class="px-8 py-6 bg-gray-50 dark:bg-gray-900 rounded-b-2xl flex justify-end space-x-3">
                    ...
                    <button type="submit"
                            class="px-6 py-3 rounded-lg bg-gradient-to-r from-orange-600 to-amber-600 text-white font-semibold hover:from-orange-700 hover:to-amber-700 transition-all shadow-lg">
