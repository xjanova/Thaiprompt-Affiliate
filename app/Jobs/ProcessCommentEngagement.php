    ...
    protected function pickCannedReply(string $name, bool $isLao, string $category): string
    {
        ...
        if ($category === 'blessing') {
            $replies = $isLao ? [
                ...
                // ⛔ (2026-08-22) ห้ามใส่ {name} — ชื่อจากโปรไฟล์เป็นชื่อเต็ม
                //    เห็นปุ๊บรู้ทันทีว่าเป็นบอท (ชุดนี้เป็นทางสำรองตอนคลัง DB ใช้ไม่ได้)
                'สาธุค่ะ 🙏 ขอให้ดวงพุ่งแรงทั้งสัปดาห์นี้ เกิดวันอะไรคะ',
                'ขอให้สมหวังทุกประการค่ะ ✨ ตอนนี้ห่วงเรื่องไหนที่สุดคะ',
                'น้อมรับพรดีๆ ค่ะ 💖 ขอให้สุขภาพแข็งแรงนะคะ',
                'ขอบคุณค่ะ 🌟 ส่งพลังบวกกลับด้วยนะคะ',
                'สาธุค่ะ ฟ้าเปิดทางใหม่ให้แล้วนะคะ 🙏',
                'น้อมรับพลังบวกค่ะ 💫 ขอให้สิ่งดีๆ เข้ามาทุกวัน',
                'ขอให้ทุกอย่างราบรื่นนะคะ 🌈 วันนี้เป็นยังไงบ้างคะ',
                'สาธุค่ะ ขอให้โชคดีตลอดทั้งเดือน 🍀',
            ];
        } else { // emoji
            $replies = $isLao ? [
                '🙏 ສາທຸເດີ {name}',
                ...
                // ⛔ ห้ามใส่ {name} — เหตุผลเดียวกับชุด blessing ด้านบน
                '💖 ขอให้โชคดีค่ะ',
