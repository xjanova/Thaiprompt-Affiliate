...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">✏️ แก้ไขเกม</h2>
            ...
            <form action="{{ route('admin.games.update', $game) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="title_en" name="title_en" value="{{ old('title_en', $game->title_en) }}"
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('description', $game->description) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="description_en" name="description_en" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('description_en', $game->description_en) }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="icon" name="icon" value="{{ old('icon', $game->icon) }}" required maxlength="10"
                               placeholder="🎮 🚀 ⚡ 🧭"
                    ...
                    <div>
                        ...
                        @if($game->image)
                            <div class="mb-2">
                                <img src="{{ asset($game->image) }}" alt="{{ $game->title }}" class="w-32 h-32 object-cover rounded-lg">
                                <p class="text-xs text-gray-500 mt-1">รูปปัจจุบัน</p>
                            </div>
                        @endif
                        <input type="file" id="image" name="image" accept="image/*"
                               class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        <p class="mt-1 text-sm text-gray-500">รองรับ: JPG, PNG, GIF, WebP (สูงสุด 2MB) - เว้นว่างถ้าไม่ต้องการเปลี่ยน</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="url" id="url" name="url" value="{{ old('url', $game->url) }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="color" id="primary_color" name="primary_color" value="{{ old('primary_color', $game->primary_color) }}" required
                                   class="h-10 w-20 border border-gray-300 dark:border-slate-600 rounded-md">
                            <input type="text" id="primary_color_text" value="{{ old('primary_color', $game->primary_color) }}"
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="color" id="secondary_color" name="secondary_color" value="{{ old('secondary_color', $game->secondary_color) }}" required
                                   class="h-10 w-20 border border-gray-300 dark:border-slate-600 rounded-md">
                            <input type="text" id="secondary_color_text" value="{{ old('secondary_color', $game->secondary_color) }}"
                                   class="flex-1 px-3 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-md">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="glow_color" name="glow_color" value="{{ old('glow_color', $game->glow_color) }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="card_style" name="card_style" required
                                class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            <option value="default" {{ old('card_style', $game->card_style) == 'default' ? 'selected' : '' }}>Default</option>
                            <option value="gradient" {{ old('card_style', $game->card_style) == 'gradient' ? 'selected' : '' }}>Gradient</option>
                            <option value="glass" {{ old('card_style', $game->card_style) == 'glass' ? 'selected' : '' }}>Glass</option>
                            <option value="neon" {{ old('card_style', $game->card_style) == 'neon' ? 'selected' : '' }}>Neon</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="order" name="order" value="{{ old('order', $game->order) }}" min="0"
                               class="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
                </div>
