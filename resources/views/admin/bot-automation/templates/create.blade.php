                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <select class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent @error('category') border-red-500 @enderror"
                                        ...
                                        <option value="support" {{ old('category') == 'support' ? 'selected' : '' }}><span data-translate>ซัพพอร์ต</span></option>
                                        <option value="marketing" {{ old('category') == 'marketing' ? 'selected' : '' }}><span data-translate>การตลาด</span></option>
                                        <option value="education" {{ old('category') == 'education' ? 'selected' : '' }}><span data-translate>การศึกษา</span></option>
                                        <option value="ecommerce" {{ old('category') == 'ecommerce' ? 'selected' : '' }}><span data-translate>อีคอมเมิร์ซ</span></option>
                                    </select>
                                    @error('category')
                                        <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                    @enderror
                        ...
                        <div class="p-6">
                            <ul class="space-y-3">
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 mt-0.5 flex-shrink-0 text-green-300" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span class="text-sm" data-translate>ใช้ข้อความที่ชัดเจนและกระชับ</span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 mt-0.5 flex-shrink-0 text-green-300" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span class="text-sm" data-translate>กำหนดคำสำคัญทริกเกอร์หลายคำ</span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 mt-0.5 flex-shrink-0 text-green-300" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span class="text-sm" data-translate>ทดสอบโฟลว์อย่างละเอียด</span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 mt-0.5 flex-shrink-0 text-green-300" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span class="text-sm" data-translate>เพิ่มการตอบกลับสำรอง</span>
                                </li>
                                <li class="flex items-start gap-3">
                                    <svg class="w-5 h-5 mt-0.5 flex-shrink-0 text-green-300" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                    <span class="text-sm" data-translate>เน้นเทมเพลตให้มีจุดประสงค์ชัดเจน</span>
                                </li>
                            </ul>
                        </div>
                    </div>
