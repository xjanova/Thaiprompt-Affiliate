...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <p class="text-gray-600 text-sm">ฟรี</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <p class="text-gray-600 text-sm">ค่าเฉลี่ย</p>
            ...
            <div class="space-y-3">
                ...
                <div>
                    <div class="flex justify-between mb-1">
                        ...
                        <span class="text-sm text-gray-600">{{ $item->count }} ครั้ง (฿{{ number_format($item->revenue ?? 0) }})</span>
                    </div>
            ...
            <div class="space-y-3">
                ...
                <div>
                    <div class="flex justify-between mb-1">
                        ...
                        <span class="text-sm text-gray-600">{{ $item->count }} ครั้ง</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
