...
class CelticCrossService
{
    ...
    protected function buildBlackMagicDirective(FortuneReading $reading, string $userQuestion, string $previousContext = ''): string
    {
        ...
        return "━━━━━━━━━━━━━━━━━\n"
            ...
            ."3. อ่านไพ่บอกใบ้ให้ครบ: โดนของจริงไหม / แบบไหน (เสน่ห์ยาแฝด/ของกิน/ของฝัง/อาคม/วิญญาณ) /\n"
            ."   มาทางไหน-ช่วงไหน (เท่าที่ไพ่ชี้ — ❌ ห้ามมั่วชื่อคนจริง) / หนัก-เบาแค่ไหน / คลายแล้วหรือยัง\n"
