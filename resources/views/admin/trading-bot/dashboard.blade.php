...
<div class="container-fluid px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">ระบบจัดการบอทเทรดอัตโนมัติ</p>
        </div>
        <div class="flex space-x-3">
            <a href="{{ route('admin.trading-bot.arbitrage-monitor') }}" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-lg transition-colors">
                💹 Arbitrage Monitor
            </a>
            <a href="{{ route('admin.trading-bot.packages.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition-colors">
                + New Package
            </a>
        </div>
    </div>
    ...
    <!-- System Health -->
    <div class="mb-8 p-6 rounded-lg {{ $systemHealth['status'] === 'good' ? 'bg-green-50 dark:bg-green-900/20' : ($systemHealth['status'] === 'warning' ? 'bg-yellow-50 dark:bg-yellow-900/20' : 'bg-red-50 dark:bg-red-900/20') }}">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-yellow-500 to-orange-600 rounded-lg p-6 text-white shadow-lg">
            <div class="flex justify-between items-start">
                <div>
                ...
                <div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $subscription->package->name }}</p>
                        </div>
                ...
                <div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">{{ $bot->trading_pair }}</p>
                        </div>
                        <div class="text-right">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <a href="{{ route('admin.trading-bot.packages.index') }}" class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
            <div class="text-3xl mb-3">📦</div>
            <h3 class="font-bold text-lg text-gray-900 dark:text-white mb-2">Packages</h3>
            <p class="text-gray-600 dark:text-gray-300 text-sm">Manage subscription packages</p>
        </a>

        <a href="{{ route('admin.trading-bot.exchanges.index') }}" class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
            <div class="text-3xl mb-3">🌐</div>
            <h3 class="font-bold text-lg text-gray-900 dark:text-white mb-2">Exchanges</h3>
            <p class="text-gray-600 dark:text-gray-300 text-sm">Manage supported exchanges</p>
        </a>

        <a href="{{ route('admin.trading-bot.analytics') }}" class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
            <div class="text-3xl mb-3">📊</div>
            <h3 class="font-bold text-lg text-gray-900 dark:text-white mb-2">Analytics</h3>
            <p class="text-gray-600 dark:text-gray-300 text-sm">View detailed analytics</p>
        </a>

        <a href="{{ route('admin.trading-bot.settings') }}" class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow">
            <div class="text-3xl mb-3">⚙️</div>
            <h3 class="font-bold text-lg text-gray-900 dark:text-white mb-2">Settings</h3>
            <p class="text-gray-600 dark:text-gray-300 text-sm">System configuration</p>
        </a>
    </div>
</div>
@endsection
