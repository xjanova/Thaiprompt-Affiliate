...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 rounded-3xl shadow-2xl p-8 text-white relative overflow-hidden">
        ...
        <div class="relative">
            <a href="{{ route('admin.crypto.hd-wallets.show', $masterWallet->id) }}" class="inline-flex items-center space-x-2 px-4 py-2 glass-fusion hover:glass-fusion backdrop-blur-sm rounded-xl mb-4 transition-all">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="flex items-center space-x-6">
                        <div class="px-4 py-2 glass-fusion backdrop-blur-sm rounded-xl" border border-white/20 dark:border-white/10>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all transform hover:scale-[1.02] border-2 border-transparent hover:border-emerald-500" border border-white/20 dark:border-white/10>
            <!-- Header -->
            <div class="bg-gradient-to-br from-emerald-500 to-green-600 p-6 relative overflow-hidden">
                <div class="absolute top-0 right-0 w-24 h-24 glass-fusion opacity-10 rounded-full -mr-12 -mt-12" border border-white/20 dark:border-white/10></div>
                <div class="relative">
                    <div class="flex items-center justify-between mb-3">
                        <span class="px-3 py-1 glass-fusion backdrop-blur-sm text-white text-xs font-bold rounded-full">
            ...
            <div class="p-6">
                ...
                <div class="mb-4 p-4 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 dark:border-gray-600">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <div class="grid grid-cols-2 gap-3 mb-4">
                    <div class="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                    ...
                    <div class="text-center p-3 bg-purple-50 dark:bg-purple-900/20 rounded-xl border border-purple-200 dark:border-purple-800">
                        <i class="fas fa-exchange-alt text-purple-600 mb-1"></i>
                        <p class="text-lg font-bold text-gray-900 dark:text-white">0</p>
                        <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400">Transactions</p>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        @if($wallet->status === 'active')
                        <button onclick="lockWallet({{ $wallet->id }})" class="px-3 py-2 bg-yellow-100 hover:bg-yellow-200 dark:bg-yellow-900 dark:hover:bg-yellow-800 text-yellow-700 dark:text-yellow-300 font-semibold rounded-xl transition-all text-sm">
                            <i class="fas fa-lock mr-1"></i>ล็อก
                        </button>
                        @else
                        <button onclick="unlockWallet({{ $wallet->id }})" class="px-3 py-2 bg-green-100 hover:bg-green-200 dark:bg-green-900 dark:hover:bg-green-800 text-green-700 dark:text-green-300 font-semibold rounded-xl transition-all text-sm">
                            <i class="fas fa-unlock mr-1"></i>ปลดล็อก
                        </button>
                        @endif
                        <button class="px-3 py-2 bg-gray-100/50 dark:bg-gray-800/50 hover:bg-gray-200 dark:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 dark:text-gray-300 font-semibold rounded-xl transition-all text-sm">
            ...
            <!-- Footer -->
            <div class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:bg-gray-900 px-6 py-3 border-t border-gray-200 dark:border-gray-700 dark:border-gray-700">
        ...
        @empty
        <div class="col-span-3 glass-fusion dark:bg-gray-800 rounded-2xl shadow-xl p-16 text-center" border border-white/20 dark:border-white/10>
            ...
            <p class="text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-6">Master Wallet นี้ยังไม่มี Child Wallet</p>
    ...
    <div class="glass-fusion dark:bg-gray-800 rounded-2xl shadow-lg p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
        {{ $childWallets->links() }}
    </div>
    @endif
    ...
    <div class="glass-fusion dark:bg-gray-800 rounded-2xl shadow-xl p-8" border border-white/20 dark:border-white/10>
        ...
        <div class="flex flex-col items-center space-y-8 py-8">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="px-4 py-3 bg-gray-200 dark:bg-gray-700 dark:bg-gray-700 rounded-xl">
                    <p class="text-gray-600 dark:text-gray-400 dark:text-gray-400 font-bold">+{{ $childWallets->count() - 5 }} more</p>
                </div>
                @endif
            </div>
        </div>
