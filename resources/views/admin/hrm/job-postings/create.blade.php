...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl shadow-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-purple-100">สร้างประกาศรับสมัครงานใหม่</p>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
        <form action="{{ route('admin.hrm.recruitment.jobs.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="employment_type"
                        ...
                        <option value="full_time" {{ old('employment_type') == 'full_time' ? 'selected' : '' }}>Full Time (เต็มเวลา)</option>
                        <option value="part_time" {{ old('employment_type') == 'part_time' ? 'selected' : '' }}>Part Time (พาร์ทไทม์)</option>
                        <option value="contract" {{ old('employment_type') == 'contract' ? 'selected' : '' }}>Contract (สัญญาจ้าง)</option>
                        <option value="intern" {{ old('employment_type') == 'intern' ? 'selected' : '' }}>Intern (ฝึกงาน)</option>
                        <option value="freelance" {{ old('employment_type') == 'freelance' ? 'selected' : '' }}>Freelance (อิสระ)</option>
                    </select>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="benefits"
                              ...
                              placeholder="ระบุสวัสดิการและผลประโยชน์ที่จะได้รับ...">{{ old('benefits') }}</textarea>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="status"
                        ...
                        <option value="active" {{ old('status', 'active') == 'active' ? 'selected' : '' }}>เปิดรับสมัคร</option>
                        <option value="on_hold" {{ old('status') == 'on_hold' ? 'selected' : '' }}>พักการรับสมัคร</option>
                        <option value="closed" {{ old('status') == 'closed' ? 'selected' : '' }}>ปิดรับสมัคร</option>
                        <option value="filled" {{ old('status') == 'filled' ? 'selected' : '' }}>จ้างแล้ว</option>
                    </select>
                    @error('status')
                        <p class="mt-1 text-sm text-red-500"><i class="fas fa-exclamation-circle"></i> {{ $message }}</p>
                    @enderror
