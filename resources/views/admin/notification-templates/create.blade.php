...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">สร้างเทมเพลตเพื่อใช้งานซ้ำได้อย่างสะดวก</p>
        </div>
    </div>
    ...
    <!-- Form -->
    <form action="{{ route('admin.notification-templates.store') }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="icon" value="{{ old('icon') }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                           placeholder="เช่น 👋 🎉 💰">
                    <p class="text-xs text-gray-500 mt-1">ใช้ emoji เพื่อแสดงไอคอน</p>
                </div>
                ...
                <div>
                    ...
                    <select name="color" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
                ...
                <select name="priority" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
