...
export const useShopLocationConsent = () => {
  ...
  const element = (
    <ConsentSheet
      ...
      reasons={[
        { icon: 'shopping-cart-simple', text: 'ใช้ตำแหน่งตอนคุณกดเปิดร้าน เพื่อปักหมุดจุดขายวันนี้' },
        { icon: 'eye', text: 'ลูกค้าเห็นตำแหน่งร้านเฉพาะตอนร้านเปิดเท่านั้น ปิดร้านแล้วตำแหน่งถูกซ่อนทันที' },
        { icon: 'broadcast', text: 'ถ้าคุณเปิด "แชร์ตำแหน่งสด" แอปส่งตำแหน่งทุก 30 วินาที เฉพาะตอนเปิดแอปไว้ ปิดแอปแล้วหยุดชั่วคราว' },
        { icon: 'house', text: 'ไม่ใช้ตำแหน่งเบื้องหลัง และไม่แสดงที่อยู่บ้านของคุณให้ใครเห็น' },
      ]}
