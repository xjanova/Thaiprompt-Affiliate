...
trait CelticCrossConversationTrait
{
    ...
    protected function presentTierChoice(FortuneReading $reading): array
    {
        ...
        if ($isCelticOnlyIntro) {
            ...
            $introLine = FortuneLocaleService::lo(
                'ที่นี่ไม่ใช่ดูดวงสำเร็จรูปนะคะ — แม่หมอเปิดไพ่จริงให้ แล้ว *คุยตอบกันสด ๆ* เหมือนนั่งดูต่อหน้า ✨',
        ...
        if ($deepEnabled) {
            $deepBlock = FortuneLocaleService::lo(
                "━━━━━━━━━━━━━━━━━\n"
                    ."🔹 *แพคเกจ{$deepNum} — ดูพื้นดวง {$deepPrice} บาท* 💫\n"
                    ."━━━━━━━━━━━━━━━━━\n"
                    ."📅 *วิเคราะห์จากวันเดือนปีเกิด + ไพ่*\n"
                    ."    หมอคำนวณดาวเจ้าชนะ + ราศี + ลัคนา ผสมกับไพ่ให้\n\n"
                    ."🃏 *เปิดไพ่ + อ่านพื้นดวงรวมให้ทันที*\n"
                    ."    ไม่ต้องพิมพ์คำถาม — แม่หมออ่านภาพรวมชีวิตให้เลย\n\n"
                    ."💬 *คุยกับแม่หมอต่อได้ {$deepWindow} นาที* (ถามได้ไม่จำกัด)\n"
                    ."💎 *เหมาะกับ:* คนอยากรู้ดวงรวม ๆ เริ่มต้นง่าย ราคาเป็นมิตร\n\n",
                "━━━━━━━━━━━━━━━━━\n"
            ...
            if ($isCelticOnlyIntro) {
                $celticBlock = FortuneLocaleService::lo(
                    "👑 *Celtic Cross • ค่าครู {$celticPrice} บาท*\n"
                        ."🃏 เปิดไพ่ 10 ใบ ฟันธงทีละใบ (ไพ่โบราณดั้งเดิม)\n"
                        ."💬 ถามแม่หมอได้ {$qLimitText} ใน {$qaWindow} นาที — ตอบสดไม่มีรอ\n"
                        ."🎁 แถมภาพไพ่สวย ๆ เก็บเป็นที่ระลึก\n\n",
        ...
        if ($isCelticOnlyIntro) {
            // 🌙 (2026-05-31) CTA สั้น + ชี้ไปปุ่มด้านล่าง (เป็นมิตรกับผู้สูงอายุ) — soft tone 3 ทางเลือก
            ...
            $message .= FortuneLocaleService::lo(
                "✨ พร้อม — กดปุ่ม *\"👑 VIP ดูไพ่เต็ม\"* ด้านล่างได้เลย\n"
                    ."💬 อยากถามก่อน — พิมพ์มาได้เลย แม่หมอตอบให้\n"
                    .'🙏 ยังไม่พร้อม — พิมพ์ *"ไว้คราวหน้า"* ก็ได้ค่ะ',
    ...
    protected function handleTierChoice(FortuneReading $reading, string $messageText): array
    {
        ...
        $celticKeywords = [
            ...
            // 🆕 (2026-06-08) ปุ่มใหม่ "👑 VIP ดูไพ่เต็ม" — รองรับกดหรือพิมพ์ตามป้าย
    ...
    protected function handleCelticAwaitingQuestion(FortuneReading $reading, string $messageText): array
    {
        ...
        $followupOffer = "\n\n──────────────────────\n"
            .$timeHint
            .$qHint."\n"
            .'💬 พิมพ์คำถามต่อไปได้เลย — หรือพิมพ์ *"เลิก"* เมื่อพร้อมจบและรับสรุป ✨';
