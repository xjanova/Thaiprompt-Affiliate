...
class SendBillReminderJob implements ShouldQueue
{
    ...
    private function buildSystemMessage(string $personaContext, bool $isAwaitingMethod = false): string
    {
        ...
        $missionLine = $isAwaitingMethod
            ? 'ภารกิจ: ลูกค้าเห็นปุ่มเลือกวิธีชำระเงิน (QR ไทย / บัตรเครดิต) แต่ยังลังเล ไม่ได้กดเลือก ผ่านมา 2+ นาที — ทักไปกระตุ้นเบา ๆ + เปิดทางขอช่วยถ้าติดขัด'
            : 'ภารกิจ: ลูกค้าสร้างบิลดูดวงไว้แต่ยังไม่ได้โอนเงิน (ผ่านมา 2+ นาที) — ทักไปด้วยความห่วงใย + เล่า benefit (สิ่งที่จะได้รับหลังโอน) ไม่ใช่ทวงแบบเจ้าหนี้';
