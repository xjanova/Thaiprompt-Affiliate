...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('app_theme_settings', function (Blueprint $table) {
            ...
            // Input States
            $table->string('input_background')->nullable()->after('background_light_color');
            $table->string('input_background_dark')->nullable()->after('input_background');
            $table->string('input_border')->nullable()->after('border_light_color');
            ...
            // Link Colors
            $table->string('link_color')->nullable()->after('info_dark_color');
            ...
            // Status Badge Colors
            $table->string('badge_success')->nullable()->after('success_dark_color');
            $table->string('badge_warning')->nullable()->after('warning_dark_color');
            $table->string('badge_error')->nullable()->after('error_dark_color');
            $table->string('badge_info')->nullable()->after('info_dark_color');
