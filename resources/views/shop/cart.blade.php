    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="mb-8" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2 text-sm">
                ...
                <li class="text-gray-400">/</li>
                <li class="text-gray-700 font-medium">ตะกร้าสินค้า</li>
            </ol>
        </nav>

        <!-- Page Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-black text-gray-900 mb-2">🛒 ตะกร้าสินค้า</h1>
            <p class="text-gray-600">จัดการสินค้าในตะกร้าของคุณ</p>
        </div>
            ...
            <div class="lg:col-span-2 space-y-4">
                    ...
                    <div class="flex flex-col sm:flex-row gap-6">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ route('shop.show', $product->slug) }}" class="block">
                                <div class="w-full sm:w-32 aspect-square bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl overflow-hidden">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex items-center border-2 border-gray-300 rounded-lg">
                                            <button onclick="updateCartQuantity({{ $item->id }}, {{ max(1, $item->quantity - 1) }})"
                                                    class="px-3 py-1 hover:bg-gray-100 font-bold transition"
                                            ...
                                            <input type="number"
                                                   ...
                                                   class="w-16 text-center border-x-2 border-gray-300 py-1 font-semibold focus:outline-none">
                ...
                <div class="mt-6">
                    <form action="{{ route('cart.clear') }}" method="POST" onsubmit="return confirm('ต้องการล้างสินค้าทั้งหมดในตะกร้า?')">
                        ...
                        @method('DELETE')
                        <button type="submit"
                                class="px-6 py-3 border-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-white font-semibold rounded-xl transition">
                            🗑️ ล้างตะกร้าสินค้า
                        </button>
                    </form>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 sticky top-4">
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div class="text-sm text-gray-600 bg-blue-50 p-3 rounded-lg">
                            💡 ซื้อเพิ่มอีก <span class="font-bold text-indigo-600">฿{{ number_format(500 - $subtotal, 2) }}</span> เพื่อรับการจัดส่งฟรี!
                        </div>
                        @endif
                    </div>
                    ...
                    <a href="{{ route('checkout.index') }}"
                       class="block w-full px-6 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white text-center font-bold text-lg rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
                        ⚡ ดำเนินการชำระเงิน
                    </a>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <p class="text-sm font-semibold text-gray-700 mb-3">เรารับชำระผ่าน</p>
                        <div class="grid grid-cols-2 gap-2">
                            <div class="px-3 py-2 bg-gray-50 rounded-lg text-center text-xs font-medium text-gray-600">
                                💳 บัตรเครดิต
                            </div>
                            <div class="px-3 py-2 bg-gray-50 rounded-lg text-center text-xs font-medium text-gray-600">
                                🏦 โอนธนาคาร
        ...
        <div class="bg-white rounded-2xl shadow-xl p-12 text-center">
            ...
            <h2 class="text-3xl font-bold text-gray-900 mb-3">ตะกร้าสินค้าว่างเปล่า</h2>
            <p class="text-gray-600 mb-8 text-lg">คุณยังไม่มีสินค้าในตะกร้า เริ่มช๊อปปิ้งกันเลย!</p>
            <a href="{{ route('shop.index') }}"
               class="inline-block px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold text-lg rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
                🛍️ เริ่มช๊อปปิ้ง
            </a>
        </div>
        @endif
