            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400">รหัสการสมัคร</label>
                            <p class="mt-1 text-lg font-bold text-gray-900 dark:text-white">#{{ $subscription->id ?? 'N/A' }}</p>
                        </div>
                        <div>
                            <label data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400">สถานะ</label>
                            <div class="mt-1">
                                @if(isset($subscription->status))
                                    ...
                                    @elseif($subscription->status == 'cancelled')
                                        <span data-translate class="px-4 py-2 inline-flex text-sm font-semibold rounded-full bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400">ยกเลิก</span>
                                    @else
                        ...
                        <div>
                            <label data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400">ผู้ใช้</label>
                        ...
                        <div>
                            <label data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400">รายการ</label>
                        ...
                        <div>
                            <label data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400">วันเริ่มต้น</label>
                        ...
                        <div>
                            <label data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400">วันหมดอายุ</label>
                        ...
                        <div>
                            <label data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400">จำนวนเงิน</label>
                            <p class="mt-1 text-2xl font-bold text-green-600 dark:text-green-400">${{ number_format($subscription->amount ?? 0, 2) }}</p>
                        </div>
                        <div>
                            <label data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400">รอบการเรียกเก็บเงิน</label>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <label data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400">หมายเหตุ</label>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase" data-translate>วันที่</th>
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase" data-translate>จำนวน</th>
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase" data-translate>สถานะ</th>
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase">ID</th>
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase" data-translate>วิธีชำระ</th>
                            </tr>
                        </thead>
                ...
                <div class="p-4">
                    <div class="space-y-2">
                        <a href="#" class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg transition-colors">
                            ...
                            <span data-translate class="text-sm font-medium text-gray-700 dark:text-gray-300">ส่งอีเมลถึงผู้ใช้</span>
                        </a>
                        <a href="#" class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg transition-colors">
                            <svg class="w-5 h-5 text-gray-600 dark:text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            <span data-translate class="text-sm font-medium text-gray-700 dark:text-gray-300">ดูใบแจ้งหนี้</span>
                        </a>
                        <a href="#" class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg transition-colors">
                            <svg class="w-5 h-5 text-gray-600 dark:text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/>
                            </svg>
                            <span data-translate class="text-sm font-medium text-gray-700 dark:text-gray-300">ดาวน์โหลดใบเสร็จ</span>
                        </a>
                        <a href="#" class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-lg transition-colors">
                            <svg class="w-5 h-5 text-gray-600 dark:text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                            </svg>
                            <span data-translate class="text-sm font-medium text-gray-700 dark:text-gray-300">แก้ไขการสมัคร</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center pb-3 border-b border-gray-200 dark:border-gray-700">
                            <span data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400">ใช้ครั้งสุดท้าย:</span>
                        ...
                        <div class="flex justify-between items-center pb-3 border-b border-gray-200 dark:border-gray-700">
                            <span data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400">บอทที่ใช้งาน:</span>
                            <span class="text-lg font-bold text-gray-900 dark:text-white">{{ $subscription->active_bots ?? '0' }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400">พื้นที่ใช้งาน:</span>
