...
class FortunePackageCardBuilder
{
    ...
    /**
     * รูป 99 พิมพ์ว่า "ถามได้ไม่อั้น ใน 15 นาที" = สิทธิ์แบบไม่จำกัด
     *
     * ⚠️ ค่าที่เทียบคือค่าที่ presentTierChoice ปั้นจาก settings (ไม่ใช่ถ้อยคำบนรูป):
     *    celtic_cross_max_questions = 0 → "ไม่จำกัด" ⇒ ตรง
     *    ตั้งเป็นตัวเลข (เช่น 5) → "5 คำถาม" ⇒ ไม่ตรงรูป ⇒ การ์ดหายทั้งชุด ต้องสร้างรูปใหม่
     *    (prod 2026-08-23 = 0 — เคยพลาดพิมพ์ "5 คำถาม" ลงรูปแล้วการ์ดไม่ขึ้นเลยทั้ง 3 ใบ)
     */
    ...
    private function packages(array $ctx): ?array
    {
        ...
        // "ถามได้ ไม่จำกัด" อ่านแล้วสะดุด — ใช้ถ้อยคำเดียวกับที่พิมพ์อยู่บนรูปเป๊ะ ๆ
        $askLine = $qLimitText === 'ไม่จำกัด'
            ? "ถามได้ไม่อั้น ใน {$qaWindow} นาที"
