...
<div class="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-4xl font-bold text-white mb-2 flex items-center gap-3">
                        ...
                        <span data-translate>แก้ไขสินค้าและบริการ</span>
                    </h1>
    ...
    <!-- Form -->
    <form action="{{ route('admin.accounting.products.update', $product) }}" method="POST" class="max-w-5xl mx-auto">
        @csrf
        @method('PUT')
        ...
        <div class="glass-fusion dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-2xl p-8 space-y-8 border-2 border-emerald-100 dark:border-emerald-900" border border-white/20 dark:border-white/10>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <label class="relative flex items-center p-6 border-3 rounded-2xl cursor-pointer transition-all hover:shadow-xl {{ old('type', $product->type) === 'goods' ? 'border-blue-500 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/40 dark:to-blue-800/40 shadow-lg' : 'border-gray-300 dark:border-gray-600 dark:border-gray-600 hover:border-blue-300 dark:hover:border-blue-700' }}">
                        <input type="radio" name="type" value="goods" {{ old('type', $product->type) === 'goods' ? 'checked' : '' }}
                        ...
                        @if(old('type', $product->type) === 'goods')
                    ...
                    <label class="relative flex items-center p-6 border-3 rounded-2xl cursor-pointer transition-all hover:shadow-xl {{ old('type', $product->type) === 'service' ? 'border-purple-500 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/40 dark:to-purple-800/40 shadow-lg' : 'border-gray-300 dark:border-gray-600 dark:border-gray-600 hover:border-purple-300 dark:hover:border-purple-700' }}">
                        ...
                        @if(old('type', $product->type) === 'service')
                        <div class="absolute top-4 right-4">
