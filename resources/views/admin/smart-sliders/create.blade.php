...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {{-- Header --}}
        <div class="mb-8">
            <a href="{{ route('admin.smart-sliders.index') }}" class="inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white mb-4 transition-colors">
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400 dark:text-gray-400">เริ่มต้นจากเทมเพลตหรือสร้างใหม่เลยก็ได้</p>
        </div>
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between max-w-2xl mx-auto">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="font-semibold" :class="step >= 2 ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400'">ตั้งค่าพื้นฐาน</span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <label class="relative cursor-pointer group">
                            ...
                            <div class="border-2 rounded-xl p-6 transition-all duration-300"
                                 :class="selectedTemplate === '' ? 'border-blue-600 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 dark:border-gray-600 dark:border-slate-600 hover:border-blue-400'">
                                <div class="aspect-video bg-gradient-to-br from-gray-200 to-gray-300 dark:from-slate-700 dark:to-slate-600 rounded-xl mb-4 flex items-center justify-center">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">สร้าง Slider จากศูนย์</p>
                                @if($selectedTemplate === '')
                        ...
                        <label class="relative cursor-pointer group">
                            ...
                            <div class="border-2 rounded-xl p-6 transition-all duration-300"
                                 :class="selectedTemplate === '{{ $template->id }}' ? 'border-blue-600 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-300 dark:border-gray-600 dark:border-slate-600 hover:border-blue-400'">
                                <div class="aspect-video bg-gray-200 dark:bg-gray-700 dark:bg-slate-700 rounded-xl mb-4 overflow-hidden">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">{{ $template->description }}</p>
                ...
                <div class="glass-fusion dark:bg-slate-800 rounded-2xl shadow-lg p-8" border border-white/20 dark:border-white/10>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="name" required x-model="formData.name"
                                   class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-white transition-all"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400">
                                ใช้เรียก Slider: <code class="px-2 py-1 bg-gray-100/50 dark:bg-gray-800/50 dark:bg-slate-700 rounded">&lt;x-smart-slider slider="homepage-hero" /&gt;</code>
                            </p>
                        </div>
                    ...
                    <div class="mt-8 flex items-center justify-between">
                        <button type="button" @click="step = 1"
                                class="px-6 py-3 bg-gray-200 dark:bg-gray-700 dark:bg-slate-700 hover:bg-gray-300 dark:hover:bg-slate-600 text-gray-700 dark:text-gray-300 dark:text-gray-300 font-semibold rounded-xl transition-colors">
