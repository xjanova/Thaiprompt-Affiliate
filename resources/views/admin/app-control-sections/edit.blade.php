...
<div x-data="{ activeTab: 'basic' }" class="container-fluid px-4 py-6">
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.app-control-sections.update', $appControlSection) }}" class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 overflow-hidden p-8">
        @method('PUT')
        @csrf
