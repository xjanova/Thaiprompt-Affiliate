...
<div id="connectionTestModal" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden items-center justify-center p-4">
    <div class="glass-fusion rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden transform transition-all" border border-white/20 dark:border-white/10>
        ...
        <div class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 px-6 py-4 flex justify-end">
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                    ...
                    <div id="usersTableContent" class="hidden">
                        <div class="max-h-96 overflow-y-auto">
                            <table class="w-full">
                                <thead class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 sticky top-0">
                                    <tr>
...
function renderUsersTable(users) {
    ...
    users.forEach(user => {
        ...
        tr.className = 'hover:bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50';
        tr.innerHTML = `
            <td class="px-4 py-3">
                <div class="flex items-center">
