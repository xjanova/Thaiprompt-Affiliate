    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 mb-8">
            <div class="flex items-center gap-4">
                ...
                <select id="member-selector" class="flex-1 px-4 py-3 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="p-6 bg-purple-50 dark:bg-purple-900/20 rounded-xl border border-purple-200 dark:border-purple-800">
                    ...
                    <h3 class="font-bold text-gray-800 dark:text-white mb-2">เลื่อนดูผัง</h3>
                ...
                <div class="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
                    ...
                    <h3 class="font-bold text-gray-800 dark:text-white mb-2">ซูมเข้า-ออก</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div class="p-6 bg-green-50 dark:bg-green-900/20 rounded-xl border border-green-200 dark:border-green-800">
                    ...
                    <h3 class="font-bold text-gray-800 dark:text-white mb-2">คลิกดูรายละเอียด</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div class="p-6 bg-pink-50 dark:bg-pink-900/20 rounded-xl border border-pink-200 dark:border-pink-800">
                    ...
                    <h3 class="font-bold text-gray-800 dark:text-white mb-2">ค้นหาสมาชิก</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div class="p-6 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl border border-yellow-200 dark:border-yellow-800">
                    ...
                    <h3 class="font-bold text-gray-800 dark:text-white mb-2">สลับประเภท</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <div class="p-6 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl border border-indigo-200 dark:border-indigo-800">
                    ...
                    <h3 class="font-bold text-gray-800 dark:text-white mb-2">ดูสถิติ</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
