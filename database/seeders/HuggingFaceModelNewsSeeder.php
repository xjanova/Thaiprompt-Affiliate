    ...
    public function run(): void
    {
        ...
        $news = [
            ...
            [
                ...
                'news_type' => 'trending',
                'importance' => 'critical',
                'tags' => ['flux', 'image-generation', 'breaking-news', 'trending', 'black-forest-labs'],
                'categories' => ['Image Generation', 'Trending'],
                'is_published' => true,
                'is_featured' => true,
                'is_pinned' => true,
                'featured_image_url' => 'https://huggingface.co/datasets/huggingface/brand-assets/resolve/main/hf-logo.png',
            ...
            [
                ...
                'news_type' => 'new_model',
                'importance' => 'critical',
                'tags' => ['llama', 'meta', 'llm', 'open-source', 'multilingual'],
                'categories' => ['Language Models', 'New Release'],
                'is_published' => true,
                'is_featured' => true,
                'is_pinned' => false,
            ...
            [
                ...
                'news_type' => 'tutorial',
                'importance' => 'high',
                'tags' => ['whisper', 'speech-to-text', 'thai-language', 'tutorial', 'best-practices'],
                'categories' => ['Audio Processing', 'Tutorials'],
                'is_published' => true,
                'is_featured' => true,
                'is_pinned' => false,
            ...
            [
                ...
                'news_type' => 'tutorial',
                'importance' => 'high',
                'tags' => ['mixtral', 'deployment', 'cloud-gpu', 'tutorial', 'cost-effective'],
                'categories' => ['Language Models', 'Tutorials', 'Deployment'],
                'is_published' => true,
                'is_featured' => false,
                'is_pinned' => false,
            ...
            [
                ...
                'importance' => 'high',
                'tags' => ['stable-diffusion', 'image-generation', 'stability-ai', 'new-release'],
                'categories' => ['Image Generation', 'Updates'],
                'is_published' => true,
                'is_featured' => true,
                'is_pinned' => false,
