...
class CelticCrossService
{
        ...
        if ($bmForced) {
            ...
            $groups = [
                ...
                [
                    ...
                    'len' => $cardsOnly ? '550-850' : '700-1050',
                    ...
                    'spec' => $cardsOnly
                        ...
                        : "เขียน 3 ส่วนนี้ (ขึ้นหัวข้อด้วย emoji ตามนี้เป๊ะ เว้นบรรทัดให้อ่านง่าย • พาดหัวเรื่องเด่นทำไปแล้วในส่วนแรก ไม่ต้องทำซ้ำ):\n"
            ...
            $baseChartDirective =
                ...
                .($bcCardsOnly
                    ...
                    : "  1) 🌟 พื้นฐานดวงจากดวงดาว — ราศี/ปีนักษัตร/ธาตุ + ดาวเจ้าชนะ/ดาวมิตร/ดาวศัตรู + นิสัยพื้นฐาน (จุดแข็ง-จุดอ่อน)\n"
                        ...
                        ."  3) 🕛 ลัคนา & เรือนชะตา — ลัคนาราศีอะไร (ภาพที่คนอื่นเห็น vs ตัวจริง) + ดาวเด่นตกภพไหน (สนามชีวิตที่หนักสุด) + จังหวะเวลาจากเรือนชะตา\n"
                        ."     (ไม่รู้เวลาเกิด = ผังคำนวณจากเวลามาตรฐาน 12:00 น. ให้แล้ว → อ่านได้ตามปกติ ❌ ห้ามข้าม ❌ ห้ามออกตัว)\n"
    ...
    protected function buildBirthAstrologyBlockFor(
        ...
        try {
            ...
            return (string) $astro->buildCelticBirthAstrologyBlock($source, $confirmedHour);
        } catch (\Throwable $e) {
