...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-md p-6">
        <h2 class="text-2xl font-bold text-gray-900 mb-6">แก้ไขผู้ใช้</h2>
        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                @if($user->is_super_admin)
                    ...
                    <p class="mt-2 text-sm text-yellow-700 bg-yellow-50 border-l-4 border-yellow-400 p-3 rounded">
            ...
            <div class="border-t pt-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">เปลี่ยนรหัสผ่าน (ถ้าต้องการ)</h3>
        ...
        <div class="mt-8 pt-6 border-t border-red-200">
            ...
            <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                <div class="flex items-start justify-between">
                    <div>
                        <h4 class="font-medium text-red-900">ลบผู้ใช้</h4>
