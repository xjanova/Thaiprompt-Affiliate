...
<div class="container-fluid px-4 py-8">
    <div class="max-w-6xl mx-auto">
        <div class="mb-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 dark:text-gray-400">เอฟเฟกต์เรืองแสงสำหรับ Active States</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                <div class="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">{{ ucfirst($effect->target_element) }}</p>
                    </div>
                ...
                <div class="space-y-2 text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">
                ...
                <div class="flex gap-2 mt-4">
                    <form action="{{ route('admin.arrow-x-theme.rgb-effects.destroy', $effect) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="px-4 py-2 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 rounded-xl text-sm" onclick="return confirm('ยืนยันการลบ?')">
            ...
            @empty
            <div class="col-span-2 text-center py-12 text-gray-500 dark:text-gray-400 dark:text-gray-400">
