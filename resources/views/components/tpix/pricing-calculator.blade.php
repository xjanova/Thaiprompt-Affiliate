...
<div x-data="pricingCalculator({{ json_encode($pricing) }})" class="space-y-4">
    ...
    {{-- Payment Info --}}
    <div class="p-4 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border-l-4 border-blue-500 rounded-r-xl">
            ...
            <div class="text-sm text-blue-900 dark:text-blue-100">
                ...
                <ul class="space-y-1 text-blue-800 dark:text-blue-200">
                    <li class="flex items-center gap-2">
                        ...
                        <span><strong>ชำระด้วย TPIX เท่านั้น</strong> ผ่าน Web3 Wallet</span>
                    </li>
                    <li class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                        </svg>
                        <span>ค่า Gas Fee แยกจากค่าบริการ</span>
                    </li>
                    <li class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                        </svg>
                        <span>คืนเงิน 80% หาก Deploy ล้มเหลว</span>
                    </li>
                    <li class="flex items-center gap-2 mt-2 pt-2 border-t border-blue-200 dark:border-blue-700">
                        <svg class="w-4 h-4 text-yellow-600" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                        </svg>
                        <span class="text-yellow-800 dark:text-yellow-200"><strong>หาก TPIX ไม่พอ</strong> → ไป <a href="{{ config('tpix.dex_url', '#') }}/swap" target="_blank" class="underline font-semibold hover:text-yellow-900">Swap ที่ DEX</a></span>
                    </li>
                </ul>
            </div>
        </div>
