...
<div class="max-w-4xl mx-auto px-4 py-6">
    ...
    <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-md p-6 mb-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.mlm.product-pv.index') }}"
               class="px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 dark:text-gray-300 rounded-xl transition-all duration-200">
                ← กลับ
            </a>
        </div>
    </div>
    ...
    <div class="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-xl p-6 text-center">
        ...
        <a href="{{ route('admin.mlm.product-pv.index') }}"
           class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-xl transition-all duration-200 gap-2">
            กลับไปหน้ารายการ
        </a>
    </div>
    ...
    <form action="{{ route('admin.mlm.product-pv.store') }}" method="POST">
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-md p-6 space-y-6" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">เลือกสินค้าที่ต้องการกำหนด PV</p>
                        @error('product_id')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="pv_value" id="pv-value-input"
                               ...
                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl focus:ring-2 focus:ring-purple-500"
                               required>
                        <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">กำหนดค่า Point Value สำหรับสินค้านี้</p>
                    ...
                    <div id="product-price-display" class="hidden">
                        ...
                        <div class="p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/30 dark:to-pink-900/30 rounded-xl border border-purple-100 dark:border-purple-800">
                            <div class="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-1">
                ...
                <div class="mt-4">
                    ...
                    <div class="flex gap-2 flex-wrap">
                        <button type="button" onclick="setPvByPercentage(100)"
                                class="px-3 py-2 bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:hover:bg-blue-800/30 text-blue-700 dark:text-blue-300 rounded-xl text-sm transition-colors">
                            100% ของราคา
                        </button>
                        <button type="button" onclick="setPvByPercentage(80)"
                                class="px-3 py-2 bg-green-100 hover:bg-green-200 dark:bg-green-900/30 dark:hover:bg-green-800/30 text-green-700 dark:text-green-300 rounded-xl text-sm transition-colors">
                            80% ของราคา
                        </button>
                        <button type="button" onclick="setPvByPercentage(50)"
                                class="px-3 py-2 bg-yellow-100 hover:bg-yellow-200 dark:bg-yellow-900/30 dark:hover:bg-yellow-800/30 text-yellow-700 dark:text-yellow-300 rounded-xl text-sm transition-colors">
                            50% ของราคา
                        </button>
                        <button type="button" onclick="setPvByPercentage(30)"
                                class="px-3 py-2 bg-purple-100 hover:bg-purple-200 dark:bg-purple-900/30 dark:hover:bg-purple-800/30 text-purple-700 dark:text-purple-300 rounded-xl text-sm transition-colors">
                            30% ของราคา
                        </button>
                    </div>
                </div>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 dark:border-gray-700 pt-6">
                ...
                <div class="mb-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="use_global_rate" id="use-global-rate"
                               ...
                               class="w-4 h-4 text-purple-600 border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded focus:ring-purple-500">
                ...
                <div id="custom-rate-section" class="hidden">
                    ...
                    <input type="number" name="custom_commission_per_pv" id="custom-commission-input"
                           ...
                           min="0" step="0.01"
                           class="w-full md:w-1/2 px-4 py-2 border border-gray-300 dark:border-gray-600 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-xl focus:ring-2 focus:ring-purple-500">
                    <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">กำหนดอัตราค่าคอมมิชชั่นต่อ PV เฉพาะสำหรับสินค้านี้</p>
                ...
                <!-- Commission Preview -->
                <div id="commission-preview" class="mt-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 rounded-xl border border-green-100 dark:border-green-800 hidden">
                    <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">ตัวอย่างค่าคอมมิชชั่น</h4>
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            <span class="text-gray-600 dark:text-gray-400 dark:text-gray-400">PV ทั้งหมด:</span>
                            <span id="preview-pv" class="ml-2 font-semibold text-blue-600 dark:text-blue-400">-</span>
                        </div>
                        <div>
                            <span class="text-gray-600 dark:text-gray-400 dark:text-gray-400">ค่าคอมมิชชั่น:</span>
                ...
                <div class="space-y-3">
                    <label class="flex items-start">
                        <input type="checkbox" name="show_pv_on_product_page"
                               ...
                               class="w-4 h-4 mt-1 text-purple-600 border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded focus:ring-purple-500">
                        <div class="ml-2">
                            <span class="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300 font-medium">แสดง PV ในหน้าสินค้า</span>
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">แสดงค่า PV ให้ลูกค้าเห็นในหน้ารายละเอียดสินค้า</p>
                        </div>
                    </label>
                    ...
                    <label class="flex items-start">
                        <input type="checkbox" name="show_commission_preview"
                               ...
                               class="w-4 h-4 mt-1 text-purple-600 border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded focus:ring-purple-500">
                        <div class="ml-2">
                            <span class="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300 font-medium">แสดงตัวอย่างค่าคอมมิชชั่น</span>
                            <p class="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-1">แสดงตัวอย่างค่าคอมมิชชั่นที่จะได้รับในหน้าสินค้า</p>
                        </div>
                    </label>
                </div>
            </div>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 dark:border-gray-700 pt-6">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white dark:text-white mb-4 flex items-center gap-2">
                    <i class="fas fa-file-alt text-gray-600 dark:text-gray-400 dark:text-gray-400"></i>
                    คำอธิบาย (ไม่บังคับ)
                </h3>
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 dark:border-gray-700 pt-6">
                <div class="flex items-center justify-end gap-3">
                    <a href="{{ route('admin.mlm.product-pv.index') }}"
                       class="px-6 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 dark:text-gray-300 rounded-xl transition-all duration-200">
                        ยกเลิก
                    </a>
                    <button type="submit"
                            class="px-6 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-xl shadow-lg transition-all duration-200 flex items-center gap-2">
