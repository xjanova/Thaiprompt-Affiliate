                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-6 rounded-2xl border-2 border-indigo-100">
                        ...
                        @if(isset($cashbackInfo) && $cashbackInfo['cashback'] > 0)
                            <div class="mt-4 flex items-center gap-2 text-amber-700 font-bold bg-gradient-to-r from-amber-50 to-orange-50 px-4 py-3 rounded-xl border-2 border-amber-300 shadow-md">
                                ...
                                <div>
                                    <div class="text-lg">รับ Cashback คืน
                                        <span class="text-xl">฿{{ number_format($cashbackInfo['cashback'], 2) }}</span>
                                    </div>
                                    @if($cashbackInfo['setting'])
                                        <div class="text-xs text-amber-600 mt-0.5">
                                            ...
                                            @if($cashbackInfo['type'] === 'product')
                                                <span class="inline-flex items-center px-2 py-0.5 bg-amber-200 text-amber-800 rounded text-xs ml-1">
                                                    โปรโมชันพิเศษ
                                                </span>
                                            @endif
                                        </div>
