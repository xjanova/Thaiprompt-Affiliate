...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="glass-fusion dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 dark:border-slate-700 overflow-hidden mb-8" border border-white/20 dark:border-white/10>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                <thead class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:bg-slate-900">
                    <tr>
                        <th data-translate scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-400 dark:text-gray-300 uppercase tracking-wider">วันที่</th>
                        <th data-translate scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-400 dark:text-gray-300 uppercase tracking-wider">ผู้ใช้ที่ใช้งาน</th>
                        <th data-translate scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-400 dark:text-gray-300 uppercase tracking-wider">ผู้ใช้ใหม่</th>
                        <th data-translate scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-400 dark:text-gray-300 uppercase tracking-wider">การโต้ตอบ</th>
                        <th data-translate scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-400 dark:text-gray-300 uppercase tracking-wider">ระยะเวลาเฉลี่ย</th>
                        <th data-translate scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-600 dark:text-gray-400 dark:text-gray-300 uppercase tracking-wider">อัตราการมีส่วนร่วม</th>
                    </tr>
                </thead>
                <tbody class="glass-fusion dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700">
                    ...
                    <tr class="hover:bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:hover:bg-slate-700/50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">{{ $data->active_users ?? '0' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">{{ $data->new_users ?? '0' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">{{ $data->interactions ?? '0' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">{{ $data->avg_duration ?? '0' }} นาที</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">{{ $data->engagement_rate ?? '0' }}%</td>
                    </tr>
                    @empty
                    <tr>
