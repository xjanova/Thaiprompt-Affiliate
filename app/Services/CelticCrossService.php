...
class CelticCrossService
{
    ...
    protected function buildGrandFinalePrompt(
        ...
        return $localeDirective
            ...
            ."      บล็อก \"ภาพรวมสำรับ\" / \"ไพ่คู่-ไพ่สัมพันธ์\" / \"ธาตุเสริม-ขัด\" / \"ความสัมพันธ์ตำแหน่ง\" / \"น้ำหนัก Yes-No\"\n"
            ."      = *เครื่องมือคิดในใจเท่านั้น* ใช้หาคำตอบ แล้วพูดออกมาเฉพาะ \"ข้อสรุป\" ❌ ห้ามพูดถึงตัวเครื่องมือ\n"
            ...
            .$questionChecklist
            ."   ❗ รายการที่ไม่ใช่คำถามจริง (\"พร้อม\" / \"ขอบคุณ\" / \"ค่ะ\" / คำตอบรับ) → ข้ามได้ ไม่ต้องนับเป็นย่อหน้า\n"
            ."━━━━━━━━━━━━━━━━━\n\n"
            ...
            ."   ✅ ถ้าเช็คลิสต์เกิน 6 ข้อ → รวบข้อที่เป็นเรื่องเดียวกันเข้าย่อหน้าเดียว (สูงสุด 6 ย่อหน้า)\n"
            ."      แต่ *ต้องมีคำตอบครบทุกข้อ* ในเนื้อย่อหน้านั้น ห้ามทิ้งข้อใดข้อหนึ่งเงียบๆ\n"
