...
<div class="container-fluid px-4 py-6">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Create New Page</h1>
    </div>
    ...
    <div class="max-w-4xl">
        <form action="{{ route('admin.page-builder.store') }}" method="POST" class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-6">Page Information</h2>
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-6 mt-6">
                    <h3 class="text-lg font-medium text-gray-800 dark:text-white mb-4">SEO Settings (Optional)</h3>
            ...
            <div class="flex items-center justify-end space-x-4">
                ...
                <button type="submit"
                        class="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:shadow-lg transition-all duration-300">
