...
<div class="space-y-6 pb-20 lg:pb-6">
    {{-- Premium Hero Header (Emerald-Green-Teal for Distributions) --}}
    <div class="relative overflow-hidden bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 dark:from-emerald-800 dark:via-green-800 dark:to-teal-800 rounded-2xl shadow-2xl p-8">
        ...
        <div class="relative z-10">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-3xl md:text-4xl font-bold text-white drop-shadow-lg">การจ่ายผลตอบแทน</h1>
    ...
    @if(isset($position))
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center py-2 border-b">
                            ...
                            <span class="font-bold text-gray-800 dark:text-white">{{ $position->plan->name ?? 'N/A' }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b">
                            <span class="text-gray-600 dark:text-gray-400">จำนวนลงทุน:</span>
                            <span class="font-bold text-blue-600">฿{{ number_format($position->amount ?? 0, 2) }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b">
                            <span class="text-gray-600 dark:text-gray-400">อัตราผลตอบแทน:</span>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200">
                            <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">รวมรับแล้ว</div>
                            <div class="text-3xl font-bold text-green-600">
                                ฿{{ number_format($distributions->sum('amount') ?? 0, 2) }}
                            </div>
                        </div>
                        <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-200">
                            <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">จำนวนครั้ง</div>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    ...
                                    <p class="text-gray-600 dark:text-gray-400">ยังไม่มีการจ่ายผลตอบแทน</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        <div class="text-center">
            <a href="{{ route('user.investments.show', $position->id) }}"
               class="inline-block px-8 py-4 bg-gray-200 hover:bg-gray-300 text-gray-700 dark:text-gray-300 rounded-xl font-bold transition-colors">
