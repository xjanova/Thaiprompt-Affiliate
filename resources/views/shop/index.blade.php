...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/30 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
                ...
                <div class="max-w-2xl mx-auto">
                    <form method="GET" action="{{ route('shop.index') }}" class="relative">
                        <input type="text"
                               ...
                               class="w-full px-6 py-4 pr-14 rounded-2xl text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700 font-medium shadow-2xl focus:outline-none focus:ring-4 focus:ring-white/50 dark:focus:ring-gray-600 transition-all placeholder-gray-400 dark:placeholder-gray-500">
                        <button type="submit"
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
                    @foreach($categories->take(12) as $category)
                        <a href="{{ route('shop.category', $category->slug) }}"
                           class="group flex flex-col items-center gap-3 p-4 rounded-xl bg-gradient-to-br from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 hover:from-indigo-50 hover:to-purple-50 dark:hover:from-indigo-900/50 dark:hover:to-purple-900/50 border-2 border-gray-100 dark:border-gray-600 hover:border-indigo-300 dark:hover:border-indigo-600 transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                            <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-800 dark:to-purple-800 flex items-center justify-center text-2xl group-hover:scale-110 transition-transform">
                                📦
                            </div>
                            <span class="text-sm font-semibold text-gray-700 dark:text-gray-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 text-center transition-colors">
                                {{ $category->name }}
                            </span>
                        </a>
                    @endforeach
        ...
        <div class="flex flex-col lg:flex-row gap-6">
            ...
            <aside class="lg:w-80 flex-shrink-0">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden sticky top-4">
                    <!-- Filters Header -->
                    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-700 dark:to-purple-700 text-white px-6 py-4">
                    ...
                    <form method="GET" action="{{ route('shop.index') }}" id="filterForm" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/50 transition-all placeholder-gray-400 dark:placeholder-gray-500">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="space-y-2 max-h-64 overflow-y-auto pr-2 custom-scrollbar">
                                ...
                                <label class="flex items-center gap-3 cursor-pointer hover:bg-indigo-50 dark:hover:bg-indigo-900/30 p-3 rounded-xl transition-all group">
                                    <input type="radio"
                                           name="category"
                                           value="{{ $category->slug }}"
                                           {{ request('category') === $category->slug ? 'checked' : '' }}
                                           onchange="document.getElementById('filterForm').submit()"
                                           class="w-5 h-5 text-indigo-600 dark:text-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 flex-1">
                                        {{ $category->name }}
                                    </span>
                                </label>
                                @endforeach
                        ...
                        <div>
                            ...
                            <select name="brand"
                                    onchange="document.getElementById('filterForm').submit()"
                                    class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/50 transition-all font-medium">
                        ...
                        <!-- Filter Buttons -->
                        <div class="flex flex-col gap-3 pt-4 border-t-2 border-gray-100 dark:border-gray-700">
                            <button type="submit"
                                    class="w-full px-6 py-3.5 bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-700 dark:to-purple-700 hover:from-indigo-700 hover:to-purple-700 dark:hover:from-indigo-600 dark:hover:to-purple-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105 flex items-center justify-center gap-2">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"/>
                                </svg>
                                ค้นหาด้วยตัวกรอง
                            ...
                            <a href="{{ route('shop.index') }}"
                               class="w-full px-6 py-3 border-2 border-gray-300 dark:border-gray-600 hover:border-red-500 dark:hover:border-red-500 text-gray-700 dark:text-gray-300 hover:text-red-500 dark:hover:text-red-400 font-bold rounded-xl transition-all flex items-center justify-center gap-2 bg-white dark:bg-gray-700 hover:bg-red-50 dark:hover:bg-red-900/20">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="flex-1 min-w-0">
                ...
                <div class="mb-8">
                    <div class="bg-gradient-to-r from-amber-50 via-yellow-50 to-orange-50 dark:from-amber-900/20 dark:via-yellow-900/20 dark:to-orange-900/20 rounded-2xl shadow-lg p-6 border-2 border-amber-200 dark:border-amber-700">
                        <div class="flex items-center justify-between mb-6">
                            <h2 class="text-2xl font-black text-gray-900 dark:text-gray-100 flex items-center gap-3">
                                <div class="w-10 h-10 bg-gradient-to-br from-amber-400 to-orange-500 dark:from-amber-600 dark:to-orange-700 rounded-xl flex items-center justify-center">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-6 border border-gray-100 dark:border-gray-700">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div class="flex items-center gap-3">
                            <div class="w-12 h-12 bg-gradient-to-br from-indigo-100 to-purple-100 dark:from-indigo-800 dark:to-purple-800 rounded-xl flex items-center justify-center">
                                <span class="text-xl font-black text-indigo-600 dark:text-indigo-400">{{ $products->total() }}</span>
                            </div>
                            <div>
                                <div class="text-gray-900 dark:text-gray-100 font-bold">
                                    พบ <span class="text-indigo-600 dark:text-indigo-400">{{ number_format($products->total()) }}</span> สินค้า
                                </div>
                        ...
                        <form method="GET" action="{{ route('shop.index') }}" class="flex items-center gap-3">
                            ...
                            <label class="text-sm font-bold text-gray-700 dark:text-gray-300 whitespace-nowrap flex items-center gap-2">
                                <svg class="w-4 h-4 text-indigo-600 dark:text-indigo-400" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <select name="sort_by"
                                    ...
                                    class="px-4 py-2.5 border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-4 focus:ring-indigo-100 dark:focus:ring-indigo-900/50 font-semibold transition-all">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-12 text-center border border-gray-100 dark:border-gray-700">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3">ไม่พบสินค้าที่คุณค้นหา</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                        ลองปรับเปลี่ยนเงื่อนไขการค้นหา หรือลองค้นหาด้วยคำค้นอื่น
                    </p>
                    <a href="{{ route('shop.index') }}"
                       class="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-700 dark:to-purple-700 hover:from-indigo-700 hover:to-purple-700 dark:hover:from-indigo-600 dark:hover:to-purple-600 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
