...
|--------------------------------------------------------------------------
|
| กฎสำหรับ Seller Routes:
| 1. สมาชิกต้องผ่าน KYC ก่อนถึงจะเปิดร้านได้
| 2. ต้องมี store และ package ก่อนถึงจะใช้งานฟีเจอร์อื่นๆ ได้
| 3. Onboarding routes ไม่ต้องใช้ middleware เพราะเป็นหน้าแรกที่ต้องเข้ามา
|
*/

// ========================================
// SELLER ONBOARDING (ไม่ต้อง KYC - เป็นหน้าที่ต้องทำ KYC)
// ขั้นตอนการเริ่มต้นใช้งานสำหรับ Seller ใหม่
// ========================================
Route::prefix('onboarding')->name('onboarding.')->group(function () {
    Route::get('/', [OnboardingController::class, 'index'])->name('index');
    Route::post('/create-store', [OnboardingController::class, 'createStore'])->name('create-store');
    Route::post('/change-package', [OnboardingController::class, 'changePackage'])->name('change-package');
    Route::post('/skip-package', [OnboardingController::class, 'skipPackage'])->name('skip-package');
});

// ========================================
// ROUTES ที่ต้อง KYC และมี STORE แล้ว
// ========================================
Route::middleware(['kyc.verified', 'has.vendor.store'])->group(function () {
