...
<div class="space-y-6" x-data="{ language: 'th' }">
        ...
        <div class="relative z-10">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-white/90 text-lg" data-translate>สร้างใบแจ้งหนี้/ใบกำกับภาษีใหม่</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-6xl mx-auto">
        <form action="{{ route('admin.accounting.invoices.store') }}" method="POST" id="invoice-form"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="document_type" required
                                    class="w-full pl-10 pr-4 py-3 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400 focus:border-emerald-500 transition-all appearance-none">
                                <option value="invoice" data-translate>ใบแจ้งหนี้</option>
                                <option value="tax_invoice" data-translate>ใบกำกับภาษี</option>
                                <option value="receipt" data-translate>ใบเสร็จรับเงิน</option>
                                <option value="quotation" data-translate>ใบเสนอราคา</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="px-6 pb-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="note" rows="3"
                              class="w-full px-4 py-3 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400 focus:border-emerald-500 transition-all">{{ old('note') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="terms" rows="2"
                              class="w-full px-4 py-3 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400 focus:border-emerald-500 transition-all">{{ old('terms') }}</textarea>
                </div>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-900 px-6 py-6 flex justify-end gap-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <button type="submit"
                        class="group px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2">
