...
class FortuneConversationService
{
    ...
    {
        $name = $userProfile['name'] ?? 'ท่าน';
        $gender = isset($userProfile['gender']) ? ($userProfile['gender'] === 'male' ? 'ชาย' : 'หญิง') : '';

        return "คุณเป็นหมอดูชื่อดัง ทำนายแบบสั้นกระชับแต่ฟันธง ไม่เกิน 200 คำ
...
ทำนายแบบกระชับ ให้ข้อมูลสำคัญ ตอบเป็นภาษาไทย
ท้ายคำทำนายให้บอกว่า 'หากต้องการรู้ละเอียดกว่านี้ สามารถบอกวันเดือนปีเกิดและถามคำถามเพิ่มได้ค่ะ'";
    }
    ...
    protected function buildDeepPrompt(?array $userProfile, array $questions, ?string $birthDate): string
    {
        ...
        return "คุณเป็นหมอดูชื่อดังระดับประเทศ ประสบการณ์กว่า 30 ปี เชี่ยวชาญโหราศาสตร์ไทย โหราศาสตร์สากล ไพ่ทาโรต์ เลขศาสตร์
...
กรุณาทำนายอย่างละเอียด:
1. วิเคราะห์ดวงชะตาจากวันเกิด (ถ้ามี) - ราศี ลัคนา ธาตุ ดาวเคราะห์
2. ตอบแต่ละคำถามอย่างละเอียด ฟันธง ระบุช่วงเวลาชัดเจน
3. ให้คำแนะนำที่ปฏิบัติได้จริง
4. บอกสิ่งที่ควรระวังและโอกาสที่จะเกิดขึ้น

ตอบเป็นภาษาไทย อย่างละเอียดและเป็นกันเอง";
    }
}
