...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <!-- Form -->
    <form action="{{ route('admin.email.templates.update', $template) }}" method="POST" class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" value="{{ $template->name }}" disabled
                       class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white bg-gray-100 cursor-not-allowed">
                <p class="mt-1 text-xs text-gray-500">ไม่สามารถแก้ไขชื่อได้</p>
            </div>
            ...
            <div>
                ...
                <select name="category" class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white" required>
        ...
        <div class="flex items-center">
            <label class="flex items-center cursor-pointer">
                <input type="checkbox" name="is_active" value="1" {{ $template->is_active ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
        ...
        <div>
            ...
            <input type="text" name="subject" value="{{ old('subject', $template->subject) }}"
                   class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white @error('subject') border-red-500 @enderror"
                   required>
            @error('subject')
        ...
        <div>
            ...
            <textarea name="body_html" rows="15"
                      class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white font-mono text-sm @error('body_html') border-red-500 @enderror"
        ...
        <div>
            ...
            <textarea name="body_text" rows="8"
                      class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white font-mono text-sm">{{ old('body_text', $template->body_text) }}</textarea>
        </div>
        ...
        <div>
            ...
            <textarea name="description" rows="3"
                      class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">{{ old('description', $template->description) }}</textarea>
        </div>
