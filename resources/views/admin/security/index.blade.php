...
<div x-data="{ activeTab: 'dashboard' }" class="space-y-6">
    ...
    <!-- Tab Navigation -->
    <div class="glass-fusion rounded-xl shadow-md" border border-white/20 dark:border-white/10>
        <div class="border-b border-gray-200 dark:border-gray-700">
            <nav class="flex -mb-px">
                <button @click="activeTab = 'dashboard'"
                        :class="{ 'border-indigo-500 text-indigo-600': activeTab === 'dashboard', 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600': activeTab !== 'dashboard' }"
                ...
                <button @click="activeTab = 'turnstile'"
                        :class="{ 'border-indigo-500 text-indigo-600': activeTab === 'turnstile', 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600': activeTab !== 'turnstile' }"
                        class="px-6 py-4 text-sm font-medium border-b-2 transition-colors duration-200">
                    <span class="flex items-center">
                        <span class="text-lg mr-2">🤖</span>
                ...
                <button @click="activeTab = 'ratelimit'"
                        :class="{ 'border-indigo-500 text-indigo-600': activeTab === 'ratelimit', 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600': activeTab !== 'ratelimit' }"
                        class="px-6 py-4 text-sm font-medium border-b-2 transition-colors duration-200">
                    <span class="flex items-center">
                ...
                <button @click="activeTab = 'autoban'"
                        :class="{ 'border-indigo-500 text-indigo-600': activeTab === 'autoban', 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600': activeTab !== 'autoban' }"
                        class="px-6 py-4 text-sm font-medium border-b-2 transition-colors duration-200">
                    <span class="flex items-center">
                        <span class="text-lg mr-2">🚨</span>
                        Auto-Ban
                ...
                <button @click="activeTab = 'ipmanagement'"
                        :class="{ 'border-indigo-500 text-indigo-600': activeTab === 'ipmanagement', 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600': activeTab !== 'ipmanagement' }"
                        class="px-6 py-4 text-sm font-medium border-b-2 transition-colors duration-200">
                    <span class="flex items-center">
                        <span class="text-lg mr-2">🚫</span>
                        IP Blocking
                ...
                <button @click="activeTab = 'logs'"
                        :class="{ 'border-indigo-500 text-indigo-600': activeTab === 'logs', 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600': activeTab !== 'logs' }"
                        class="px-6 py-4 text-sm font-medium border-b-2 transition-colors duration-200">
                    <span class="flex items-center">
                        <span class="text-lg mr-2">📝</span>
                        Security Logs
                ...
                <button @click="activeTab = 'threat'"
                        :class="{ 'border-indigo-500 text-indigo-600': activeTab === 'threat', 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:border-gray-600': activeTab !== 'threat' }"
                        class="px-6 py-4 text-sm font-medium border-b-2 transition-colors duration-200">
                    <span class="flex items-center">
                        <span class="text-lg mr-2">🌍</span>
                        Threat Intelligence
        ...
        <div class="p-6">
            ...
            <div x-show="activeTab === 'dashboard'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                <div class="space-y-6">
                    ...
                    <!-- Recent Blocked IPs -->
                    <div class="glass-fusion rounded-xl border border-gray-200 dark:border-gray-700 p-6" border border-white/20 dark:border-white/10>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">เหตุผล</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">วันที่บล็อก</th>
                                ...
                                <tbody class="glass-fusion divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{{ $blockedIp->reason ?? '-' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ $blockedIp->created_at->diffForHumans() }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($blockedIp->is_active)
                                            <span class="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Active</span>
                                            @else
                                            <span class="px-2 py-1 text-xs font-semibold rounded-full bg-gray-100/50 dark:bg-gray-800/50 text-gray-900 dark:text-white">Inactive</span>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
                        ...
                        @else
                        <p class="text-gray-500 dark:text-gray-400 text-center py-8">ไม่มี IP ที่ถูกบล็อก</p>
                        @endif
                    </div>
                    ...
                    <div class="glass-fusion rounded-xl border border-gray-200 dark:border-gray-700 p-6" border border-white/20 dark:border-white/10>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">ความรุนแรง</th>
                                    </tr>
                                </thead>
                                <tbody class="glass-fusion divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-900">
                                            <span class="px-2 py-1 text-xs font-mono rounded bg-gray-100/50 dark:bg-gray-800/50">{{ $log->event_type }}</span>
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-900">
                                            @if($log->country_code)
                        ...
                        @else
                        <p class="text-gray-500 dark:text-gray-400 text-center py-8">ไม่มี Security Logs</p>
                        @endif
                    </div>
                </div>
            </div>
                ...
                <form method="POST" action="{{ route('admin.security.turnstile.update') }}">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="turnstile_enabled" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                        ...
                        <!-- Site Key -->
                        <div>
                            <label for="turnstile_site_key" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Site Key</label>
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Site Key ที่ได้จาก Cloudflare Dashboard</p>
                        </div>

                        <!-- Secret Key -->
                        <div>
                            <label for="turnstile_secret_key" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Secret Key</label>
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Secret Key ที่ได้จาก Cloudflare Dashboard</p>
                        </div>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="turnstile_bypass_admin" id="turnstile_bypass_admin"
                                   ...
                                   class="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
                            <label for="turnstile_bypass_admin" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                        ...
                        <!-- Theme -->
                        <div>
                            <label for="turnstile_theme" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">ธีม</label>
                        ...
                        <!-- Size -->
                        <div>
                            <label for="turnstile_size" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">ขนาด</label>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="checkbox" name="turnstile_login" id="turnstile_login"
                                           ...
                                           class="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
                                    <label for="turnstile_login" class="ml-2 text-sm text-gray-700 dark:text-gray-300">หน้า Login</label>
                                </div>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="turnstile_register" id="turnstile_register"
                                           ...
                                           class="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
                                    <label for="turnstile_register" class="ml-2 text-sm text-gray-700 dark:text-gray-300">หน้า Register</label>
                                </div>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="turnstile_password_change" id="turnstile_password_change"
                                           ...
                                           class="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
                                    <label for="turnstile_password_change" class="ml-2 text-sm text-gray-700 dark:text-gray-300">การเปลี่ยนรหัสผ่าน</label>
                                </div>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="turnstile_profile_update" id="turnstile_profile_update"
                                           ...
                                           class="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
                                    <label for="turnstile_profile_update" class="ml-2 text-sm text-gray-700 dark:text-gray-300">การแก้ไขโปรไฟล์</label>
                                </div>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="turnstile_withdrawal" id="turnstile_withdrawal"
                                           ...
                                           class="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
                                    <label for="turnstile_withdrawal" class="ml-2 text-sm text-gray-700 dark:text-gray-300">การถอนเงิน</label>
                                </div>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="turnstile_affiliate_app" id="turnstile_affiliate_app"
                                           ...
                                           class="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
                                    <label for="turnstile_affiliate_app" class="ml-2 text-sm text-gray-700 dark:text-gray-300">การสมัคร Affiliate</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="rate_limiting_enabled" id="rate_limiting_enabled"
                                   ...
                                   class="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
                            <label for="rate_limiting_enabled" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                        ...
                        <div class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 rounded-xl p-4">
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label for="rate_limit_login_max_attempts" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    ...
                                    <input type="number" name="rate_limit_login_max_attempts" id="rate_limit_login_max_attempts"
                                           ...
                                           min="1" max="50"
                                           class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">จำนวนครั้งที่อนุญาตให้พยายาม Login ล้มเหลวได้</p>
                                </div>

                                <div>
                                    <label for="rate_limit_login_decay_minutes" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    ...
                                    <input type="number" name="rate_limit_login_decay_minutes" id="rate_limit_login_decay_minutes"
                                           ...
                                           min="1" max="1440"
                                           class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">ระยะเวลาที่จะรีเซ็ตจำนวนครั้งที่พยายาม</p>
                                </div>

                                <div>
                                    <label for="rate_limit_login_lockout_minutes" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        เวลาล็อกบัญชี (นาที)
                                    </label>
                                    <input type="number" name="rate_limit_login_lockout_minutes" id="rate_limit_login_lockout_minutes"
                                           ...
                                           min="1" max="1440"
                                           class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">ระยะเวลาที่จะล็อกไม่ให้ Login ได้</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="auto_ban_enabled" id="auto_ban_enabled"
                                   ...
                                   class="w-4 h-4 text-indigo-600 border-gray-300 dark:border-gray-600 rounded focus:ring-indigo-500">
                            <label for="auto_ban_enabled" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                        ...
                        <div class="bg-gradient-to-br from-red-50 to-red-100 border border-red-200 rounded-xl p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    ...
                                    <label for="auto_ban_failed_login_enabled" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                        เปิดใช้งาน
                                    </label>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">จำนวนครั้ง (Threshold)</label>
                                        <input type="number" name="auto_ban_failed_login_threshold"
                                               ...
                                               min="1" max="100"
                                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-red-500">
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">ครั้ง</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">ช่วงเวลา (Time Window)</label>
                                        <input type="number" name="auto_ban_failed_login_time_window"
                                               ...
                                               min="1" max="1440"
                                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-red-500">
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">นาที</p>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">ระยะเวลาแบน (Ban Duration)</label>
                                        <input type="number" name="auto_ban_failed_login_ban_duration"
                                               ...
                                               min="1" max="10080"
                                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-red-500">
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">นาที ({{ round(config('autoban.failed_login.ban_duration') / 60, 1) }} ชม.)</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    ...
                                    <label for="auto_ban_turnstile_enabled" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                        เปิดใช้งาน
                                    </label>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">จำนวนครั้ง</label>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">ช่วงเวลา (นาที)</label>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">ระยะเวลาแบน (นาที)</label>
                                        <input type="number" name="auto_ban_turnstile_ban_duration"
                                               ...
                                               min="1" max="10080"
                                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500">
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ round(config('autoban.turnstile_failure.ban_duration') / 60, 1) }} ชม.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-xl p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    ...
                                    <label for="auto_ban_rate_limit_enabled" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                        เปิดใช้งาน
                                    </label>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input type="number" name="auto_ban_rate_limit_threshold"
                                               ...
                                               min="1" max="100"
                                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500">
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">ช่วงเวลา (นาที)</label>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="auto_ban_rate_limit_ban_duration"
                                               ...
                                               min="1" max="10080"
                                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-purple-500">
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ round(config('autoban.rate_limit.ban_duration') / 60, 1) }} ชม.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    ...
                                    <label for="auto_ban_notifications_enabled" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="auto_ban_email_enabled" id="auto_ban_email_enabled"
                                           ...
                                           class="w-4 h-4 text-green-600 border-gray-300 dark:border-gray-600 rounded focus:ring-green-500">
                                    <label for="auto_ban_email_enabled" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                                        ส่งอีเมล
                                    </label>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">อีเมลผู้รับ (คั่นด้วย comma)</label>
                                    <input type="text" name="auto_ban_email_recipients"
                                           ...
                                           class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500"
                                           placeholder="admin@example.com, security@example.com">
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">อีเมลที่จะได้รับการแจ้งเตือนเมื่อมี IP ถูก Auto-Ban</p>
                                </div>
                            </div>
                        </div>
            ...
            <div x-show="activeTab === 'ipmanagement'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                <div class="space-y-6" x-data="{ showAddModal: false }">
                    ...
                    <div x-show="showAddModal"
                         ...
                         style="display: none;">
                        <div class="glass-fusion rounded-xl shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto" border border-white/20 dark:border-white/10>
                            <div class="p-6">
                                <div class="flex justify-between items-center mb-6">
                                    <h3 class="text-xl font-semibold text-gray-900">เพิ่ม IP Address</h3>
                                    <button @click="showAddModal = false" class="text-gray-400 hover:text-gray-600 dark:text-gray-400">
                                ...
                                <form method="POST" action="{{ route('admin.security.ip.block') }}" class="space-y-6" x-data="{ ipType: 'single' }">
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-3 gap-3">
                                            <label class="relative flex items-center justify-center p-3 border rounded-xl cursor-pointer transition-all"
                                                   :class="ipType === 'single' ? 'border-indigo-600 bg-indigo-50' : 'border-gray-300 dark:border-gray-600 hover:border-indigo-400'">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <div class="text-xs text-gray-500 dark:text-gray-400">IP เดียว</div>
                                                </div>
                                            </label>

                                            <label class="relative flex items-center justify-center p-3 border rounded-xl cursor-pointer transition-all"
                                                   :class="ipType === 'range' ? 'border-indigo-600 bg-indigo-50' : 'border-gray-300 dark:border-gray-600 hover:border-indigo-400'">
                                                <input type="radio" name="ip_type" value="range" x-model="ipType" class="sr-only">
                                                <div class="text-center">
                                                    <div class="text-2xl mb-1">↔️</div>
                                                    <div class="text-sm font-medium">IP Range</div>
                                                    <div class="text-xs text-gray-500 dark:text-gray-400">ช่วง IP</div>
                                                </div>
                                            </label>

                                            <label class="relative flex items-center justify-center p-3 border rounded-xl cursor-pointer transition-all"
                                                   :class="ipType === 'cidr' ? 'border-indigo-600 bg-indigo-50' : 'border-gray-300 dark:border-gray-600 hover:border-indigo-400'">
                                                <input type="radio" name="ip_type" value="cidr" x-model="ipType" class="sr-only">
                                                <div class="text-center">
                                                    <div class="text-2xl mb-1">🌐</div>
                                                    <div class="text-sm font-medium">CIDR</div>
                                                    <div class="text-xs text-gray-500 dark:text-gray-400">Class IP</div>
                                                </div>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div x-show="ipType === 'single'" x-transition>
                                        ...
                                        <input type="text"
                                               ...
                                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">รองรับทั้ง IPv4 และ IPv6</p>
                                    </div>
                                        ...
                                        <div class="grid grid-cols-2 gap-3">
                                            <div>
                                                <input type="text"
                                                       ...
                                                       class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">IP เริ่มต้น</p>
                                            </div>
                                            <div>
                                                <input type="text"
                                                       name="ip_range_end"
                                                       ...
                                                       class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">IP สิ้นสุด</p>
                                            </div>
                                        </div>
                                    ...
                                    <div x-show="ipType === 'cidr'" x-transition>
                                        <label for="ip_cidr" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        ...
                                        <input type="text"
                                               ...
                                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">รูปแบบ CIDR เช่น 192.168.1.0/24 (256 addresses)</p>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="reason"
                                                  ...
                                                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent"></textarea>
                                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">สูงสุด 500 ตัวอักษร (ไม่จำเป็น)</p>
                                    </div>
                                    ...
                                    <div class="flex justify-end gap-3 pt-4 border-t">
                                        <button type="button"
                                                ...
                                                class="px-6 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 transition">
                                            ยกเลิก
                                        </button>
                                        <button type="submit"
                                                class="px-6 py-2 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 transition">
                                            เพิ่ม IP
                                        </button>
                                    </div>
                                </form>
                    ...
                    <!-- Blocked IPs Table -->
                    @if($blockedIps->count() > 0)
                    <div class="glass-fusion rounded-xl border border-gray-200 dark:border-gray-700 overflow-x-auto" border border-white/20 dark:border-white/10>
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">IP Type</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">IP Address</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">ประเภท</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">เหตุผล</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">บล็อกโดย</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">วันที่บล็อก</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">หมดอายุ</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">สถานะ</th>
                            ...
                            <tbody class="glass-fusion divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{{ $blockedIp->reason ?? '-' }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{{ $blockedIp->blocker->name ?? 'System' }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{{ $blockedIp->created_at->format('Y-m-d H:i') }}</td>
                    ...
                    @else
                    <div class="glass-fusion rounded-xl border border-gray-200 dark:border-gray-700 p-8" border border-white/20 dark:border-white/10>
                        <p class="text-gray-500 dark:text-gray-400 text-center">ไม่มี IP ที่ถูกบล็อก</p>
                    </div>
                    @endif
                </div>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <form method="POST" action="{{ route('admin.security.threat-intelligence.settings') }}">
                        ...
                        <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div class="flex items-center">
                                        <input type="checkbox" name="threat_block_proxy" id="threat_block_proxy"
                                               ...
                                               class="w-4 h-4 text-orange-600 border-gray-300 dark:border-gray-600 rounded">
                                        <label for="threat_block_proxy" class="ml-2 text-sm text-gray-700 dark:text-gray-300">🔀 Proxy</label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="threat_block_vpn" id="threat_block_vpn"
                                               ...
                                               class="w-4 h-4 text-yellow-600 border-gray-300 dark:border-gray-600 rounded">
                                        <label for="threat_block_vpn" class="ml-2 text-sm text-gray-700 dark:text-gray-300">🔒 VPN</label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="threat_block_tor" id="threat_block_tor"
                                               ...
                                               class="w-4 h-4 text-purple-600 border-gray-300 dark:border-gray-600 rounded">
                                        <label for="threat_block_tor" class="ml-2 text-sm text-gray-700 dark:text-gray-300">🧅 Tor</label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        <input type="checkbox" name="threat_block_abuse" id="threat_block_abuse"
                                               ...
                                               class="w-4 h-4 text-red-600 border-gray-300 dark:border-gray-600 rounded">
                                        <label for="threat_block_abuse" class="ml-2 text-sm text-gray-700 dark:text-gray-300">⚠️ Abuse</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <label for="threat_confidence_threshold" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Confidence Threshold (%)
                                </label>
                            ...
                            <div class="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6" x-data="{
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div x-show="frequency === 'daily' || frequency === 'weekly'" x-transition>
                                        <label for="threat_update_time" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    ...
                                    <div x-show="frequency === 'weekly'" x-transition>
                                        <label for="threat_update_day" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                            วันที่ต้องการอัปเดต
                                        </label>
                                    ...
                                    <div x-show="frequency === 'custom'" x-transition>
                                        <label for="threat_update_cron" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                            Cron Expression
                                        </label>
                                        <input type="text" name="threat_update_cron" id="threat_update_cron"
                                               ...
                                               placeholder="0 3 * * *"
                                               class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-green-500 font-mono">
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-xl p-6">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        <label for="abuseipdb_api_key" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                            AbuseIPDB API Key
                                        </label>
                                    ...
                                    <div>
                                        <label for="ipqualityscore_api_key" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            ...
                            <div id="threatUpdateProgress" class="mb-4 glass-fusion rounded-xl border border-gray-200 dark:border-gray-700 p-4 hidden" border border-white/20 dark:border-white/10>
                                <div class="flex items-center gap-3 mb-3">
                                    <div class="flex-shrink-0">
                                        <div class="animate-spin rounded-full h-6 w-6 border-b-2 border-green-600"></div>
                                    </div>
                                    <div class="flex-1">
                                        <p id="threatProgressMessage" class="text-sm text-gray-600 dark:text-gray-400">กำลังอัปเดต Threat Intelligence...</p>
                                    </div>
                            ...
                            <!-- Update Button -->
                            <div class="flex items-center justify-between">
                                <button type="button" id="updateThreatBtnSettings" class="px-6 py-2 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition">
                                    🔄 อัปเดตข้อมูลทันที
                                </button>

                                <button type="submit" class="px-6 py-2 bg-purple-600 text-white font-semibold rounded-xl hover:bg-purple-700 transition">
                                    บันทึกการตั้งค่า
                                </button>
                            </div>
                        </div>
            ...
            <div x-show="activeTab === 'logs'" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                <div class="space-y-6">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="glass-fusion divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{{ $log->user->name ?? '-' }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{{ $log->email ?? '-' }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($log->severity === 'critical')
                                        <span class="px-2 py-1 text-xs font-semibold rounded-full bg-red-100 text-red-800">Critical</span>
                                        @elseif($log->severity === 'high')
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{{ Str::limit($log->description, 50) }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    @else
                    <div class="glass-fusion rounded-xl border border-gray-200 dark:border-gray-700 p-8" border border-white/20 dark:border-white/10>
                        <p class="text-gray-500 dark:text-gray-400 text-center">ไม่มี Security Logs</p>
                    </div>
                    @endif
                </div>
            </div>
...
@if($errors->any())
<div class="fixed bottom-4 right-4 bg-red-500 text-white px-6 py-3 rounded-xl shadow-lg"
...
if (updateThreatBtn) {
    ...
    function showThreatSuccess(message) {
        ...
        alertDiv.className = 'fixed bottom-4 right-4 bg-green-500 text-white px-6 py-3 rounded-xl shadow-lg z-50';
    ...
    function showThreatError(message) {
        ...
        const alertDiv = document.createElement('div');
        alertDiv.className = 'fixed bottom-4 right-4 bg-red-500 text-white px-6 py-3 rounded-xl shadow-lg z-50';
        alertDiv.textContent = message;
        document.body.appendChild(alertDiv);
        setTimeout(() => alertDiv.remove(), 5000);
    }
