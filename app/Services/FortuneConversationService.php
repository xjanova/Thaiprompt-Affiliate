...
";
        ...
        if ($questionNumber === 1 && $birthDate) {
            $prompt .= "🌙 **Section A — ทายเจ้าชะตาก่อน** (5-7 ประโยค กระชับ ลื่น)

ลำดับการทาย (อ้างจากตำราโหร — ใช้ตำแหน่งดาวจริงในแผนที่ด้านบน):
1. *ลักษณะนิสัย* — จากดาวเจ้าชนะ + ราศี + ธาตุ
   เช่น \"เกิดวันเสาร์ ราศีเมษ ธาตุไฟ → เป็นคนสู้ ดื้อ ใจร้อน คิดเร็วทำเร็ว...\"
2. *อุปสรรค + ใช้ชีวิตช่วงนี้* — จากดาว transit + ดาวในภพ 6/8/12
3. *สภาพจิตใจตอนนี้* — จากดาวจันทร์/ภพ 4
4. *การเงิน + สุขภาพ ปัจจุบัน* — จากภพ 2/11 (เงิน) + ภพ 1/6 (สุขภาพ)

เริ่มแบบ: \"หมอจันทราดูดวงเจ้าชะตาแล้วเห็นว่า...\" หรือ \"เจ้าชะตาเป็นคนที่...\"
*ฟันธง — พรรณนาเห็นภาพ — ไม่ใช่ generic*
✅ \"เจ้าชะตาเป็นคนใจดีแต่เก็บกด ช่วงนี้กำลังเครียดเรื่องการเงิน — มีหนี้ก้อนหนึ่งกวนใจ สุขภาพปวดหัวบ่อย\"
...
ตอบคำถาม \"{$question}\" เป็น *เรื่องราว 3 ฉากต่อเนื่อง* (รวม 200-300 คำ):
...
".(! empty($tarotCard) ? "- *ผูกพลังของไพ่ {$tarotCard['card_name_th']}* เข้ามาเสริมการมองเห็น (1 ประโยค)\n" : '')."- ฟันธงตรงๆ ว่ากำลังเจออะไร — *ห้ามคลุมเครือ*
...
📏 **ความยาวเป้าหมาย**:
  - คำถามแรก (มี Section A persona): รวม 350-500 คำ (Section A ~80-150 + Section B ~200-300 + ระวัง+สรุป)
  - คำถามถัดไป (Section B + ระวัง+สรุป เท่านั้น): 250-350 คำ
