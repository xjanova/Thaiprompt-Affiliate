...
return [
    ...
    |
    | หมายเหตุ: records_builder ถูกย้ายไปที่ App\Services\NfcTemplateRecordsBuilder
    | เพื่อให้ config สามารถ serialize ได้ (php artisan config:cache)
    | ใช้งาน: NfcTemplateRecordsBuilder::build($templateKey, $data)
    |
    */
