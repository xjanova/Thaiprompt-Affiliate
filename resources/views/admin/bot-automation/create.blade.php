...
<div class="space-y-6" x-data="{ language: 'th' }">
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-cyan-500 via-purple-600 to-indigo-700 dark:from-cyan-900 dark:via-purple-900 dark:to-indigo-950 rounded-3xl shadow-2xl p-8">
        ...
        <div class="relative flex items-center justify-between">
            <div class="flex items-center gap-6">
                <div class="w-20 h-20 glass-fusion backdrop-blur-sm rounded-2xl flex items-center justify-center border-2 border-white/30 animate-pulse" border border-white/20 dark:border-white/10>
    ...
    <form action="{{ route('admin.bot-automation.store') }}" method="POST" class="space-y-6">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                           class="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200"
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <label class="relative cursor-pointer group">
                        ...
                        <div class="p-6 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 rounded-xl peer-checked:border-cyan-500 peer-checked:bg-gradient-to-br peer-checked:from-cyan-50 peer-checked:to-purple-50 dark:peer-checked:from-cyan-900/20 dark:peer-checked:to-purple-900/20 hover:border-cyan-300 transition-all duration-200 peer-checked:shadow-lg">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400" data-translate>โพสต์เนื้อหาอัตโนมัติตามเวลาที่กำหนด</p>
                        </div>
                    </label>
                    ...
                    <label class="relative cursor-pointer group">
                        ...
                        <div class="p-6 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 rounded-xl peer-checked:border-cyan-500 peer-checked:bg-gradient-to-br peer-checked:from-cyan-50 peer-checked:to-purple-50 dark:peer-checked:from-cyan-900/20 dark:peer-checked:to-purple-900/20 hover:border-cyan-300 transition-all duration-200 peer-checked:shadow-lg">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400" data-translate>ตอบคำถามลูกค้าอัตโนมัติด้วย AI</p>
                        </div>
                    </label>
                    ...
                    <label class="relative cursor-pointer group">
                        ...
                        <div class="p-6 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 rounded-xl peer-checked:border-cyan-500 peer-checked:bg-gradient-to-br peer-checked:from-cyan-50 peer-checked:to-purple-50 dark:peer-checked:from-cyan-900/20 dark:peer-checked:to-purple-900/20 hover:border-cyan-300 transition-all duration-200 peer-checked:shadow-lg">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400" data-translate>ช่วยปิดการขายและติดตามลูกค้า</p>
                        </div>
                    </label>
                    ...
                    <label class="relative cursor-pointer group">
                        ...
                        <div class="p-6 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 rounded-xl peer-checked:border-cyan-500 peer-checked:bg-gradient-to-br peer-checked:from-cyan-50 peer-checked:to-purple-50 dark:peer-checked:from-cyan-900/20 dark:peer-checked:to-purple-900/20 hover:border-cyan-300 transition-all duration-200 peer-checked:shadow-lg">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400" data-translate>กระตุ้นการมีส่วนร่วมของผู้ใช้</p>
                        </div>
                    </label>
                    ...
                    <label class="relative cursor-pointer group">
                        ...
                        <div class="p-6 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 rounded-xl peer-checked:border-cyan-500 peer-checked:bg-gradient-to-br peer-checked:from-cyan-50 peer-checked:to-purple-50 dark:peer-checked:from-cyan-900/20 dark:peer-checked:to-purple-900/20 hover:border-cyan-300 transition-all duration-200 peer-checked:shadow-lg">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400" data-translate>รายงานและวิเคราะห์ข้อมูลอัตโนมัติ</p>
                        </div>
                    </label>
                </div>
        ...
        <div class="glass-fusion dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 overflow-hidden" border border-white/20 dark:border-white/10>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <label class="relative cursor-pointer">
                            ...
                            <div class="p-4 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 rounded-xl peer-checked:border-indigo-500 peer-checked:bg-indigo-50 dark:peer-checked:bg-indigo-900/20 hover:border-indigo-300 transition-all duration-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400" data-translate>ทำงานตามตารางเวลา</p>
                                    </div>
                                </div>
                            </div>
                        </label>
                            ...
                            <div class="p-4 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 rounded-xl peer-checked:border-indigo-500 peer-checked:bg-indigo-50 dark:peer-checked:bg-indigo-900/20 hover:border-indigo-300 transition-all duration-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400" data-translate>ทำงานเมื่อเกิดเหตุการณ์</p>
                                    </div>
                                </div>
                            </div>
                        </label>
                            ...
                            <div class="p-4 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 rounded-xl peer-checked:border-indigo-500 peer-checked:bg-indigo-50 dark:peer-checked:bg-indigo-900/20 hover:border-indigo-300 transition-all duration-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400" data-translate>รับข้อมูลจากภายนอก</p>
                                    </div>
                                </div>
                            </div>
                        </label>
                            ...
                            <div class="p-4 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 rounded-xl peer-checked:border-indigo-500 peer-checked:bg-indigo-50 dark:peer-checked:bg-indigo-900/20 hover:border-indigo-300 transition-all duration-200">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400" data-translate>กดเริ่มด้วยตนเอง</p>
                                    </div>
                                </div>
                            </div>
                        </label>
                ...
                <div id="schedule-options" class="hidden">
                    ...
                    <select name="schedule_type" class="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <label class="relative cursor-pointer">
                            ...
                            <div class="p-4 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 rounded-xl peer-checked:border-pink-500 peer-checked:bg-pink-50 dark:peer-checked:bg-pink-900/20 hover:border-pink-300 transition-all duration-200 h-full">
                                <div class="text-center">
                                    ...
                                    <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400" data-translate>เขียนเนื้อหาเอง</p>
                                </div>
                            </div>
                        </label>
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="p-4 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 rounded-xl peer-checked:border-pink-500 peer-checked:bg-pink-50 dark:peer-checked:bg-pink-900/20 hover:border-pink-300 transition-all duration-200 h-full">
                                <div class="text-center">
                                    ...
                                    <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400" data-translate>ใช้เทมเพลตที่มี</p>
                                </div>
                            </div>
                        </label>
                        ...
                        <label class="relative cursor-pointer">
                            ...
                            <div class="p-4 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 rounded-xl peer-checked:border-pink-500 peer-checked:bg-pink-50 dark:peer-checked:bg-pink-900/20 hover:border-pink-300 transition-all duration-200 h-full">
                                <div class="text-center">
                                    ...
                                    <p class="text-xs text-gray-600 dark:text-gray-400 dark:text-gray-400" data-translate>ให้ AI สร้างเนื้อหา</p>
                                </div>
                            </div>
                        </label>
                    </div>
                ...
                <div id="custom-content" class="hidden">
                    ...
                    <textarea name="custom_content" rows="6"
                              class="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-700 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition-all duration-200"
                ...
                <div id="ai-prompt" class="hidden">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 mt-2" data-translate>บอก AI ว่าต้องการให้สร้างเนื้อหาแบบไหน</p>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                <label class="flex items-center cursor-pointer group">
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active') ? 'checked' : '' }}
                           class="w-6 h-6 text-cyan-600 border-2 border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-cyan-500 transition-all duration-200">
        ...
        <div class="flex items-center justify-end gap-4">
            <a href="{{ route('admin.bot-automation.index') }}"
               class="px-8 py-3 bg-gray-200 dark:bg-gray-700 dark:bg-slate-700 text-gray-700 dark:text-gray-300 dark:text-gray-300 font-semibold rounded-xl hover:bg-gray-300 dark:hover:bg-slate-600 transition-all duration-200 shadow-md hover:shadow-lg">
