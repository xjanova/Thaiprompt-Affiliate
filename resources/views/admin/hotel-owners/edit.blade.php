...
@section('title', 'แก้ไขข้อมูลเจ้าของโรงแรม')
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <a href="{{ route('admin.hotel-owners.show', $hotelOwner->id) }}"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="relative h-32 bg-gradient-to-br from-purple-600 via-pink-600 to-rose-600 p-8 flex items-center">
                ...
                <div class="relative flex items-center">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-white mb-1">แก้ไขข้อมูลเจ้าของโรงแรม</h1>
                        <p class="text-purple-100">แก้ไขข้อมูลของ {{ $hotelOwner->name }}</p>
                    </div>
                </div>
            </div>

            {{-- Form --}}
            <form method="POST" action="{{ route('admin.hotel-owners.update', $hotelOwner->id) }}" class="p-8">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text"
                                       ...
                                       id="name"
                                       required
                                       value="{{ old('name', $hotelOwner->name) }}"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email"
                                           ...
                                           id="email"
                                           required
                                           value="{{ old('email', $hotelOwner->email) }}"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text"
                                           name="phone"
                                           id="phone"
                                           value="{{ old('phone', $hotelOwner->phone) }}"
                    ...
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                        ...
                        <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800 mb-4">
                            <p class="text-sm text-blue-800 dark:text-blue-300">
                                💡 <strong>หมายเหตุ:</strong> หากคุณไม่ต้องการเปลี่ยนรหัสผ่าน ให้เว้นช่องนี้ว่างไว้
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                @error('password')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">เว้นว่างไว้หากไม่ต้องการเปลี่ยนรหัสผ่าน</p>
                            </div>
                        ...
                        <div>
                            ...
                            <select name="managed_hotel_id"
                                ...
                                @foreach($availableHotels as $hotel)
                                    <option value="{{ $hotel->id }}"
                                            {{ old('managed_hotel_id', $hotelOwner->managed_hotel_id) == $hotel->id ? 'selected' : '' }}>
                            ...
                            @if($hotelOwner->managedHotel)
                                <p class="mt-2 text-sm text-green-600 dark:text-green-400">
                                    ✅ กำลังดูแล: <strong>{{ $hotelOwner->managedHotel->name }}</strong>
                                </p>
                            @endif
                            @if($availableHotels->isEmpty())
                                <div class="mt-3 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                                    <p class="text-sm text-yellow-800 dark:text-yellow-300">
                                        ⚠️ ขณะนี้ไม่มีโรงแรมที่ว่างให้เลือก
                                    </p>
                                </div>
                            @endif
                        </div>
