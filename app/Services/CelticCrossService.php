...
class CelticCrossService
{
     ...
     *      แต่อย่าใช้คำว่าฟันธง ให้ใช้ แม่หมอทำนายดังนี้ แทน"
    ...
    protected function buildShortFollowupPrompt(
        ...
        return $personaPrefix
            ...
            ."• ขึ้นต้นตอบด้วยวลี *\"แม่หมอทำนายดังนี้:\"* (หรือใกล้เคียง เช่น \"แม่หมออ่านไพ่ให้แล้ว...\")\n"
            ...
            ."• ห้ามใช้คำว่า *\"ฟันธง\"* ตรงๆ — ใช้ *\"แม่หมอทำนายดังนี้\"* แทน\n"
            ...
            .'เริ่มตอบทันที (200-450 chars, ขึ้นด้วย "แม่หมอทำนายดังนี้:" หรือใกล้เคียง):';
    }
