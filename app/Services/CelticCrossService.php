        ...
        if ($bmForced) {
            ...
            $groups = [
                ...
                [
                    ...
                    'must' => ['🌟', '🔮', '🕛'],
                    'spec' => "เขียน 3 ส่วนนี้ (ขึ้นหัวข้อด้วย emoji ตามนี้เป๊ะ เว้นบรรทัดให้อ่านง่าย • พาดหัวเรื่องเด่นทำไปแล้วในส่วนแรก ไม่ต้องทำซ้ำ):\n"
                ...
                [
                    ...
                    'spec' => 'เขียน 5 ด้านนี้'.($deityEnabled ? ' + ปิดท้ายด้วยองค์เทพประจำตัว' : '')." (ขึ้นหัวข้อด้วย emoji ตามนี้เป๊ะ • แต่ละด้านผูกดาว(ภพ)+ไพ่ที่เกี่ยวข้อง • ฟันธงชัด • ไม่ต้องทำพาดหัวเรื่องเด่นซ้ำ):\n"
                        ."💞 ความรัก\n"
                        ."💼 การงาน\n"
    ...
    protected function buildFollowupPrompt(
        ...
        if ($reading->getConversationState('celtic_base_chart') && $this->isBlackMagicModeForced($reading)) {
            ...
            $baseChartDirective =
                ...
                ."📐 โครงสร้าง — *เปิดด้วยพาดหัวเรื่องเด่นก่อน* แล้วตามด้วย 5 ส่วน (ใส่ให้ครบ • ใช้ emoji หัวข้อ • เว้นย่อหน้าให้อ่านง่าย):\n"
