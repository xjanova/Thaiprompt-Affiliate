...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // เพิ่ม composite index ให้ user_id + created_at ใน fortune_readings (ถ้ายังไม่มี)
        if (Schema::hasColumn('fortune_readings', 'user_id') && ! $this->indexExists('fortune_readings', 'idx_user_date')) {
            Schema::table('fortune_readings', function (Blueprint $table) {
