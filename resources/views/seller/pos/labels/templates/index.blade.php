                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition group">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('seller.pos.labels.templates.designer', $template) }}"
                            ...
                            <div class="relative" x-data="{ open: false }">
                                ...
                                <div x-show="open"
                                    ...
                                    <a href="{{ route('seller.pos.labels.templates.edit', $template) }}"
                                       class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                                        <i class="fas fa-edit mr-2"></i> แก้ไข
                                    </a>

                                    <form action="{{ route('seller.pos.labels.templates.duplicate', $template) }}"
                                          method="POST"
                                          class="block">
                                        @csrf
                                        <button type="submit"
                                    ...
                                    @if(!$template->is_system)
                                        ...
                                        <form action="{{ route('seller.pos.labels.templates.destroy', $template) }}"
                                              method="POST"
