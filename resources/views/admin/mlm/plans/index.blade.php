...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">ระบบใช้แผนคอมมิชชัน Global บังคับทั้งระบบ</p>
    </div>
            ...
            <div class="flex-1">
                ...
                <div class="mt-6 pt-6 border-t border-blue-200 dark:border-blue-700">
                    ...
                    <a href="{{ route('admin.mlm.settings.index') }}"
                       class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white px-6 py-3 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl">
    ...
    <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        <a href="{{ route('admin.mlm.settings.index') }}" class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-200 border-l-4 border-blue-500 dark:border-blue-400">
        ...
        <a href="{{ route('admin.mlm.members.index') }}" class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-200 border-l-4 border-emerald-500 dark:border-emerald-400">
            <div class="flex items-center gap-3">
        ...
        <a href="{{ route('admin.mlm.reports.dashboard') }}" class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-200 border-l-4 border-purple-500 dark:border-purple-400">
            <div class="flex items-center gap-3">
