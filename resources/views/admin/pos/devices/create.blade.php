...
@section('title', 'เพิ่มอุปกรณ์ POS')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">📱 เพิ่มอุปกรณ์ POS ใหม่</h1>
            <p class="text-gray-500 mt-1">สร้างอุปกรณ์ Point of Sale ใหม่</p>
        </div>
    ...
    <!-- Form -->
    <form action="{{ route('admin.pos.devices.store') }}" method="POST" class="space-y-6">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="device_type" required
                        ...
                        <option value="standard" {{ old('device_type') == 'standard' ? 'selected' : '' }}>📱 Standard</option>
                        <option value="premium" {{ old('device_type') == 'premium' ? 'selected' : '' }}>💎 Premium</option>
                    </select>
                    @error('device_type')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="hardware_id" value="{{ old('hardware_id') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="subscription_status" required
                        ...
                        <option value="expired" {{ old('subscription_status') == 'expired' ? 'selected' : '' }}>⚠️ Expired</option>
                ...
                <div>
                    ...
                    <input type="number" name="monthly_fee" value="{{ old('monthly_fee', '0') }}" step="0.01" min="0" required
                        placeholder="0.00"
                ...
                <div>
                    ...
                    <input type="date" name="subscription_starts_at" value="{{ old('subscription_starts_at') }}"
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                    <input type="checkbox" name="dual_screen_enabled" value="1" {{ old('dual_screen_enabled') ? 'checked' : '' }}
                        class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                    <span class="ml-3">
                ...
                <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                    <input type="checkbox" name="offline_mode_enabled" value="1" {{ old('offline_mode_enabled') ? 'checked' : '' }}
                        class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                    <span class="ml-3">
                ...
                <label class="flex items-center cursor-pointer p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                    <input type="checkbox" name="receipt_printer_enabled" value="1" {{ old('receipt_printer_enabled') ? 'checked' : '' }}
                        class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                    <span class="ml-3">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center justify-end gap-4">
                <a href="{{ route('admin.pos.devices.index') }}" class="px-6 py-3 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
                    ยกเลิก
                </a>
