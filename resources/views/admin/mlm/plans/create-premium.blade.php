...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8">
    <div class="max-w-7xl mx-auto px-4">
        <!-- Header -->
        <div class="glass-effect rounded-2xl shadow-2xl p-8 mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-4xl font-black bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent flex items-center gap-3">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="glass-effect rounded-2xl shadow-xl p-6">
                        <div class="flex items-center justify-between">
                            ...
                            <button type="submit"
                                    class="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-xl font-bold shadow-lg transition-all transform hover:scale-105 flex items-center gap-2">
                        ...
                        <div id="overpay-warning" class="hidden">
                            <div class="glass-effect rounded-2xl shadow-xl p-6 border-2 border-red-500 warning-danger">
                                <div class="flex items-start">
                                    <div class="text-4xl mr-3"><i class="fas fa-exclamation-triangle text-red-500"></i></div>
                                    <div>
                        ...
                        <div id="safe-indicator" class="hidden">
                            <div class="glass-effect rounded-2xl shadow-xl p-6 border-2 border-green-500">
                                <div class="flex items-center">
                                    <div class="text-4xl mr-3"><i class="fas fa-check-circle text-green-500"></i></div>
                                    <div>
                                        <h3 class="text-xl font-bold text-green-600 dark:text-green-400">การตั้งค่าปลอดภัย</h3>
                                        <p class="text-sm text-green-700 dark:text-green-300">อัตราคอมมิชชันอยู่ในเกณฑ์ที่ดี</p>
                                    </div>
                                </div>
                            </div>
                        </div>
