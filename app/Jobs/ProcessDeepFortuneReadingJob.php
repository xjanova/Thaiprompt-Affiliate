            ...
            if (! empty($reading->deep_response) && $this->userId) {
                ...
                if (! $alreadySent && ! $alreadyNotified && $retryCount < 3) {
                    ...
                    if ($this->platform === 'line') {
                        ...
                        // 📱 (2026-05-19) Facebook: push แจ้งเตือน "คำทำนายพร้อม จะอ่านไหม?" — *ไม่*ส่งคำทำนายเต็ม
                        //
                        //    User spec 2026-05-19: "เปิดไพ่ → เห็นไพ่ → AI ทำนาย → ส่งแจ้งเตือนว่าจะอ่านไหม → กดอ่าน → ส่งคำทำนาย"
                        //
                        //    เดิม: push คำทำนายเต็มทันที (view_reading_deep) — ลูกค้าโดน wall of text ทันที
                        //    ใหม่: push button template "📖 อ่านคำทำนาย / ⏰ ไว้ดูทีหลัง" (fortune_ready_notification)
                        //          → ลูกค้ากด VIEW_READING postback → FacebookWebhookController:3457 trigger "ดูคำทำนาย"
                        ...
                        try {
                            ...
                            // 🛡️ (2026-05-19) เขียน flag เฉพาะเมื่อ $sent === true — กัน transient lock
