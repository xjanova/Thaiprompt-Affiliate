...
class SoftwareProductSeeder extends Seeder
{
    ...
    {
        // Create Categories
        $mlmCategory = SoftwareProductCategory::updateOrCreate(
        ...
        $ecommerceCategory = SoftwareProductCategory::updateOrCreate(
            ['slug' => 'ecommerce'],
            [
        ...
        $affiliateCategory = SoftwareProductCategory::updateOrCreate(
        ...
        // ========================================
        // สร้างผลิตภัณฑ์: ระบบ MLM แบบครบวงจร
        // ========================================
        $mlmProduct = SoftwareProduct::updateOrCreate(
            ['slug' => 'complete-mlm-system'],
            [
                'category_id' => $mlmCategory->id,
        ...
        // ========================================
        // สร้าง Options สำหรับระบบ MLM
        // ========================================

        // Option 1: แผนการตลาด (MLM Plan)
        $mlmPlanOption = SoftwareProductOption::updateOrCreate(
            [
                'software_product_id' => $mlmProduct->id,
                'name' => 'mlm_plan'
            ],
            [
        ...
        // Values for MLM Plan
        SoftwareProductOptionValue::updateOrCreate(
            [
                'software_product_option_id' => $mlmPlanOption->id,
                'value' => 'binary'
            ],
            [
        ...
        // Option 2: จำนวนสมาชิก
        $memberLimitOption = SoftwareProductOption::updateOrCreate(
            [
                'software_product_id' => $mlmProduct->id,
                'name' => 'member_limit'
            ],
        ...
        SoftwareProductOptionValue::updateOrCreate(
            [
                'software_product_option_id' => $memberLimitOption->id,
                'value' => '1000'
            ],
            [
        ...
        // Option 3: ฟีเจอร์เพิ่มเติม
        $additionalFeaturesOption = SoftwareProductOption::updateOrCreate(
            [
                'software_product_id' => $mlmProduct->id,
        ...
        SoftwareProductOptionValue::updateOrCreate(
            [
                'software_product_option_id' => $additionalFeaturesOption->id,
                'value' => 'mobile_app'
            ],
            [
        ...
        // Option 4: การติดตั้งและอบรม
        $installationOption = SoftwareProductOption::updateOrCreate(
            [
                'software_product_id' => $mlmProduct->id,
        ...
        SoftwareProductOptionValue::updateOrCreate(
            [
                'software_product_option_id' => $installationOption->id,
                'value' => 'basic'
            ],
            [
        ...
        // Option 5: การบำรุงรักษา (Maintenance)
        $maintenanceOption = SoftwareProductOption::updateOrCreate(
            [
                'software_product_id' => $mlmProduct->id,
                'name' => 'maintenance'
            ],
        ...
        SoftwareProductOptionValue::updateOrCreate(
            [
                'software_product_option_id' => $maintenanceOption->id,
                'value' => 'basic'
            ],
            [
        ...
        // Option 6: โฮสติ้งและโดเมน
        $hostingOption = SoftwareProductOption::updateOrCreate(
            [
                'software_product_id' => $mlmProduct->id,
                'name' => 'hosting'
            ],
        ...
        SoftwareProductOptionValue::updateOrCreate(
            [
                'software_product_option_id' => $hostingOption->id,
                'value' => 'self_hosted'
            ],
            [
        ...
        $this->command->info('✅ สร้างระบบ MLM พร้อมออฟชั่นและราคาเรียบร้อยแล้ว!');
    }
}
