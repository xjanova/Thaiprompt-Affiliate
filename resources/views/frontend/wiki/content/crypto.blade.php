<div class="wiki-content-section">
    ...
    <div class="tab-content active" data-tab-content="wallet">
        <section class="wiki-section">
            ...
            <h3>💎 Multi-Currency Wallet Features</h3>
...
&nbsp;&nbsp;&nbsp;↓<br>
3. กรอก PIN 6 หลัก (ยืนยันตัวตน)<br>
&nbsp;&nbsp;&nbsp;↓<br>
4. เลือก Bank Account (บัญชีธนาคารที่ลงทะเบียนไว้)<br>
&nbsp;&nbsp;&nbsp;↓<br>
5. ระบบสร้าง Withdrawal Request<br>
&nbsp;&nbsp;&nbsp;↓<br>
6. Lock Balance (ล็อคยอดเงินที่ขอถอน)<br>
&nbsp;&nbsp;&nbsp;↓<br>
7. Admin อนุมัติ (Manual Approval)<br>
&nbsp;&nbsp;&nbsp;↓<br>
8. โอนเงินเข้าบัญชีจริง<br>
&nbsp;&nbsp;&nbsp;↓<br>
9. Update Status = "Completed"<br>
&nbsp;&nbsp;&nbsp;↓<br>
10. ส่ง Email/SMS แจ้งเตือน
        ...
        <section class="wiki-section">
            ...
            <div class="info-box warning">
                ...
                <ul style="line-height: 2;">
                    ...
                    <li><strong>⏱️ ใจเย็น:</strong> Confirmation อาจใช้เวลานาน ไม่ควรตื่นตระหนก</li>
                </ul>
            </div>
        </section>
    </div>
    ...
    <div class="tab-content" data-tab-content="exchange" style="display: none;">
        <section class="wiki-section">
            ...
            <h3>💡 ตัวอย่าง: แลกเปลี่ยน Crypto</h3>
...
2. เลือก To: USDT<br>
&nbsp;&nbsp;&nbsp;↓<br>
3. ระบบคำนวณอัตราแลกเปลี่ยน:<br>
&nbsp;&nbsp;&nbsp;0.01 BTC × $45,000 = $450 USDT<br>
&nbsp;&nbsp;&nbsp;↓<br>
        ...
        <section class="wiki-section">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; margin: 2rem 0;">
                ...
                <div style="background: linear-gradient(135deg, rgba(var(--accent-rgb), 0.1), rgba(var(--accent-rgb), 0.05)); border: 2px solid rgb(var(--accent-rgb)); border-radius: 16px; padding: 2rem;">
                    ...
                    <ul style="list-style: none; padding-left: 0; line-height: 2; font-size: 0.95rem;">
                        ...
                        <li>✅ รับดอกเบี้ยรายวัน</li>
                        <li>✅ ขั้นต่ำ: 1,000 USDT</li>
                    </ul>
                </div>
            </div>

            <h3>💰 ROI & Dividend System</h3>
            ...
            <div class="info-box success">
                ...
                <ul style="line-height: 2;">
                    ...
                    <li><strong>รายไตรมาส:</strong> Bonus Dividend (ถ้ากำไรเกินเป้า)</li>
                </ul>
            </div>
            ...
            <div class="info-box tip">
                ...
                <ul style="line-height: 2;">
                    ...
                    <li><strong>ศึกษาก่อนลงทุน:</strong> อ่าน Whitepaper, Tokenomics ให้เข้าใจ</li>
                </ul>
            </div>
        </section>
    </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; margin: 2rem 0;">
                <div class="info-box success">
                    ...
                    <ul style="line-height: 2;">
                        ...
                        <li>ตรวจสอบ Address ก่อนโอน</li>
                        <li>เก็บ Seed Phrase ให้ปลอดภัย</li>
                    </ul>
                </div>
                ...
                <div class="info-box warning">
                    ...
                    <ul style="line-height: 2;">
                        ...
                        <li>อย่าเก็บ Private Key ในมือถือ</li>
                        <li>อย่าเชื่อคำว่า "รวยเร็ว แน่นอน"</li>
                    </ul>
                </div>
            </div>
...
(function() {
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initCryptoTabs);
    } else {
        initCryptoTabs();
    }
    ...
    function initCryptoTabs() {
        ...
        console.log('Crypto Tabs initialized:', tabButtons.length, 'buttons found');
