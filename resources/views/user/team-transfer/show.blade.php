...
<div class="container mx-auto px-4 py-8">
    {{-- Premium Hero Header (Blue-Purple for Transfer Detail) --}}
    <div class="relative overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 dark:from-blue-800 dark:via-purple-800 dark:to-indigo-800 rounded-2xl shadow-2xl p-8 mb-6">
        ...
        <div class="relative z-10">
            ...
            <div class="flex items-center gap-4">
                <div class="glass-fusion p-4 rounded-2xl">
                    <i class="fas fa-exchange-alt text-4xl text-white drop-shadow-lg"></i>
                </div>
                <div>
                    <h1 class="text-3xl md:text-4xl font-bold text-white drop-shadow-lg">📄 รายละเอียดคำขอย้ายทีม</h1>
                    <p class="text-blue-100 mt-1">#{{ $request->id }}</p>
                </div>
            </div>
        </div>
    </div>
