            ...
            try {
                ...
                if ($justUpdated !== null && $block !== '') {
                    $block .= "\n🕛 เจ้าชะตาเพิ่งบอกเวลาเกิด {$justUpdated} น. — ผังข้างบนคำนวณใหม่ด้วยเวลานี้แล้ว"
                        ...
                        .$this->birthTimeEchoRule($justUpdated);
                }
...
".FortuneAIService::NO_HEDGE_DIRECTIVE;
    ...
    /**
     * 🇹🇭 (2026-09-14) กำกับตอนแม่หมอทวนเวลาเกิด — ให้ทวนเป็นตัวเลขที่ระบบแปลงแล้ว ห้ามแปลงนาฬิกาไทยเอง
     *
     * เคสจริง FTU-260913-C9471: ลูกค้าพิมพ์ "5 โมงเช้าก่อนเที่ยง" ระบบ (ตอนนั้นยังผิด) เก็บ 05:00
     * แล้ว AI อธิบายต่อว่า *"เวลาเกิด 05:00 น. คือห้าโมงเช้า"* — ผิดซ้ำ เพราะห้าโมงเช้า = 11:00
     * ตัวแปลงแก้แล้ว แต่ต้องกันไม่ให้ AI แปลงเองสวนผังอีก
     */
    protected function birthTimeEchoRule(string $hhmm): string
    {
        return "\n   → ทวนเวลาเป็นตัวเลข {$hhmm} น. ตามนี้เท่านั้น ห้ามแปลงเป็นนาฬิกาไทยเอง"
            .' (ระบบแปลงให้แล้ว: ตีห้า = 05:00 · ห้าโมงเช้า = 11:00 · ห้าโมงเย็น = 17:00)';
    }
