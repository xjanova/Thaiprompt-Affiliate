...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-8">เขียนรีวิวที่พัก</h1>
        ...
        <form action="{{ route('hotels.reviews.store', $booking->booking_number) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-6">ให้คะแนนประสบการณ์ของคุณ</h3>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center gap-2" x-data="{ rating: 0, hover: 0 }">
                        @for($i = 1; $i <= 5; $i++)
                            <label class="cursor-pointer">
                                ...
                                <svg @mouseenter="hover = {{ $i }}" @mouseleave="hover = 0"
                                     :class="(rating >= {{ $i }} || hover >= {{ $i }}) ? 'text-yellow-400' : 'text-gray-300 dark:text-gray-600'"
                        ...
                        @endfor
                        <span x-text="rating > 0 ? rating + '/5' : 'เลือกคะแนน'" class="ml-2 text-gray-600 dark:text-gray-400"></span>
                    </div>
                            ...
                            <div class="flex gap-1">
                                @for($i = 1; $i <= 5; $i++)
                                    <label class="cursor-pointer">
                                        ...
                                        <svg class="w-6 h-6 text-gray-300 dark:text-gray-600 hover:text-yellow-400 fill-current transition-colors rating-star"
                                             viewBox="0 0 20 20">
                                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                        </svg>
                                    </label>
            ...
            <!-- Review Content -->
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-6">เขียนรีวิว</h3>
            ...
            <!-- Additional Info -->
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-6">ข้อมูลเพิ่มเติม</h3>

                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        คุณเดินทางแบบไหน?
                    </label>
                    <select name="guest_type" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:border-blue-500 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="file" name="images[]" multiple accept="image/*"
                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-blue-50 file:text-blue-700 dark:file:bg-blue-900/30 dark:file:text-blue-400 hover:file:bg-blue-100 dark:hover:file:bg-blue-900/50"
                           onchange="previewImages(this)">
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">รองรับไฟล์ JPG, PNG (สูงสุด 5MB ต่อรูป)</p>
