        ...
        <form method="GET" action="{{ route('admin.tpix.wallets') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <input
                    ...
                    class="w-full px-4 py-2 rounded-xl border border-gray-300 dark:border-gray-600 dark:border-slate-600 glass-fusion dark:bg-slate-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                >
            </div>
            ...
            <div class="flex items-end gap-2">
                <button
                    type="submit"
                    class="flex-1 px-6 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition"
                >
                    ค้นหา
                </button>
                <a
                    href="{{ route('admin.tpix.wallets') }}"
                    class="px-4 py-2 bg-gray-200 dark:bg-gray-700 dark:bg-slate-700 hover:bg-gray-300 dark:hover:bg-slate-600 text-gray-700 dark:text-gray-300 dark:text-gray-300 font-semibold rounded-xl transition"
                >
                    รีเซ็ต
                </a>
            </div>
                ...
                <tbody class="glass-fusion dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700">
                    ...
                    <tr class="hover:bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:hover:bg-slate-700 transition">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @else
                            <span class="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400">-</span>
                            @endif
                        </td>
                        ...
                        <td class="px-6 py-4">
                            @php
                                $statusColors = [
                                    ...
                                    'inactive' => 'bg-gray-100/50 dark:bg-gray-800/50 dark:bg-gray-700 text-gray-900 dark:text-white dark:text-gray-300',
