...
<div class="container mx-auto px-4 py-8 max-w-6xl">
    ...
    <div class="grid grid-cols-3 gap-6 mb-6">
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-gray-600 text-sm mb-2">ผู้ใช้</h3>
            <p class="text-xl font-bold">{{ $reading->user->name ?? 'Guest' }}</p>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-gray-600 text-sm mb-2">หมวดหมู่</h3>
            <p class="text-xl font-bold">{{ $reading->category->name_th }}</p>
        </div>
        <div class="bg-white rounded-lg shadow p-6">
            <h3 class="text-gray-600 text-sm mb-2">รูปแบบ</h3>
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <p class="text-gray-700">{{ $reading->question }}</p>
    </div>
    @endif
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="border rounded-lg p-4">
                ...
                <p class="text-sm text-gray-600">{{ $readingCard->position_name }}</p>
