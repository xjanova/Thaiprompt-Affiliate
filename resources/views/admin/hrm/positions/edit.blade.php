...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-green-500 to-teal-600 rounded-xl shadow-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold mb-1">✏️ แก้ไขตำแหน่ง</h1>
                <p class="text-green-100">แก้ไขข้อมูลตำแหน่ง: {{ $position->position_name }}</p>
            </div>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.hrm.positions.update', $position) }}" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="position_code" value="{{ old('position_code', $position->position_code) }}" required
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500">{{ old('description', $position->description) }}</textarea>
            ...
            <div class="grid grid-cols-1 gap-4">
                <div>
                    ...
                    <textarea name="responsibilities" rows="4"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                              placeholder="ระบุหน้าที่และความรับผิดชอบของตำแหน่งนี้">{{ old('responsibilities', $position->responsibilities) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="requirements" rows="4"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500"
                              placeholder="ระบุคุณสมบัติและทักษะที่ต้องการสำหรับตำแหน่งนี้">{{ old('requirements', $position->requirements) }}</textarea>
