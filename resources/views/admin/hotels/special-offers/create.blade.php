...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        ...
        <nav class="flex text-sm text-gray-500 dark:text-gray-400 space-x-2">
            ...
            <span>/</span>
            <span class="text-gray-900 dark:text-white font-medium">สร้างใหม่</span>
        </nav>
    </div>

    <form action="{{ route('admin.hotels.special-offers.store') }}" method="POST" enctype="multipart/form-data" x-data="offerForm()">
        @csrf
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="description" name="description" rows="3"
                                              ...
                                              class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div x-show="discountType === 'free_nights'" x-cloak>
                                        ...
                                        <input type="number" id="free_nights" name="free_nights" value="{{ old('free_nights') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="min_nights" name="min_nights" value="{{ old('min_nights') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="min_amount" name="min_amount" value="{{ old('min_amount') }}"
                            ...
                            <div class="space-y-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="date" id="valid_to" name="valid_to" value="{{ old('valid_to') }}" required
                                               class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition">
                                        @error('valid_to')
                                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                        @enderror
                        ...
                        <div x-show="activeTab === 'limits'" x-transition x-cloak>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="max_uses_per_user" name="max_uses_per_user" value="{{ old('max_uses_per_user') }}"
                                           min="1" placeholder="ไม่จำกัด"
                                           class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition">
...
function offerForm() {
    return {
        ...
        bannerPreview: null,
        roomTypesHtml: '<p class="text-sm text-indigo-100">กรุณาเลือกโรงแรมก่อน</p>',
