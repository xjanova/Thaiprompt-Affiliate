...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">เพิ่มสมาชิกใหม่เข้าสู่ระบบ MLM</p>
        </div>
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-6">
            <div class="mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                ...
                <p class="text-gray-600 dark:text-gray-400 mt-1">กรอกข้อมูลสำหรับสร้างสมาชิก MLM ใหม่</p>
            </div>
            ...
            <form action="{{ route('admin.mlm.members.store') }}" method="POST" class="space-y-6">
                ...
                <!-- User Selection -->
                <div>
                    <label for="user_id" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-2">
                    ...
                    <select id="user_id"
                            name="user_id"
                            required
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent transition @error('user_id') border-red-500 @enderror">
                ...
                <!-- MLM Plan -->
                <div>
                    <label for="mlm_plan_id" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-2">
                    ...
                    <select id="mlm_plan_id"
                            name="mlm_plan_id"
                            required
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent transition @error('mlm_plan_id') border-red-500 @enderror">
                ...
                <!-- Unilevel Sponsor -->
                <div>
                    <label for="unilevel_sponsor_id" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-2">
                    ...
                    <select id="unilevel_sponsor_id"
                            ...
                            required
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition @error('unilevel_sponsor_id') border-red-500 @enderror">
                ...
                <div>
                    <label for="binary_sponsor_id" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-2">
                        <i class="fas fa-code-branch text-purple-600 dark:text-purple-400"></i>
                        ผู้สนับสนุน Binary
                        <span class="text-gray-500 text-xs font-normal">(ไม่จำเป็น)</span>
                    </label>
                    <select id="binary_sponsor_id"
                            name="binary_sponsor_id"
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent transition @error('binary_sponsor_id') border-red-500 @enderror">
                ...
                <div>
                    <label for="binary_position" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-2">
                    ...
                    <select id="binary_position"
                            ...
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent transition @error('binary_position') border-red-500 @enderror">
                ...
                <!-- Information Box -->
                <div class="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 dark:border-blue-400 p-4 rounded-lg">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <a href="{{ route('admin.mlm.members.index') }}"
                       class="w-full sm:w-auto px-6 py-3 text-center text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition flex items-center justify-center gap-2">
