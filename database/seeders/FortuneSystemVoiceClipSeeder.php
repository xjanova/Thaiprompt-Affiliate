    ...
    protected function clips(): array
    {
        return [
            ...
            [
                ...
                'step_group' => 'celtic',
                'title' => 'เลือกไพ่ใบต่อไป (99 — กระตุ้นเมื่อเงียบ)',
                'description' => 'เล่นเมื่อลูกค้าเงียบไม่กดเปิดไพ่ใบต่อไปครบเวลาที่ตั้ง (ตั้งวินาทีที่ "หน่วงเสียงเลือกไพ่")',
                'script_text' => 'ตั้งจิตให้นิ่ง นึกถึงเรื่องที่อยากรู้ แล้วกดเปิดไพ่ใบต่อไปได้เลยนะคะ ไพ่แต่ละใบจะบอกเล่าเรื่องราวของเจ้าชะตาค่ะ',
                'enabled' => false,
            ],

            // ── (2026-06-21) จ่ายแล้ว → เริ่มเปิดไพ่ (Celtic 99) ──────────
            [
                'clip_key' => 'paid_intro',
                'step_group' => 'celtic',
                'title' => 'จ่ายแล้ว — เริ่มเปิดไพ่ (99)',
                'description' => 'เล่นตอนค่าครูเข้าระบบ ก่อนเปิดไพ่ใบแรก (Celtic 99)',
                'script_text' => 'ได้รับค่าบูชาครูเรียบร้อยแล้วนะคะ แม่หมอจะเริ่มเปิดไพ่ให้ทีละใบ ทั้งหมดสิบใบ ตั้งจิตให้นิ่ง นึกถึงเรื่องที่อยากรู้ แล้วกดเปิดไพ่ใบแรกได้เลยค่ะ',
                'enabled' => false,
            ],

            // ── (2026-06-21) ขั้นตอน 39 (Deep) — แยกเสียงจาก 99 ──────────
            [
                'clip_key' => 'deep39_draw',
                'step_group' => 'deep',
                'title' => 'ดูดวง 39 — ตั้งจิตเปิดไพ่ (พื้นดวง)',
                'description' => 'เล่นตอน 39 ขอตั้งจิตก่อนเปิดไพ่อ่านพื้นดวงรวม (แยกจาก 99)',
                'script_text' => 'แม่หมอได้รับวันเดือนปีเกิดของเจ้าชะตาแล้วนะคะ เดี๋ยวจะเปิดไพ่อ่านพื้นดวงรวมจากวันเกิดและไพ่ให้ ตั้งจิตให้นิ่ง หายใจลึกๆ แล้วพิมพ์ พร้อม หรือ เปิดไพ่ ได้เลยค่ะ',
                'enabled' => false,
            ],
        ];
    }
