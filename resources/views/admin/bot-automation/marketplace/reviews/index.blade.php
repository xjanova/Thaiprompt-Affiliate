    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="group glass-fusion dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-orange-100 dark:border-orange-900/30 hover:border-orange-300 dark:hover:border-orange-700 transform hover:-translate-y-1" border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <p data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">รีวิวทั้งหมด</p>
        ...
        <div class="group glass-fusion dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-green-100 dark:border-green-900/30 hover:border-green-300 dark:hover:border-green-700 transform hover:-translate-y-1" border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <p data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">คะแนนเฉลี่ย</p>
        ...
        <div class="group glass-fusion dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-yellow-100 dark:border-yellow-900/30 hover:border-yellow-300 dark:hover:border-yellow-700 transform hover:-translate-y-1" border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <p data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">รอการอนุมัติ</p>
        ...
        <div class="group glass-fusion dark:bg-gray-800 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-blue-100 dark:border-blue-900/30 hover:border-blue-300 dark:hover:border-blue-700 transform hover:-translate-y-1" border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <p data-translate class="text-sm font-medium text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">รีวิวเดือนนี้</p>
                    ...
                    <tr class="hover:bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-1">
                                @for($i = 0; $i < 5; $i++)
                                    <svg class="w-4 h-4 {{ $i < ($review->rating ?? 0) ? 'text-yellow-400' : 'text-gray-300 dark:text-gray-600 dark:text-gray-400' }}" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                @endfor
                            </div>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400 max-w-xs">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <button onclick="approveReview({{ $review->id }})"
                                        class="inline-flex items-center px-3 py-1.5 bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 text-white rounded-xl transition-all duration-300 shadow-sm hover:shadow-md">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                    </svg>
                                </button>
                                <button onclick="rejectReview({{ $review->id }})"
                                        class="inline-flex items-center px-3 py-1.5 bg-red-600 hover:bg-red-700 dark:bg-red-500 dark:hover:bg-red-600 text-white rounded-xl transition-all duration-300 shadow-sm hover:shadow-md">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p data-translate class="text-lg font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400">ไม่พบรีวิว</p>
                                <p data-translate class="text-sm text-gray-400 dark:text-gray-500 dark:text-gray-400 mt-1">รอรีวิวจากผู้ใช้งาน</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
