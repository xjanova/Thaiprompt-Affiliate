                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Show widget on your website</p>
                            </div>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Welcome Message</label>
                            <textarea name="welcome_message" rows="3"
                                class="w-full px-4 py-3 border border-gray-200 rounded-lg">{{ old('welcome_message', $settings->welcome_message ?? 'Hello! How can we help?') }}</textarea>
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Position</label>
                            <select name="position" class="w-full px-4 py-3 border border-gray-200 rounded-lg">
            ...
            <div class="lg:col-span-1">
                <div class="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl border border-cyan-200 p-6 sticky top-6">
                    ...
                    <div class="bg-white rounded-lg p-4 shadow-lg">
                        <p class="text-sm text-gray-600 text-center">Widget preview will appear here</p>
                    </div>
                </div>
            </div>
        </div>
