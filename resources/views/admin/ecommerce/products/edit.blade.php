                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name', $product->name) }}" required placeholder="กรอกชื่อสินค้า..." data-translate-placeholder class="w-full px-4 py-2.5 rounded-lg border-2 border-gray-300 dark:border-gray-600 dark:bg-slate-700 dark:text-white focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900/30 transition-all">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="text" name="sku" value="{{ old('sku', $product->sku) }}" placeholder="รหัสสินค้า" data-translate-placeholder class="w-full px-4 py-2.5 rounded-lg border-2 border-gray-300 dark:border-gray-600 dark:bg-slate-700 dark:text-white focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900/30 transition-all font-mono">
                            @error('sku')
                        ...
                        <div>
                            ...
                            <textarea name="short_description" rows="2" placeholder="คำอธิบายสินค้าแบบย่อ..." data-translate-placeholder class="w-full px-4 py-2.5 rounded-lg border-2 border-gray-300 dark:border-gray-600 dark:bg-slate-700 dark:text-white focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900/30 transition-all resize-none">{{ old('short_description', $product->short_description) }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="6" placeholder="รายละเอียดสินค้าแบบครบถ้วน..." data-translate-placeholder class="w-full px-4 py-2.5 rounded-lg border-2 border-gray-300 dark:border-gray-600 dark:bg-slate-700 dark:text-white focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900/30 transition-all resize-none">{{ old('description', $product->description) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="brand" value="{{ old('brand', $product->brand) }}" placeholder="ชื่อแบรนด์" data-translate-placeholder class="w-full px-4 py-2.5 rounded-lg border-2 border-gray-300 dark:border-gray-600 dark:bg-slate-700 dark:text-white focus:border-pink-500 dark:focus:border-pink-400 focus:ring-2 focus:ring-pink-200 dark:focus:ring-pink-900/30 transition-all">
                        </div>
                        ...
                        <div class="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-3">
                            <label class="inline-flex items-center gap-2 cursor-pointer group">
                                ...
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors" data-translate>✅ ใช้งาน</span>
                            </label>
                            ...
                            <label class="inline-flex items-center gap-2 cursor-pointer group">
                                ...
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-yellow-600 dark:group-hover:text-yellow-400 transition-colors" data-translate>⭐ สินค้าแนะนำ</span>
                            </label>
                            ...
                            <label class="inline-flex items-center gap-2 cursor-pointer group">
                                ...
                                <span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" data-translate>📊 ติดตามสต็อก</span>
                            </label>
                        </div>
