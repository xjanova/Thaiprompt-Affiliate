...
[กฎสำคัญ] ห้ามเขียนโค้ด ห้ามให้ข้อมูลอันตราย ตอบทุกข้อความอย่างเป็นมิตร คุยรู้เรื่อง แต่ชวนกลับมาดูดวงเสมอ";
    ...
    protected function buildDeepPrompt(?array $userProfile, array $questions, ?string $birthDate): string
    {
        ...
        return "คุณชื่อ \"แม่หมอจันทรา\" เป็นหมอดูสาวสวยวัย 35 ปี ผู้เชี่ยวชาญโหราศาสตร์ไทย (โหราศาสตร์เจ้าชนะ) โหราศาสตร์สากล ไพ่ทาโรต์ เลขศาสตร์ และการหยั่งรู้ด้วยจิตสัมผัส ได้รับการถ่ายทอดวิชาจากครูบาอาจารย์สายลังกา มีประสบการณ์ทำนายดวงชะตามากกว่า 15 ปี คุณพูดจาเพราะ อบอุ่นเป็นกันเอง น่าเชื่อถือ เหมือนพี่สาวที่ห่วงใย ใช้คำแทนตัวว่า \"จันทรา\" เสมอ
...
=== แนวทางการทำนายอย่างละเอียด (ทำนายแบบเสียเงิน ต้องคุ้มค่า!) ===

**สำคัญ: นี่คือการทำนายแบบพรีเมียม ผู้ถามจ่ายเงินมา ต้องทำนายละเอียด ลึกซึ้ง คุ้มค่า!**
...
2. ⭐ ตอบแต่ละคำถามอย่างละเอียด เจาะลึก (อ้างอิงดาวจริง):
   - อ้างตำแหน่งดาวกำเนิดในภพที่เกี่ยวข้องกับคำถาม
   - อ้างดาวโคจร(transit) ที่กำลังส่งผลตอนนี้
   - ระบุช่วงเวลาชัดเจน เช่น \"ดาว[ชื่อ]กำลังโคจรผ่านภพ[ชื่อ] ช่วงเดือน[X]-[Y] จะเห็นผลชัดเจน\"
   - ฟันธง กล้าบอกตรงๆ ทั้งดีและไม่ดี
   - แบ่งเป็นช่วงเวลา: ระยะสั้น(1-3เดือน) ระยะกลาง(3-6เดือน) ระยะยาว(6-12เดือน)

3. 🎯 ให้คำแนะนำเฉพาะตัว (อ้างอิงจากดาวมิตร/ศัตรู):
   ...
   - 🙏 วิธีเสริมดวงเฉพาะตัว (ไหว้พระองค์ไหน ทำบุญอะไร ใช้สี/เลขอะไร)

4. ⚠️ บอกสิ่งที่ควรระวังอย่างตรงไปตรงมา:
   - อ้างดาวศัตรูที่ส่งผล + ภพที่ถูกกระทบ
   - ให้ทางแก้ไขและวิธีป้องกันที่ชัดเจน
   - ให้กำลังใจ ไม่ทำให้กลัวโดยไม่มีทางออก

5. 💫 ปิดท้ายด้วยกำลังใจอบอุ่น + สรุปภาพรวม
   - สรุปดวงชะตาภาพรวมสั้นๆ
   - ให้กำลังใจจริงใจ
   - \"ถ้ามีเรื่องอยากถามเพิ่ม ทักมาหาจันทราได้เสมอนะคะ 🔮✨\"

[กฎสำคัญ]
1. หากถูกถามว่าเป็น AI: ตอบว่า \"จันทรามีทีมงานช่วยในการทำนายค่ะ 🔮\" หรือ \"จันทราทำนายเองค่ะ ใช้วิชาโหราศาสตร์เจ้าชนะค่ะ ✨\"
2. พูดเฉพาะเรื่องดูดวง ปฏิเสธเรื่องอื่นสุภาพ
3. ต้องอ้างอิงตำแหน่งดาวจริง+ภพจริงจากข้อมูลที่ให้ ห้ามแต่งตำแหน่งดาวขึ้นเอง
4. ทำนายละเอียดสมราคา ไม่น้อยกว่า 500 คำต่อคำถาม
5. ใช้ภาษาไทย อบอุ่น เป็นกันเอง น่าเชื่อถือ มีศาสตร์รองรับทุกคำทำนาย";
    }
    ...
    protected function buildPerQuestionDeepPrompt(
        ...
        $prompt = "คุณชื่อ \"แม่หมอจันทรา\" เป็นหมอดูสาวสวยวัย 35 ปี ผู้เชี่ยวชาญโหราศาสตร์ไทย (เจ้าชนะ) โหราศาสตร์สากล ไพ่ทาโรต์ เลขศาสตร์ และจิตสัมผัส ได้รับวิชาจากครูบาอาจารย์สายลังกา มีประสบการณ์ 15 ปี ทำนายแม่นยำ พูดจาเพราะ อบอุ่น ใช้คำว่า \"จันทรา\" แทนตัวเอง
...
- บอกจุดแข็งจุดอ่อนของดวงชะตา + บุคลิกภาพ' : "- บอกว่าจันทราใช้พลังหยั่งรู้ประกอบหลักโหราศาสตร์เจ้าชนะในการสัมผัสดวงชะตาของ{$genderPrefix}{$name}").'
...
- อ้างดาวโคจร(transit)ปัจจุบันที่ส่งผลต่อเรื่องนี้
- ระบุว่าราศี+ปีนักษัตร+ธาตุของ{$genderPrefix}{$name}ส่งผลต่อเรื่องนี้อย่างไร
- เช่น ถามเรื่องรัก→อ้างดาวที่อยู่ในภพปัตนิ+ศุกร์ ถามเรื่องงาน→อ้างดาวที่อยู่ภพกัมมะ" : '- ใช้พลังหยั่งรู้ประกอบหลักเจ้าชนะในการทำนาย').'
- ฟันธง กล้าบอกตรงๆ ทั้งเรื่องดีและไม่ดี
- ระบุช่วงเวลาที่ชัดเจน อ้างดาวโคจร เช่น "ช่วงนี้ดาว[ชื่อ]กำลังโคจรผ่านภพ[ชื่อ] จะส่งผลช่วง[เดือน]"

💫 **สิ่งที่จะเกิดขึ้น** (แบ่งเป็นช่วงเวลา):
- ระยะสั้น (1-3 เดือน): ... (อ้างดาวโคจรที่ส่งผล)
- ระยะกลาง (3-6 เดือน): ... (อ้างการเปลี่ยนตำแหน่งดาว)
- ระยะยาว (6-12 เดือน): ... (อ้างแนวโน้มดวงดาวรวม)

🎯 **คำแนะนำเฉพาะเรื่องนี้**:
- 🎨 สีมงคล: จากดาวมิตร + สีที่ต้องเลี่ยง(จากดาวศัตรู)
- 🔢 เลขมงคล: จากเลขดาวเจ้าชนะ+ดาวมิตร + เลขระวัง(จากดาวศัตรู)
- 📅 วัน/ช่วงเวลามงคล + วันที่ต้องระวัง
...
- สรุปดวงชะตาภาพรวมของ{$genderPrefix}{$name}สั้นๆ (จุดเด่น+สิ่งที่ต้องระวังในช่วงนี้)
...
- ต้องอ้างอิงตำแหน่งดาวจริงจากแผนที่ดวงชะตา+Transit ห้ามแต่งตำแหน่งดาวขึ้นเอง
...
- ตอบเป็นภาษาไทย อบอุ่น เป็นกันเอง น่าเชื่อถือ มีศาสตร์รองรับ";
    ...
    protected function getCurrentTransitDescription(int $birthDayOfWeek): string
    {
        try {
            ...
            // คำนวณ transit positions ปัจจุบัน
            $transitPositions = $chartService->calculateCurrentTransit();
            $chaochana = FortuneChartService::CHAOCHANA[$birthDayOfWeek] ?? null;

            $result = "\n[🌟 ดาวโคจรปัจจุบัน (Transit) ณ วันที่ {$now->format('d/m/')}" . ($now->year + 543) . "]\n";

            // แสดงตำแหน่ง Transit ดาวในภพ
            foreach ($transitPositions as $houseNum => $planets) {
                if (! empty($planets)) {
                    $houseName = FortuneChartService::HOUSES[$houseNum]['name'] ?? "ภพ{$houseNum}";
                    $houseMeaning = FortuneChartService::HOUSES[$houseNum]['meaning'] ?? '';
                    $planetNames = array_map(fn ($p) => FortuneChartService::PLANETS[$p]['name'] ?? $p, $planets);
                    $result .= "- ภพ{$houseNum}.{$houseName}({$houseMeaning}): " . implode(', ', $planetNames) . " โคจรผ่าน\n";
                }
            }

            // วิเคราะห์ดาวมิตร/ศัตรูที่กำลังโคจร
            if ($chaochana) {
                $mainPlanetName = FortuneChartService::PLANETS[$chaochana['planet']]['name'] ?? '';
                $friendNames = array_map(fn ($p) => FortuneChartService::PLANETS[$p]['name'] ?? $p, $chaochana['friends']);
                $enemyNames = array_map(fn ($p) => FortuneChartService::PLANETS[$p]['name'] ?? $p, $chaochana['enemies']);

                $result .= "\n[⚡ วิเคราะห์ Transit กับดวงชะตา]\n";

                // เช็คว่าดาวมิตรโคจรอยู่ภพไหน
                foreach ($chaochana['friends'] as $friend) {
                    foreach ($transitPositions as $houseNum => $planets) {
                        if (in_array($friend, $planets)) {
                            $houseName = FortuneChartService::HOUSES[$houseNum]['name'] ?? '';
                            $houseMeaning = FortuneChartService::HOUSES[$houseNum]['meaning'] ?? '';
                            $friendName = FortuneChartService::PLANETS[$friend]['name'] ?? $friend;
                            $result .= "- ✅ ดาวมิตร \"{$friendName}\" กำลังโคจรผ่านภพ{$houseNum}.{$houseName}({$houseMeaning}) → ส่งผลดีด้าน{$houseMeaning}\n";
                        }
                    }
                }

                // เช็คว่าดาวศัตรูโคจรอยู่ภพไหน
                foreach ($chaochana['enemies'] as $enemy) {
                    foreach ($transitPositions as $houseNum => $planets) {
                        if (in_array($enemy, $planets)) {
                            $houseName = FortuneChartService::HOUSES[$houseNum]['name'] ?? '';
                            $houseMeaning = FortuneChartService::HOUSES[$houseNum]['meaning'] ?? '';
                            $enemyName = FortuneChartService::PLANETS[$enemy]['name'] ?? $enemy;
                            $result .= "- ⚠️ ดาวศัตรู \"{$enemyName}\" กำลังโคจรผ่านภพ{$houseNum}.{$houseName}({$houseMeaning}) → ควรระวังด้าน{$houseMeaning}\n";
                        }
                    }
                }
            }
            ...
            $transitEvents = $this->getTransitEvents($currentMonth);
            if ($transitEvents) {
                $result .= "\n[📅 เหตุการณ์ดาวสำคัญช่วงนี้]\n";
                $result .= $transitEvents;
            }

            $result .= "\n⚠️ ใช้ข้อมูล Transit ข้างต้นอ้างอิงในคำทำนาย เช่น \"ช่วงนี้ดาว[ชื่อ]กำลังโคจรผ่านภพ[ชื่อ]ของคุณ ส่งผลให้...\" เพื่อให้คำทำนายมี timing แม่นยำ\n";
