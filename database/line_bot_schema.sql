-- ============================================
-- LINE Bot AI System - Complete Database Schema
-- ============================================
-- รัน SQL นี้ในฐานข้อมูล admin_mlmtestthai
-- หากไม่สามารถใช้ php artisan migrate ได้
-- ============================================
...
CREATE TABLE IF NOT EXISTS `line_bot_knowledge_bases` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `line_bot_knowledge_bases_ai_setting_id_foreign` (`ai_setting_id`),
  KEY `line_bot_knowledge_bases_type_index` (`type`),
  KEY `line_bot_knowledge_bases_is_enabled_index` (`is_enabled`),
  CONSTRAINT `line_bot_knowledge_bases_ai_setting_id_foreign` FOREIGN KEY (`ai_setting_id`) REFERENCES `line_bot_ai_settings` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `line_bot_conversations` (
  ...
  KEY `line_bot_conversations_ai_setting_id_foreign` (`ai_setting_id`),
  KEY `line_bot_conversations_status_index` (`status`),
  CONSTRAINT `line_bot_conversations_ai_setting_id_foreign` FOREIGN KEY (`ai_setting_id`) REFERENCES `line_bot_ai_settings` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `line_bot_messages` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `line_bot_messages_conversation_id_foreign` (`conversation_id`),
  KEY `line_bot_messages_role_index` (`role`),
  CONSTRAINT `line_bot_messages_conversation_id_foreign` FOREIGN KEY (`conversation_id`) REFERENCES `line_bot_conversations` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Table 7: line_chat_widget_settings
CREATE TABLE IF NOT EXISTS `line_chat_widget_settings` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `secondary_color` varchar(7) NOT NULL DEFAULT '#0891B2',
  `welcome_message` text DEFAULT NULL,
  `avatar_id` bigint(20) unsigned DEFAULT NULL,
  `show_on_pages` tinyint(1) NOT NULL DEFAULT 1,
  ...
  `auto_open_delay` int(11) NOT NULL DEFAULT 3000,
  `offline_message` text DEFAULT NULL,
  `enable_user_chat` tinyint(1) NOT NULL DEFAULT 1,
  `enable_seller_chat` tinyint(1) NOT NULL DEFAULT 1,
  `enable_ai_chat` tinyint(1) NOT NULL DEFAULT 1,
  `is_active` tinyint(1) NOT NULL DEFAULT 0,
  `metadata` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `line_broadcast_messages` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `line_broadcast_messages_flex_template_id_foreign` (`flex_template_id`),
  KEY `line_broadcast_messages_status_index` (`status`),
  KEY `line_broadcast_messages_scheduled_at_index` (`scheduled_at`),
  CONSTRAINT `line_broadcast_messages_flex_template_id_foreign` FOREIGN KEY (`flex_template_id`) REFERENCES `line_flex_message_templates` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ============================================
-- Insert Seed Data for Flex Message Templates
-- ============================================

INSERT INTO `line_flex_message_templates` (`name`, `category`, `description`, `flex_content`, `is_seed`, `is_active`, `created_at`, `updated_at`) VALUES
('Welcome Message', 'welcome', 'Beautiful welcome message for new users', '{
  "type": "bubble",
  "hero": {
    "type": "image",
    ...
    "contents": [
      ...
      },
      {
        ...
        "contents": [
          {
            "type": "text",
            "text": "ขอบคุณที่เข้าร่วมกับเรา เราพร้อมช่วยเหลือคุณในทุกๆ เรื่อง",
            "size": "sm",
            "color": "#666666",
            "wrap": true
          }
...
('Flash Sale Promotion', 'promotion', 'Eye-catching flash sale promotion template', '{
  "type": "bubble",
  "hero": {
    "type": "image",
...
('Product Card', 'product', 'Beautiful product showcase template', '{
  "type": "bubble",
  "hero": {
    "type": "image",
...
-- Completed!
-- ============================================
-- เรียบร้อย! ตารางทั้งหมดถูกสร้างแล้ว
-- พร้อมข้อมูล Seed สำหรับ Flex Message Templates
-- ============================================
