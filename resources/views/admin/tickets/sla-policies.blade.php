...
<div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                ...
                <button onclick="openCreateModal()"
                        class="inline-flex items-center px-6 py-3 glass-fusion text-red-600 hover:bg-red-50 rounded-xl font-semibold transition-all duration-200 hover:scale-105 shadow-lg">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <!-- Total Policies Card -->
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-red-500 hover:shadow-xl transition-all duration-200 hover:-translate-y-1" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 dark:text-gray-400 dark:text-gray-400 text-sm font-medium mb-1">Total Policies</p>
                    <p class="text-3xl font-bold text-gray-900 dark:text-white dark:text-white">{{ $policies->count() }}</p>
                </div>
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-green-500 hover:shadow-xl transition-all duration-200 hover:-translate-y-1" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 dark:text-gray-400 dark:text-gray-400 text-sm font-medium mb-1">Active Policies</p>
                    <p class="text-3xl font-bold text-gray-900 dark:text-white dark:text-white">{{ $policies->where('is_active', true)->count() }}</p>
                </div>
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-yellow-500 hover:shadow-xl transition-all duration-200 hover:-translate-y-1" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 dark:text-gray-400 dark:text-gray-400 text-sm font-medium mb-1">Business Hours Only</p>
                    <p class="text-3xl font-bold text-gray-900 dark:text-white dark:text-white">{{ $policies->where('business_hours_only', true)->count() }}</p>
                </div>
        ...
        <div class="glass-fusion dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-blue-500 hover:shadow-xl transition-all duration-200 hover:-translate-y-1" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-gray-500 dark:text-gray-400 dark:text-gray-400 text-sm font-medium mb-1">24/7 Support</p>
                    <p class="text-3xl font-bold text-gray-900 dark:text-white dark:text-white">{{ $policies->where('business_hours_only', false)->count() }}</p>
                </div>
                    ...
                    <tr class="hover:bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($policy->priority)
                                @php
                                    ...
                                    $colorClass = $priorityColors[$policy->priority] ?? 'bg-gray-100/50 dark:bg-gray-800/50 text-gray-900 dark:text-white';
                                @endphp
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center text-sm">
                                ...
                                <span class="text-gray-500 dark:text-gray-400 dark:text-gray-400 ml-1">min</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center text-sm">
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                <i class="fas fa-clock text-6xl text-gray-300 dark:text-gray-600 dark:text-gray-400 mb-4"></i>
                                <p class="text-gray-500 dark:text-gray-400 dark:text-gray-400 text-lg font-medium">No SLA policies yet</p>
                                <p class="text-gray-400 dark:text-gray-500 dark:text-gray-400 text-sm mt-2">Create your first policy to get started</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
...
<div id="policyModal" class="hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-50 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4 py-8">
        <div class="glass-fusion dark:bg-gray-800 rounded-2xl shadow-2xl max-w-3xl w-full transform transition-all" border border-white/20 dark:border-white/10>
            <form id="policyForm" method="POST">
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" required
                               class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="2"
                                  class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all"></textarea>
                    </div>

                    <!-- Category and Priority -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="category_id" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">
                                <i class="fas fa-folder mr-1"></i>
                                Category
                            </label>
                        ...
                        <div>
                            <label for="priority" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">
                                <i class="fas fa-flag mr-1"></i>
                                Priority
                            </label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="first_response_time" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">
                        ...
                        <div>
                            <label for="resolution_time" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">
                    ...
                    <div class="flex items-center p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl border border-yellow-200 dark:border-yellow-800">
                        <input type="checkbox" name="business_hours_only" id="business_hours_only" value="1"
                               class="w-5 h-5 text-red-600 bg-gray-100/50 dark:bg-gray-800/50 border-gray-300 dark:border-gray-600 rounded focus:ring-red-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="business_hours_only" class="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300">
                ...
                <div class="px-8 py-6 bg-gray-100/50 dark:bg-gray-800/50/50 dark:bg-gray-800/50 dark:bg-gray-900 rounded-b-2xl flex justify-end space-x-3">
                    ...
                    <button type="submit"
                            class="px-6 py-3 rounded-xl bg-gradient-to-r from-red-600 to-rose-600 text-white font-semibold hover:from-red-700 hover:to-rose-700 transition-all shadow-lg">
