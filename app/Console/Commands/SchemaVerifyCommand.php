    ...
    protected function getExpectedSchema(string $table): array
    {
        ...
        $schemas = [
            ...
            'line_bot_knowledge_bases' => [
                ...
                'name' => 'string',
                'type' => 'string',       // ประเภทข้อมูล: url, internal, file, text
                'source' => 'text',        // URL หรือ path
                'content' => 'text',
                'file_path' => 'string',   // path ของไฟล์ที่อัปโหลด
                'file_type' => 'string',   // pdf, txt, docx, csv
                'priority' => 'integer',
                'is_active' => 'boolean',
            ...
            'line_flex_message_templates' => [
                ...
                'category' => 'string',        // หมวดหมู่: promotion, info, product, etc.
                'description' => 'text',
                'thumbnail' => 'string',       // รูปตัวอย่าง
                'flex_content' => 'json',      // JSON ของ Flex Message
                'is_seed' => 'boolean',        // เป็นตัวอย่างจากระบบ
                'is_active' => 'boolean',
            ...
            'line_rich_menus' => [
                ...
                'name' => 'string',
                'description' => 'text',
                'size' => 'string',            // full หรือ half
                'selected' => 'boolean',       // เลือกไว้โดยค่าเริ่มต้น
                'chat_bar_text' => 'string',   // ข้อความแสดงบน chat bar
                'areas' => 'json',             // พื้นที่และ actions ของเมนู
                'image_path' => 'string',      // รูปภาพ Rich Menu
                'is_default' => 'boolean',     // เป็น Rich Menu หลัก
                'is_active' => 'boolean',
                'created_by' => 'bigint',
                'created_at' => 'datetime',
                'updated_at' => 'datetime',
            ...
            'line_chat_widget_settings' => [
                ...
                'primary_color' => 'string',   // สี LINE เขียว
                'secondary_color' => 'string',
                'welcome_message' => 'string',
                'avatar_id' => 'bigint',       // FK to line_avatars
                'show_on_pages' => 'boolean',
                'enabled_pages' => 'json',     // หน้าที่เปิดใช้
                'enable_sound' => 'boolean',
                'enable_notifications' => 'boolean',
                'auto_open' => 'boolean',
                'auto_open_delay' => 'integer', // milliseconds
