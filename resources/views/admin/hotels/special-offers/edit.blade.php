...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-2">แก้ไขโปรโมชั่นพิเศษ</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.hotels.special-offers.index') }}">โปรโมชั่นพิเศษ</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.hotels.special-offers.show', $offer->id) }}">{{ $offer->name }}</a></li>
    ...
    <form action="{{ route('admin.hotels.special-offers.update', $offer->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="code" class="form-control" value="{{ old('code', $offer->code) }}" required
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="description" class="form-control" rows="3" placeholder="อธิบายรายละเอียดโปรโมชั่น...">{{ old('description', $offer->description) }}</textarea>
                                @error('description')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3" id="discountValueField">
                                ...
                                <input type="number" name="discount_value" class="form-control" value="{{ old('discount_value', $offer->discount_value) }}"
                            ...
                            <div class="col-md-4 mb-3 {{ old('discount_type', $offer->discount_type) == 'free_nights' ? '' : 'd-none' }}" id="freeNightsField">
                                <label class="form-label">จำนวนคืนฟรี <span class="text-danger">*</span></label>
                                <input type="number" name="free_nights" class="form-control" value="{{ old('free_nights', $offer->free_nights) }}"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="min_nights" class="form-control" value="{{ old('min_nights', $offer->min_nights) }}"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="min_amount" class="form-control" value="{{ old('min_amount', $offer->min_amount) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="valid_from" class="form-control"
                                       value="{{ old('valid_from', \Carbon\Carbon::parse($offer->valid_from)->format('Y-m-d')) }}" required>
                                @error('valid_from')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="valid_to" class="form-control"
                                       value="{{ old('valid_to', \Carbon\Carbon::parse($offer->valid_to)->format('Y-m-d')) }}" required>
                                @error('valid_to')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="max_uses" class="form-control" value="{{ old('max_uses', $offer->max_uses) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="max_uses_per_user" class="form-control" value="{{ old('max_uses_per_user', $offer->max_uses_per_user) }}"
                                       min="1" placeholder="ไม่จำกัด">
                                <small class="text-muted">เว้นว่างหากไม่จำกัด</small>
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        @if($offer->banner_image)
                            <div class="mb-3">
                                <label class="d-block mb-2"><strong>รูปปัจจุบัน:</strong></label>
                                <img src="{{ Storage::url($offer->banner_image) }}" alt="Current banner" class="img-fluid rounded">
                            </div>
                        @endif

                        <label class="form-label">เปลี่ยนรูปแบนเนอร์</label>
                    ...
                    <div class="card-body">
                        <div id="roomTypesList">
                            @if($roomTypes->count() > 0)
                                ...
                                @foreach($roomTypes as $room)
                                    <div class="custom-control custom-checkbox mb-2">
                                        <input type="checkbox" class="custom-control-input" id="room_{{ $room->id }}"
                                               ...
                                               {{ in_array($room->id, $selectedRoomTypes) ? 'checked' : '' }}>
                                ...
                                @endforeach
                            @else
                                <p class="text-muted small">ไม่มีห้องพัก</p>
                            @endif
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.hotels.special-offers.show', $offer->id) }}" class="btn btn-secondary btn-block">
