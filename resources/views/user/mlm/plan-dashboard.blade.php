...
<div class="space-y-6 pb-20 lg:pb-6">
    ...
    <div class="grid md:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1">
                    <div class="text-sm text-gray-600">ค่าคอมมิชชั่นรวม</div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1">
                    <div class="text-sm text-gray-600">PV ส่วนตัว</div>
                    <div class="text-2xl font-bold text-gray-800">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1">
                    <div class="text-sm text-gray-600">PV ทีม</div>
                    <div class="text-2xl font-bold text-gray-800">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6">
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center py-2 border-b">
                    <span class="text-gray-600">ชื่อแผน:</span>
                    <span class="font-bold text-gray-800">{{ $member->plan->name ?? 'N/A' }}</span>
                </div>
                <div class="flex justify-between items-center py-2 border-b">
                ...
                <div class="flex justify-between items-center py-2 border-b">
                    <span class="text-gray-600">วันที่เข้าร่วม:</span>
                    <span class="font-bold text-gray-800">{{ $member->created_at->format('d/m/Y') }}</span>
                </div>
                <div class="flex justify-between items-center py-2">
                    <span class="text-gray-600">ผู้แนะนำ:</span>
                    <span class="font-bold text-gray-800">
                        @if($member->sponsor)
        ...
        <div class="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl shadow-xl p-6 border border-yellow-200">
            ...
            @if($member->rank)
                <div class="text-center">
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-2">{{ $member->rank->name }}</h3>
                    <p class="text-sm text-gray-600 mb-4">{{ $member->rank->description ?? '' }}</p>
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <p class="text-gray-600">ยังไม่มียศ</p>
    ...
    <!-- Quick Actions -->
    <div class="grid md:grid-cols-3 gap-4">
        <a href="{{ route('user.mlm.team') }}" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            <div class="flex items-center gap-4">
                ...
                <div class="flex-1">
                    ...
                    <div class="text-sm text-gray-600">ดูสมาชิกในทีม</div>
                </div>
                <span class="text-blue-600">→</span>
            </div>
        </a>

        <a href="{{ route('user.mlm.commissions') }}" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            <div class="flex items-center gap-4">
                <div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
                    <span class="text-2xl">💰</span>
                </div>
                <div class="flex-1">
                    <div class="font-bold text-gray-800">ค่าคอมมิชชั่น</div>
                    <div class="text-sm text-gray-600">รายละเอียดรายได้</div>
                </div>
