        ...
        if ($bmForced) {
            ...
            $g2DeitySpec = $deityEnabled
                ? "🕉️ องค์เทพ/สิ่งศักดิ์สิทธิ์คุ้มครอง-บูชาประจำตัว (บล็อกสุดท้าย • อ่านจาก \"คลังองค์เทพรายไพ่\" ด้านบน):\n"
                    ."• สรุป *องค์เดียว* ที่เด่นสุดเป็น \"องค์อุปถัมภ์/คุ้มครองประจำตัว\" ของลูก — มีเสมอ ❌ ห้ามตอบ \"ไม่มี/แล้วแต่ศรัทธา\"\n"
                    ...
                    ."• บูชาเปิดดวงอย่างไร — ของบูชา + วันไหว้ + วิธีตั้งจิต *เฉพาะองค์นั้น* (ดึงจากคลัง) ❌ ห้ามมั่วชื่อองค์ที่ไม่มีจริง ไม่แน่ใจ→แนะแนวทางกลางที่ถูกต้อง\n"
