...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | ยอดโอนขั้นต่ำที่ถือว่าเป็น "การชำระเงินจริง" (บาท)
    |--------------------------------------------------------------------------
    |
    | SMS ธนาคารขาเข้าที่ยอดต่ำกว่านี้ = โอนเศษสตางค์ก่อกวน ไม่ใช่การจ่ายเงิน
    | → ตีตกเป็น 'rejected' ทันที ไม่ต้องเข้าคิวจับคู่ ไม่ไปรกคิวที่แอดมินต้องไล่ดู
    |
    | ✅ ปลอดภัยที่ 1.00 เพราะยอดบิลที่เล็กที่สุดที่ระบบออกได้คือ ฿1.01
    |    (UniquePaymentAmount ใช้จำนวนเต็ม + ทศนิยม 01-99 และ base ต่ำสุดคือ 1)
    |    ⇒ ต่ำกว่า ฿1.00 ไม่มีทางเป็นยอดของบิลจริง ไม่ว่าบิลเต็มหรือบิลเติมส่วนต่าง
    |
    | ตั้ง 0 = ปิดด่านนี้ (รับทุกยอดเหมือนเดิม)
    |
    */
    'min_credit_amount' => env('SMS_MIN_CREDIT_AMOUNT', 1.00),
