...
<div x-data="{ activeTab: 'basic' }" class="container-fluid px-4 py-6">
    ...
    <div class="relative mb-8 overflow-hidden rounded-2xl bg-gradient-to-br from-cyan-500 via-blue-600 to-indigo-600 dark:from-cyan-600 dark:via-blue-700 dark:to-indigo-700 p-8 shadow-2xl">
        ...
        <div class="relative flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-white mb-1">แก้ไขเซคชั่น</h1>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('admin.app-management.control-sections.update', $appControlSection) }}" class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 overflow-hidden p-8">
        @method('PUT')
        @csrf
