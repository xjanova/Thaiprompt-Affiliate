    ...
    <div class="container mx-auto px-4 py-8">
        ...
        @else
            ...
            <div class="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl p-12 text-center border border-gray-100 dark:border-slate-700">
                ...
                <a href="{{ route('storefront.index') }}" class="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
                    <span class="text-2xl">🛒</span>
                    <span>ไปตลาดบอท</span>
                </a>
            </div>
