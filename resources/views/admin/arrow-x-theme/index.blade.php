...
<div class="container-fluid px-4 py-8" x-data="arrowXDashboard()">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-6 rounded-2xl border border-purple-200 dark:border-purple-700">
            <div class="flex items-center justify-between mb-4">
                <div class="w-12 h-12 style="background: var(--arrow-x-accent-gradient)" rounded-xl flex items-center justify-center">
                    <i class="fas fa-palette text-white text-xl"></i>
                </div>
                <span class="text-2xl font-bold text-purple-600 dark:text-purple-400">{{ $themeSetting->color ? '1' : '0' }}</span>
            </div>
            <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-400 dark:text-gray-400">Color Schemes</h3>
        </div>
        ...
        <div class="bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-900/20 dark:to-pink-800/20 p-6 rounded-2xl border border-pink-200 dark:border-pink-700">
            ...
            <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-400 dark:text-gray-400">RGB Effects</h3>
        </div>
        ...
        <div class="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 p-6 rounded-2xl border border-orange-200 dark:border-orange-700">
            ...
            <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-400 dark:text-gray-400">Typography Sets</h3>
        </div>
        ...
        <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-6 rounded-2xl border border-blue-200 dark:border-blue-700">
            <div class="flex items-center justify-between mb-4">
                <div class="w-12 h-12 style="background: var(--arrow-x-primary-gradient)" rounded-xl flex items-center justify-center">
            ...
            <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-400 dark:text-gray-400">Components</h3>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="{{ route('admin.arrow-x-theme.general-settings') }}" class="group block">
            <div class="glass-fusion dark:bg-gray-800 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all hover:scale-105 border border-gray-200 dark:border-gray-700 dark:border-gray-700" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                <div class="w-16 h-16 style="background: var(--arrow-x-accent-gradient)" rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                    <i class="fas fa-cog text-white text-2xl"></i>
                </div>
                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">การตั้งค่าทั่วไป</h3>
                <p class="text-gray-600 dark:text-gray-400 dark:text-gray-400 text-sm mb-4">
        ...
        <a href="{{ route('admin.arrow-x-theme.typography') }}" class="group block">
            <div class="glass-fusion dark:bg-gray-800 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all hover:scale-105 border border-gray-200 dark:border-gray-700 dark:border-gray-700" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                <div class="w-16 h-16 style="background: var(--arrow-x-primary-gradient)" rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
        ...
        <div class="group" x-data="{ showActions: false }">
            <div class="glass-fusion dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 dark:border-gray-700" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                ...
                <div class="space-y-2">
                    <form action="{{ route('admin.arrow-x-theme.compile') }}" method="POST">
                        @csrf
                        <button type="submit" class="w-full px-4 py-2 bg-teal-100 dark:bg-teal-900/30 text-teal-800 dark:text-teal-300 rounded-xl text-sm hover:bg-teal-200 dark:hover:bg-teal-900/50 transition">
                    ...
                    <form action="{{ route('admin.arrow-x-theme.clear-cache') }}" method="POST">
                        @csrf
                        <button type="submit" class="w-full px-4 py-2 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 rounded-xl text-sm hover:bg-red-200 dark:hover:bg-red-900/50 transition">
                    ...
                    <form action="{{ route('admin.arrow-x-theme.compile-files') }}" method="POST">
                        @csrf
                        <button type="submit" class="w-full px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded-xl text-sm hover:bg-blue-200 dark:hover:bg-blue-900/50 transition">
        ...
        <a href="/.claude/ARROW_X_THEME_PLAN.md" target="_blank" class="group block">
            <div class="glass-fusion dark:bg-gray-800 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all hover:scale-105 border border-gray-200 dark:border-gray-700 dark:border-gray-700" hover:scale-105 transition-transform border border-white/20 dark:border-white/10>
                ...
                <div class="flex items-center text-gray-600 dark:text-gray-400 dark:text-gray-400 font-semibold text-sm">
