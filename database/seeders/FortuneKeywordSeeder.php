    ...
    protected function getGreetingKeywords(): array
    {
        return [
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "อรุณสวัสดิ์ค่ะ 🌅✨ เช้านี้ดวงดีนะคะ\n\nเริ่มต้นวันใหม่ด้วยการดูดวงกันไหมคะ? พิมพ์คำถามมาได้เลย 🔮",
                'category' => 'fortune',
                'priority' => 65,
                'is_active' => true,
                'notes' => 'ทักทายตอนเช้า',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "สวัสดียามค่ำค่ะ 🌙✨ คืนนี้อยากรู้เรื่องอะไรไหมคะ?\n\nจันทราพร้อมดูดวงให้ค่ะ พิมพ์คำถามมาได้เลยนะคะ 🔮",
                'category' => 'fortune',
                'priority' => 65,
                'is_active' => true,
                'notes' => 'ทักทายตอนเย็น',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "จันทราสบายดีค่ะ ขอบคุณที่ถามนะคะ 😊✨\n\nแล้วคุณล่ะคะ วันนี้เป็นอย่างไรบ้าง? ถ้าอยากรู้ว่าดวงจะดีขึ้นไหม พิมพ์คำถามมาได้เลยค่ะ 🔮",
                'category' => 'fortune',
                'priority' => 65,
                'is_active' => true,
                'notes' => 'ถามสบายดีไหม',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "ลาก่อนค่ะ 👋✨ ขอให้โชคดีนะคะ!\n\nเมื่อไหร่อยากดูดวงอีก กลับมาหาจันทราได้เลยค่ะ 🔮🌙",
                'category' => 'fortune',
                'priority' => 65,
                'is_active' => true,
                'notes' => 'ลาก่อน',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "ยินดีต้อนรับกลับค่ะ! 🎉✨ คิดถึงเหมือนกันนะคะ\n\nวันนี้อยากรู้เรื่องอะไรคะ? พิมพ์คำถามมาได้เลย 🔮",
                'category' => 'fortune',
                'priority' => 65,
                'is_active' => true,
                'notes' => 'กลับมาใหม่',
    ...
    protected function getGratitudeKeywords(): array
    {
        return [
            [
                ...
                'response_type' => 'text',
                'response_text' => "ยินดีค่ะ 🙏💜 จันทราดีใจที่ได้ช่วยนะคะ\n\nเมื่อไหร่อยากดูดวงเรื่องอื่นอีก พิมพ์มาได้ตลอดค่ะ 🔮✨",
                'category' => 'fortune',
                'priority' => 70,
                'is_active' => true,
                'notes' => 'ขอบคุณ',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "ไม่เป็นไรเลยค่ะ 😊 ไม่ต้องขอโทษนะคะ\n\nจันทราพร้อมช่วยเสมอค่ะ มีอะไรสงสัยหรืออยากดูดวง พิมพ์มาได้เลยนะคะ 🔮",
                'category' => 'fortune',
                'priority' => 65,
                'is_active' => true,
                'notes' => 'ขอโทษ',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "ขอบคุณมากค่ะ 😊💜✨ จันทราดีใจที่คำทำนายตรงใจนะคะ\n\nถ้าอยากรู้เรื่องอื่นเพิ่มเติม พิมพ์คำถามมาได้เลยค่ะ 🔮\n\n💎 หรือลอง ดูดวงละเอียด เพื่อคำทำนายเชิงลึกยิ่งขึ้นค่ะ",
                'category' => 'fortune',
                'priority' => 60,
                'is_active' => true,
    ...
    protected function getPricingKeywords(): array
    {
        return [
            [
                ...
                'description' => 'ถามราคา/ค่าบริการ',
                'trigger_words' => ['ราคา', 'ค่าบริการ', 'เท่าไหร่', 'กี่บาท', 'แพงไหม', 'ราคาเท่าไร'],
                'response_type' => 'text',
                'response_text' => "💰 ราคาบริการดูดวงค่ะ:\n\n🆓 ดูดวงพื้นฐาน — ฟรี!\nพิมพ์คำถามมาได้เลยค่ะ\n\n💎 ดูดวงละเอียด — 49 บาท\nถาม 2 คำถาม + วันเกิด → คำทำนายเชิงลึก\nพิมพ์ \"ดูดวงละเอียด\" เพื่อเริ่มค่ะ\n\n🔮 อยากลองดูฟรีก่อน พิมพ์คำถามมาได้เลยค่ะ!",
                'category' => 'fortune',
                'priority' => 70,
                'is_active' => true,
                'notes' => 'ถามราคา',
    ...
    protected function getBotIdentityKeywords(): array
    {
        return [
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "💻 จันทราถูกพัฒนาโดยทีม ThaiPrompt ค่ะ\n\nเป็นส่วนหนึ่งของ TP-Affiliate Platform ✨\n\n🔮 แต่ตอนนี้อยากรู้ดวงอะไรไหมคะ? พิมพ์คำถามมาได้เลยนะคะ!",
                'category' => 'fortune',
                'priority' => 55,
                'is_active' => true,
                'notes' => 'ถามใครพัฒนา',
    ...
    protected function getEmotionKeywords(): array
    {
        return [
            [
                ...
                'response_type' => 'text',
                'response_text' => "🫂 จันทราเข้าใจค่ะ... ไม่ต้องเก็บเอาไว้คนเดียวนะคะ\n\nเรื่องที่กังวลอยู่ บางทีดวงอาจบอกทางออกให้ได้ค่ะ 💜\n\n🔮 อยากให้จันทราดูดวงเรื่องที่กังวลไหมคะ? พิมพ์มาเลยนะคะ",
                'category' => 'fortune',
                'priority' => 60,
                'is_active' => true,
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "🎉 ดีใจด้วยค่ะ! เห็นมีความสุขแบบนี้ จันทราก็ยิ้มตามค่ะ 😊💜\n\nอยากรู้ไหมคะว่าความสุขนี้จะต่อเนื่องไปอีกนานแค่ไหน? 🔮✨\nพิมพ์คำถามมาได้เลยค่ะ!",
                'category' => 'fortune',
                'priority' => 55,
                'is_active' => true,
                'notes' => 'มีความสุข',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "💪 สู้ๆ นะคะ! ช่วงนี้อาจเหนื่อยบ้าง แต่จะดีขึ้นค่ะ\n\nอยากรู้ไหมคะว่าช่วงที่จะดีขึ้นอยู่ตรงไหน? จันทราดูดวงให้ได้ค่ะ 🔮✨\n\nพิมพ์คำถามมาเลยนะคะ!",
                'category' => 'fortune',
                'priority' => 55,
                'is_active' => true,
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "😤→😌 ใจเย็นๆ ก่อนนะคะ หายใจลึกๆ...\n\nบางทีดวงอาจบอกได้ว่าเหตุการณ์นี้จะคลี่คลายเมื่อไหร่ค่ะ 💜\n\n🔮 อยากให้จันทราดูดวงเรื่องนี้ไหมคะ? พิมพ์มาได้เลยค่ะ",
                'category' => 'fortune',
                'priority' => 55,
                'is_active' => true,
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "🌟 ความหวังเป็นสิ่งดีค่ะ! จันทราเชื่อว่าทุกคนมีดวงที่ดีรออยู่ 💜\n\nอยากรู้ไหมคะว่าสิ่งที่หวังจะเป็นจริงเมื่อไหร่? 🔮\nพิมพ์คำถามมาเลยค่ะ ✨",
                'category' => 'fortune',
                'priority' => 55,
                'is_active' => true,
                'notes' => 'มีหวัง',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "🫂 จันทราอยู่ตรงนี้นะคะ ไม่ได้อยู่คนเดียวค่ะ 💜\n\nอยากรู้ไหมคะว่าจะมีคนพิเศษเข้ามาในชีวิตเมื่อไหร่? 🔮✨\n\nพิมพ์ \"ดวงความรัก\" มาได้เลยค่ะ 💕",
                'category' => 'fortune',
                'priority' => 55,
                'is_active' => true,
    ...
    protected function getSmallTalkKeywords(): array
    {
        return [
            [
                ...
                'response_type' => 'text',
                'response_text' => "🔮 จันทราว่างเสมอค่ะ! พร้อมดูดวงให้ตลอด 24 ชั่วโมงเลยนะคะ ✨\n\nวันนี้อยากรู้เรื่องอะไรคะ? พิมพ์คำถามมาได้เลย 💜",
                'category' => 'fortune',
                'priority' => 55,
                'is_active' => true,
                'notes' => 'ถามทำอะไรอยู่',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "😋 จันทราไม่ต้องกินข้าวค่ะ แต่ขอบคุณที่ห่วงนะคะ!\n\nแต่ถ้าถามว่าวันนี้ควรกินอะไร... ลองถามดวงดูไหมคะ? 😄🔮\n\nพิมพ์คำถามมาได้เลยค่ะ!",
                'category' => 'fortune',
                'priority' => 50,
                'is_active' => true,
                'notes' => 'ถามกินข้าว',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "☁️ จันทราดูดวงเก่งกว่าดูอากาศค่ะ 😄\n\nแต่ถ้าอยากรู้ว่าดวงวันนี้จะเป็นอย่างไร จันทราช่วยได้เลยค่ะ! 🔮✨\n\nพิมพ์คำถามมาได้เลยนะคะ",
                'category' => 'fortune',
                'priority' => 50,
                'is_active' => true,
                'notes' => 'ถามอากาศ',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "🌙 จันทราอยู่มานานเท่ากับดวงจันทร์เลยค่ะ ✨ (ไม่บอกอายุนะคะ 😄)\n\nแต่ถ้าอยากรู้ดวงตามปีเกิด จันทราช่วยได้นะคะ!\nพิมพ์ \"ดูดวงละเอียด\" จะได้ใช้วันเกิดจริงดูดวงค่ะ 💎",
                'category' => 'fortune',
                'priority' => 50,
                'is_active' => true,
                'notes' => 'ถามอายุ',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "😊💜 อ๊ะ~ ขอบคุณค่ะ! จันทราก็รักทุกคนที่มาดูดวงเหมือนกันค่ะ ✨\n\nถ้าอยากรู้เรื่องความรัก จันทราดูให้ได้นะคะ 💕\nพิมพ์ \"ดวงความรัก\" มาได้เลยค่ะ 🔮",
                'category' => 'fortune',
                'priority' => 55,
                'is_active' => true,
                'notes' => 'แสดงความรัก',
    ...
    protected function getFaqKeywords(): array
    {
        return [
            [
                ...
                'response_type' => 'text',
                'response_text' => "📊 สิทธิ์การดูดวงค่ะ:\n\n🆓 ดูดวงฟรี — วันละ 5 ครั้ง\n💎 ดูดวงละเอียด — ไม่จำกัด (49 บาท/ครั้ง)\n\nพิมพ์ \"เช็คสิทธิ์\" เพื่อดูสิทธิ์คงเหลือค่ะ ✨\n\n🔮 พิมพ์คำถามมาได้เลยค่ะ!",
                'category' => 'fortune',
                'priority' => 65,
                'is_active' => true,
                'notes' => 'จำนวนครั้ง',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "🔄 ถ้าอยากเริ่มดูดวงใหม่ พิมพ์ \"ยกเลิก\" ก่อน แล้วพิมพ์คำถามใหม่ได้เลยค่ะ ✨\n\nหรือพิมพ์คำถามใหม่มาตรงๆ ก็ได้เลยค่ะ 🔮\n\nจันทราพร้อมเสมอค่ะ!",
                'category' => 'fortune',
                'priority' => 60,
                'is_active' => true,
                'notes' => 'เริ่มใหม่',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "📖 ดูคำทำนายล่าสุดได้ค่ะ!\n\nพิมพ์ \"ดูคำทำนาย\" หรือกดปุ่ม \"คำทำนายล่าสุด\" ที่เมนูด้านล่างค่ะ ✨\n\n🔮 หรือพิมพ์คำถามใหม่มาเลยก็ได้ค่ะ!",
                'category' => 'fortune',
                'priority' => 60,
                'is_active' => true,
                'notes' => 'ดูประวัติ',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "⚡ เวลาในการดูดวงค่ะ:\n\n🆓 ดูดวงฟรี — ประมาณ 10-30 วินาที\n💎 ดูดวงละเอียด — ประมาณ 1-2 นาที (หลังชำระเงิน)\n\nรวดเร็วมากเลยค่ะ! พิมพ์คำถามมาได้เลยนะคะ 🔮✨",
                'category' => 'fortune',
                'priority' => 58,
                'is_active' => true,
                'notes' => 'ถามเวลาตอบ',
    ...
    protected function getReactionKeywords(): array
    {
        return [
            [
                ...
                'response_type' => 'text',
                'response_text' => "555 😆 มีอารมณ์ดี ดวงวันนี้น่าจะดีนะคะ ✨\n\nอยากรู้ไหมคะว่าดวงดีจริงไหม? พิมพ์คำถามมาได้เลยค่ะ 🔮",
                'category' => 'fortune',
                'priority' => 50,
                'is_active' => true,
                'notes' => 'หัวเราะ',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "😲✨ จริงค่ะ! จันทราดูดวงได้แม่นจริงๆ นะคะ\n\nลองถามเรื่องอื่นดูอีกไหมคะ? 🔮💜\nพิมพ์คำถามมาได้เลยค่ะ!",
                'category' => 'fortune',
                'priority' => 50,
                'is_active' => true,
                'notes' => 'ตกใจ/ตื่นเต้น',
            ...
            [
                ...
                'response_type' => 'text',
                'response_text' => "👍 ค่ะ! มีอะไรอยากถามเพิ่มเติม พิมพ์มาได้เลยนะคะ 🔮✨\n\nจันทราพร้อมดูดวงให้ตลอดค่ะ 💜",
                'category' => 'fortune',
                'priority' => 50,
                'is_active' => true,
                'notes' => 'รับทราบ',
