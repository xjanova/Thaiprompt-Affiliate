...
@section('title', 'เพิ่ม Cloud Provider ใหม่')
...
<div class="space-y-6">
    ...
    <div class="glass-fusion rounded-2xl p-6 border border-white/30">
        <h1 class="text-3xl font-bold text-white flex items-center gap-3">
            ...
            เพิ่ม Cloud Provider ใหม่
        </h1>
        <p class="text-white/70 mt-2">กรอกข้อมูล Cloud GPU Provider</p>
    </div>

    {{-- Form --}}
    <form action="{{ route('admin.ai-rental.cloud-providers.store') }}" method="POST">
        @csrf

        @include('admin.ai-rental.cloud-providers._form', ['provider' => null])
        ...
        <div class="glass-fusion rounded-2xl p-6 border border-white/30">
            <div class="flex gap-4">
                <button type="submit"
                    ...
                    <i class="fas fa-save"></i> บันทึก Provider
                </button>
                <a href="{{ route('admin.ai-rental.cloud-providers.index') }}"
